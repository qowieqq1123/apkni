...
local io=io or require"tolua.io"
local table=table or require"tolua.table"
local string=string or require"tolua.string"
local coroutine=coroutine or require"tolua.coroutine"
local debug=require"tolua.debug"
...
local socket=require"tolua.socket"
local coro_debugger
local coro_debugee
...
and(mt.__serialize or mt.__tostring)then
...
if not file and err==false then break end
end
