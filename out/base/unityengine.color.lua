...
function Color.StrToColor(str)
local r,g,b=0
local a=1
if nil==str or string.len(str)<6 then
return setmetatable({r=0,g=0,b=0,a=1},Color)
end

r=(tonumber(string.sub(str,2,3),16)or 255)/255
g=(tonumber(string.sub(str,4,5),16)or 255)/255
b=(tonumber(string.sub(str,6,7),16)or 255)/255
a=(tonumber(string.sub(str,8,9),16)or 255)/255

return setmetatable({r=r or 0,g=g or 0,b=b or 0,a=a or 1},Color)
end


function Color:ToStrHex()
