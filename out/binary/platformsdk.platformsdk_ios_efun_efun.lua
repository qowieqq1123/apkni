...
function platformSDK_iOS_EFun:setZMLingPaiNotifyTime(updateType,args)
...
function platformSDK_iOS_EFun:setChuanSongZhenYouLiNotifyTime(updateType,args)
...
function platformSDK_iOS_EFun:setTianYuanShouChaoNotifyTime(updateType,args)
...
function platformSDK_iOS_EFun:setGuaJiNotify(taskId,taskType,taskStatus,stampTime,index)
