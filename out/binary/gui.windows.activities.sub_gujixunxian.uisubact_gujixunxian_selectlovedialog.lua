...
def_class("UISubAct_gujixunxian_SelectLoveDialog",UIWindowBase)
...
function UISubAct_gujixunxian_SelectLoveDialog:bindComponents()
...
function UISubAct_gujixunxian_SelectLoveDialog:unbindComponents()
...
function UISubAct_gujixunxian_SelectLoveDialog:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_gujixunxian_SelectLoveDialog:__delete()
...
function UISubAct_gujixunxian_SelectLoveDialog:onShow(argtable,afterOnloaded)
...
function UISubAct_gujixunxian_SelectLoveDialog:onHide()

end



function UISubAct_gujixunxian_SelectLoveDialog:onBackground()
self:onCloseBtn()
end

function UISubAct_gujixunxian_SelectLoveDialog:onCloseBtn()
if self.parentWin then
self.parentWin:closeWindow("UISubAct_gujixunxian_SelectLoveDialog")
else
self:closeSelf()
end
end

function UISubAct_gujixunxian_SelectLoveDialog:onHaveToggleChanged(name,isToggle,data)
...
function UISubAct_gujixunxian_SelectLoveDialog:onSelectBtn()
...
function UISubAct_gujixunxian_SelectLoveDialog:initFilterData()
...
function UISubAct_gujixunxian_SelectLoveDialog:onFilterBtn()
local args={}
...
function UISubAct_gujixunxian_SelectLoveDialog.selecConditionBack(data)
if _this==nil then
return
end
...
function UISubAct_gujixunxian_SelectLoveDialog:refreshList()
self.listData={}
...
function UISubAct_gujixunxian_SelectLoveDialog.sortListData(a,b)
for i=1,5 do
...
function UISubAct_gujixunxian_SelectLoveDialog:selectDefault()
...
function UISubAct_gujixunxian_SelectLoveDialog:refreshListItem(index)
...
function UISubAct_gujixunxian_SelectLoveDialog:onClickItem(index,data)
...
function UISubAct_gujixunxian_SelectLoveDialog:onSelectItem(data)
...
if isCurrent then
self.gailvspine:setChildUIModelShowTarget(5757,1,{},eAnimationID.idle,false,false,0,function()
end)
end
end

function UISubAct_gujixunxian_SelectLoveDialog:onDetailpBtn()
local dzData=self.selectData.disciple
local itemID=dzData.srctype
UIRecruitControl:showItemDiscipleInfoByItemId2(itemID)
end

function UISubAct_gujixunxian_SelectLoveDialog:onMoneyRoot()
end

function UISubAct_gujixunxian_SelectLoveDialog:onGailv_Btn()
if _this==nil then return end
local d={}
d.title='规则说明'
d.mode=3
d.name='gujixunxian_rule_%d'
d.closeCB=function()
end
UIManager:showWindow('UIRuleWin',d)
end

function UISubAct_gujixunxian_SelectLoveDialog:rec_selectUp(actID,subType,subId,idx)
