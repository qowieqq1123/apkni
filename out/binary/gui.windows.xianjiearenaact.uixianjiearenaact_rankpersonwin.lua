...
def_class("UIXianJieArenaAct_rankPersonWin",UIWindowBase)
...
function UIXianJieArenaAct_rankPersonWin:bindComponents()
...
function UIXianJieArenaAct_rankPersonWin:unbindComponents()
...
function UIXianJieArenaAct_rankPersonWin:onLoaded(...)
self:bindComponents()
end


function UIXianJieArenaAct_rankPersonWin:__delete()
self:clearTimer()
...
function UIXianJieArenaAct_rankPersonWin:onShow(argtable,afterOnloaded)
self.rankType=LTYW_Rank_Type.ePersonRank
...
function UIXianJieArenaAct_rankPersonWin:onHide()
self:clearTimer()
end

function UIXianJieArenaAct_rankPersonWin:refresh(isReset)
...
function UIXianJieArenaAct_rankPersonWin:getSortRankList(isReset)
...
function UIXianJieArenaAct_rankPersonWin:onFreshAction(i,widget)
self:fillItem(widget,i)
end

function UIXianJieArenaAct_rankPersonWin:onStartAction()

end

function UIXianJieArenaAct_rankPersonWin:fillItem(widget,index)
...
function UIXianJieArenaAct_rankPersonWin:refreshSelfRankItem()
...
local selfZhanJi=xianJieArenaActModel:getArenaSelfRankValue(self.rankType)or Int64_0
...
function UIXianJieArenaAct_rankPersonWin:setRemainingTimeTimer()
self:clearTimer()
local func=function()
...
function UIXianJieArenaAct_rankPersonWin:clearTimer()
if self.timer then
...
function UIXianJieArenaAct_rankPersonWin:refreshDropItem()
...
function UIXianJieArenaAct_rankPersonWin:onChangeLevel(level)
self.selectRankLevel=level
self:refreshReward()
end

function UIXianJieArenaAct_rankPersonWin:refreshReward()
self.rewardList=nil
...
function UIXianJieArenaAct_rankPersonWin:getRankReward(arenaRewards,rankNum)
...
function UIXianJieArenaAct_rankPersonWin:onHelpBtn()
...
function UIXianJieArenaAct_rankPersonWin:onRewardListBtn()
