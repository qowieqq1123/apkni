...
def_class("UITopMoneyWin6",UIWindowBase)
...
function UITopMoneyWin6:bindComponents()
...
function UITopMoneyWin6:unbindComponents()
...
function UITopMoneyWin6:onLoaded(...)
self:bindComponents()
self.money={}
...
function UITopMoneyWin6:__delete()
...
function UITopMoneyWin6:onShow(argtable,afterOnloaded)
if argtable then
...
function UITopMoneyWin6:onHide()
self:clearFlyIcon()
end

function UITopMoneyWin6:clearFlyIcon()
...
function UITopMoneyWin6:getMoneyList()
return self.money
end

function UITopMoneyWin6:freshMoneyList()
...
function UITopMoneyWin6:fillData(index,moneyInfo)
...
function UITopMoneyWin6:freshMoneyValue(index,moneyInfo,lastVal)
local rootStr=FMT.fmt('moneyRoot{0}',index)
if moneyInfo==nil then
self[rootStr]:setActive(false)
return
...
function UITopMoneyWin6:clearFMTweener(mtype)
...
function UITopMoneyWin6:onAddClick(moneyType)
...
function UITopMoneyWin6:getMoneyRoot(moneyType)
...
function UITopMoneyWin6:flyMoneyIcon(spos,moneyType)
...
function UITopMoneyWin6:handleFly(moneyType,spos,tpos)
...
function UITopMoneyWin6:onMoneyChange(moneyType,lastVal,val)
local moneyList=self.money
...
function UITopMoneyWin6:clickMoney(idx)
...
function UITopMoneyWin6:onMoney1Btn()
self:clickMoney(1)
end

function UITopMoneyWin6:onMoney2Btn()
self:clickMoney(2)
end

function UITopMoneyWin6:onMoney3Btn()
self:clickMoney(3)
end

function UITopMoneyWin6:onMoney4Btn()
self:clickMoney(4)
end


function UITopMoneyWin6:onItemChange(changeType,itemguid,itemid,lastcount,itemcount)
local moneyList=self.money
for i,v in ipairs(moneyList)do
local moneyInfo=moneyList[i]
