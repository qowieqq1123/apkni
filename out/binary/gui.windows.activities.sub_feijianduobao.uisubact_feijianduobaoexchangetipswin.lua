...
def_class("UISubAct_FeiJianDuoBaoExchangeTipsWin",UIWindowBase)
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:bindComponents()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:unbindComponents()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:__delete()
_this=nil
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:onHide()

end

function UISubAct_FeiJianDuoBaoExchangeTipsWin.onSubActivityStateChange(actID,subType,subid,state)
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:onShow(argtable,afterOnloaded)
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:refreshActTime()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:updateView()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:onClickItem(itemId,index,guid,attach)
tipsManager.showTips({itemid=itemId,itemguid=nil,move=TIPS_MOVE_POS.eLeft})
end

function UISubAct_FeiJianDuoBaoExchangeTipsWin:onGotoBtn()
local args={
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:onCancelBtn()
self:closeSelf()
end


function UISubAct_FeiJianDuoBaoExchangeTipsWin:playSpeak(delay)
self:clearTalk()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:doSpeaking()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:doTalkAnim()
...
function UISubAct_FeiJianDuoBaoExchangeTipsWin:finishSpeak()
self.speakObj:setChildCanvasGroupAlpha(0)

self:playSpeak(5)
end

function UISubAct_FeiJianDuoBaoExchangeTipsWin:clearTalk()
