...
def_class("UIEnterXianTuManMan",UICloneObject)





UIEnterXianTuManMan.abName="ui/windows/main/uientrychild/uienternomalitem.ab"

UIEnterXianTuManMan.assetName="UIEnterNomalItem"


function UIEnterXianTuManMan:bindComponents()
...
function UIEnterXianTuManMan:unbindComponents()
...
function UIEnterXianTuManMan:onLoaded(...)
self:bindComponents()
end


function UIEnterXianTuManMan:__delete()
...
function UIEnterXianTuManMan:onShow(argtable,afterOnloaded)
...
function UIEnterXianTuManMan:onHide()

end

function UIEnterXianTuManMan:freshReddot()

UIManager:invokeUIMethod('UIMain','freshSimpleBtnReddot')
local reddot=XianTuManManController:getXTMMEnterReddot()
self.widget:SetChildActive(1,reddot)
end


function UIEnterXianTuManMan:onIcon()
if not XianTuManManController:checkEnter()then
UIManager.info("仙途漫漫未开启")
return
end
UIFullXianTuManManController:showMainUI()
end

function UIEnterXianTuManMan:onClickBg()
if not XianTuManManController:checkEnter()then
UIManager.info("仙途漫漫未开启")
return
end
