...
def_class("UIGongFaTipsFourWin",UIWindowBase)
...
function UIGongFaTipsFourWin:bindComponents()

self.blackImg=UIObject.get(self,0)
self.rightPanel=UIObject.get(self,1)
self.title1=UIObject.get(self,2)
self.skillItem1=UIObject.get(self,3)
self.skillItem2=UIObject.get(self,4)
self.title5=UIObject.get(self,5)
self.studyDesc=UIObject.get(self,6)
self.title2=UIObject.get(self,7)
self.skillCondition=UIObject.get(self,8)
self.title3=UIObject.get(self,9)
self.pageCollect=UIObject.get(self,10)
self.gfDescText=UIText.get(self,11)
self.colorframe=UIImage.get(self,12)
self.gfItem=UIObject.get(self,13)
self.maxLevelTxt=UIText.get(self,14)
self.fadeouttContent=UIObject.get(self,15)
...
function UIGongFaTipsFourWin:unbindComponents()
...
function UIGongFaTipsFourWin:onLoaded(...)
self:bindComponents()
end


function UIGongFaTipsFourWin:__delete()
...
function UIGongFaTipsFourWin:onShow(argtable,afterOnloaded)
...
function UIGongFaTipsFourWin:onHide()

end



function UIGongFaTipsFourWin:refreshSkillView()
...
function UIGongFaTipsFourWin:fadeOutView(init)
...
function UIGongFaTipsFourWin:getSkillItem(idx)
if idx==1 then
