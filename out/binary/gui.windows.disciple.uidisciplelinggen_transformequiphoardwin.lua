...
def_class("UIDiscipleLinggen_TransformEquipHoardWin",UIWindowBase)
...
function UIDiscipleLinggen_TransformEquipHoardWin:bindComponents()
...
function UIDiscipleLinggen_TransformEquipHoardWin:unbindComponents()
...
function UIDiscipleLinggen_TransformEquipHoardWin:onLoaded(...)
self:bindComponents()
...
function UIDiscipleLinggen_TransformEquipHoardWin:__delete()
...
function UIDiscipleLinggen_TransformEquipHoardWin:onShow(argtable,afterOnloaded)
...
function UIDiscipleLinggen_TransformEquipHoardWin:onHide()

end

function UIDiscipleLinggen_TransformEquipHoardWin:refresh()
...
self.tip:setText("是否替换当前装备中的秘藏")
end

function UIDiscipleLinggen_TransformEquipHoardWin:refreshHoardItem(data,item)
...
function UIDiscipleLinggen_TransformEquipHoardWin:onCancelBtn()
...
function UIDiscipleLinggen_TransformEquipHoardWin:onOkBtn()
mzbkController.checkSwitchMC(self.disciple_guid,self.destData.pos,self.idx)
