...
def_class("UISubAct_FeiJianDuoBaoExchangeWin",UIWindowBase)
...
function UISubAct_FeiJianDuoBaoExchangeWin:bindComponents()
...
self.ScrollView=UIEnhancedScrollerLua.get(self,10)
...
function UISubAct_FeiJianDuoBaoExchangeWin:unbindComponents()
...
local _this=nil
local _ab="ui/windows/activities/sub_feijianduobao/feijianduobao_atlas_pak.ab"
local _bgs={
[eQualityColor.eWhite]="image_feijianduihuanui_1",
[eQualityColor.eGreen]="image_feijianduihuanui_1",
[eQualityColor.eBlue]="image_feijianduihuanui_2",
[eQualityColor.ePurple]="image_feijianduihuanui_3",
[eQualityColor.eOrange]="image_feijianduihuanui_4",
[eQualityColor.eRed]="image_feijianduihuanui_5",
[eQualityColor.ePink]="image_feijianduihuanui_5",
}
local _checkFlag={
[1]=function(param)
...
function UISubAct_FeiJianDuoBaoExchangeWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_FeiJianDuoBaoExchangeWin:__delete()
...
function UISubAct_FeiJianDuoBaoExchangeWin:onShow(argtable,afterOnloaded)
...
function UISubAct_FeiJianDuoBaoExchangeWin:onHide()

end

function UISubAct_FeiJianDuoBaoExchangeWin.on_money_changed(mType,oldValue,newValue)
...
function UISubAct_FeiJianDuoBaoExchangeWin:onCloseBtn()
if self.loaded then
self:closeSelf()
end
end

function UISubAct_FeiJianDuoBaoExchangeWin:onBackground()
self:onCloseBtn()
end

function UISubAct_FeiJianDuoBaoExchangeWin:refreshStar()
...
function UISubAct_FeiJianDuoBaoExchangeWin:refreshView(actId,subType,subId)
...
function UISubAct_FeiJianDuoBaoExchangeWin:refreshList()
self.dataList={}
...
function UISubAct_FeiJianDuoBaoExchangeWin:onLeftBtn()
...
function UISubAct_FeiJianDuoBaoExchangeWin:onRightBtn()
...
function UISubAct_FeiJianDuoBaoExchangeWin:onMoneyBtn()
local moneyType=self.config.money[1]
gainControl:showGainWin(moneyType)
end

function UISubAct_FeiJianDuoBaoExchangeWin:onLoadBackFinish()
...
call_activitiesHandle_func("activitiesHandle_feijianduobao","reqExchange",_this.activityId,_this.subId,itemData.index,num)
end
}
...
allowclickBG='false',
okcallback=function(...)
call_activitiesHandle_func("activitiesHandle_feijianduobao","reqExchange",_this.activityId,_this.subId,itemData.index,least)
end,
showclosebtn=true,
}
