...
def_class("UIDouFaTaiFightExtraWin",UIWindowBase)
...
function UIDouFaTaiFightExtraWin:bindComponents()
...
function UIDouFaTaiFightExtraWin:unbindComponents()
...
function UIDouFaTaiFightExtraWin:onLoaded(...)
self:bindComponents()
end


function UIDouFaTaiFightExtraWin:__delete()
...
function UIDouFaTaiFightExtraWin:onShow(argtable,afterOnloaded)
...
function UIDouFaTaiFightExtraWin:onHide()

end

function UIDouFaTaiFightExtraWin:getInputStr()
local editStr=self.InputSentence:getInputFieldValue()
return editStr
end

function UIDouFaTaiFightExtraWin:refreshSelfInfo(lookType)
...
function UIDouFaTaiFightExtraWin:refreshOtherInfo(lookType,actorId,otherSpeakStr)
...
if actorInfo then
if actorInfo.iconInfo and actorInfo.iconInfo.actoricon~=0 then
playerController:setHeadIcon(self.winid,self.otherHeadIcon:getID(),{scale=0.7,iconInfo=actorInfo.iconInfo})
else
local otherHead,otherKuang=douFaTaiModel:getDouFaTaiActorInfo(actorInfo)
...
function UIDouFaTaiFightExtraWin:onClickInput()
self.Placeholder:setText('')
end



function UIDouFaTaiFightExtraWin:onCheckStringLegal(str,legalStr)
