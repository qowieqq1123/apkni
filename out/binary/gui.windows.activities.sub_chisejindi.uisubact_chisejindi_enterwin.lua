...
def_class("UISubAct_ChiSeJinDi_EnterWin",UIWindowBase)
...
function UISubAct_ChiSeJinDi_EnterWin:bindComponents()
...
function UISubAct_ChiSeJinDi_EnterWin:unbindComponents()
...
function UISubAct_ChiSeJinDi_EnterWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_EnterWin:__delete()
...
function UISubAct_ChiSeJinDi_EnterWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UISubAct_ChiSeJinDi_EnterWin:onHide()
...
function UISubAct_ChiSeJinDi_EnterWin:onEnterModel()
...
function UISubAct_ChiSeJinDi_EnterWin:onTargetBtn()
local args={
actId=self.actId,
...
function UISubAct_ChiSeJinDi_EnterWin:onRankBtn()
if self.info:checkInResultRankTime()then
...
function UISubAct_ChiSeJinDi_EnterWin:onHelpBtn()
local args={
...
function UISubAct_ChiSeJinDi_EnterWin:onDailyBtn()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin:onJumpBtn()
...
function UISubAct_ChiSeJinDi_EnterWin:isHideJumpBtn()
local passportParam=self.config.passportParam
...
function UISubAct_ChiSeJinDi_EnterWin:refreshJumpReddot()
local passportParam=self.config.passportParam
local actId=self.actId
local subType=passportParam[1]
local subId=passportParam[2]
...
function UISubAct_ChiSeJinDi_EnterWin:onLevelHelp()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_EnterWin:enterCopy()
...
function UISubAct_ChiSeJinDi_EnterWin:initView()
...
function UISubAct_ChiSeJinDi_EnterWin:startCDTick()
self:updateCDTick()
...
function UISubAct_ChiSeJinDi_EnterWin:stopCDTick()
if self.cdTick then
...
function UISubAct_ChiSeJinDi_EnterWin:updateCDTick()
...
function UISubAct_ChiSeJinDi_EnterWin:startEnterTick()
...
function UISubAct_ChiSeJinDi_EnterWin:stopEnterTick()
...
function UISubAct_ChiSeJinDi_EnterWin:refreshView()
...
function UISubAct_ChiSeJinDi_EnterWin:showView()
...
function UISubAct_ChiSeJinDi_EnterWin:openCopy()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
self:showWindow("UISubAct_ChiSeJinDi_CopyMainWin",args)
self:stopEnterTick()
end


function UISubAct_ChiSeJinDi_EnterWin:extraParamsHandle(extraParams)
if extraParams then
...
function UISubAct_ChiSeJinDi_EnterWin:refreshDailyBtn()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin:refreshDailyScore()
local data=self.info:getData()
self.dailyScore:setText(FMT.fmt("{0}/{1}",data.dailyScore,self.config.today))
end


function UISubAct_ChiSeJinDi_EnterWin:refreshCopyCost()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin:refreshRankScore()
local data=self.info:getData()

self.scoreTx:setText(FMT.fmt("段位积分：{0}",data.stageScore))
...
function UISubAct_ChiSeJinDi_EnterWin:refreshRankReward()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin:onClickRewardItem(itemid,index,itemguid,attach)
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin:startBT()
self:stopBT()
...
function UISubAct_ChiSeJinDi_EnterWin:randomBTDisciple(bt,index)
...
function UISubAct_ChiSeJinDi_EnterWin:stopBT()
if self.bt then
...
function UISubAct_ChiSeJinDi_EnterWin:randamJumpPos(bt,index)
...
function UISubAct_ChiSeJinDi_EnterWin:refreshTargetReddot()
local reddot=self.info:hasTargetFlag0()
self.targetReddot:setActive(reddot)
end

function UISubAct_ChiSeJinDi_EnterWin:checkEnterCost(costList,sIndex,callback)
sIndex=sIndex or 1
...
function UISubAct_ChiSeJinDi_EnterWin.on_249_231(args)
local actId=args[1]
...
function UISubAct_ChiSeJinDi_EnterWin.on_249_233(actId,subId,stageIdx)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_EnterWin.on_249_234(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_EnterWin.on_249_235(actId,subId,targetIdx)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_EnterWin.on_249_236(args)
local actId=args[1]
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
local subId=args[2]
local round=args[4]
...
function UISubAct_ChiSeJinDi_EnterWin.on_249_240(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshView()
end
...
function UISubAct_ChiSeJinDi_EnterWin.onSubActivityDontHandleReddotChange(actId,subType,subId)
