...
UIChildSubZM=simple_class(UIChildObject)

local defaultIcon='button_zjmzongmenqh'
local _this

function UIChildSubZM:onLoaded()

end

function UIChildSubZM:onShow(isInit)
if isInit then
_this=self
end
...
function UIChildSubZM:OnButtonClick()
...
function UIChildSubZM:OnYuanZhuButtonClick()
xianjieController:reqHelpAll()
end

function UIChildSubZM:release()
...
function UIChildSubZM.refreshReddot(class,sub_typo,last_flag,flag)
...
function UIChildSubZM:refreshReddotView(isreddot)
...
function UIChildSubZM:doPunchRotation(isreddot)
