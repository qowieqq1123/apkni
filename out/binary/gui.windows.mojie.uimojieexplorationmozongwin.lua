...
def_class("UIMoJieExplorationMoZongWin",UIWindowBase)
...
function UIMoJieExplorationMoZongWin:bindComponents()
...
function UIMoJieExplorationMoZongWin:unbindComponents()
...
type=mzType.eSamll,
name="低级魔宗",
iconName="icon_mojieditubiaoshi_1",
},
{
type=mzType.eBig,
name="高级魔宗",
iconName="icon_mojieditubiaoshi_2",
}
}

local abname="ui/windows/xianjie/xianjiehud2icons_atlas_pak.ab"

function UIMoJieExplorationMoZongWin:onLoaded(...)
_this=self
self:bindComponents()
self.selectId=1
self.monster_type=0
...
function UIMoJieExplorationMoZongWin:__delete()
self:unbindComponents()
_this=nil
end


function UIMoJieExplorationMoZongWin:onHide()
...
function UIMoJieExplorationMoZongWin:onShow(argtable,afterOnloaded)
...
function UIMoJieExplorationMoZongWin:playEnterAnim()
...
function UIMoJieExplorationMoZongWin:playLeaveAnim()
...
function UIMoJieExplorationMoZongWin:inititem()
...
function UIMoJieExplorationMoZongWin:onChooseBtn(idx)
...
function UIMoJieExplorationMoZongWin:onLvltips()
...
function UIMoJieExplorationMoZongWin:onTabtn()
...
function UIMoJieExplorationMoZongWin:handlejump()
