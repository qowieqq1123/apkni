...
local xjEntityData_MGZDHuLingTa={}


function xjEntityData_MGZDHuLingTa:onInit()
...
function xjEntityData_MGZDHuLingTa:createEntity(needRefreshAOI)
if xianjieModel:checkSceneIndex(self.sceneidx)and self.ent_key==nil then
self.ent_key=xianjieController:addEntity(XJ_ENTITY_TYPE.eMGZDHuLingTa,{self.buildID},needRefreshAOI)
return true
end
...
function xjEntityData_MGZDHuLingTa:refreshData(d)

end


function xjEntityData_MGZDHuLingTa:onDelete()

end

function xjEntityData_MGZDHuLingTa:getCfg()
return cfgHelper.get1(cfg_fairylandclientbuildconfig_get,self.entityId)
end

function xjEntityData_MGZDHuLingTa:getAtkSize()
local cfg=self:getCfg()
...
return xjEntityData_MGZDHuLingTa