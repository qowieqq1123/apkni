...
def_class("xzsChildYueLongChi",UICloneObject)





xzsChildYueLongChi.abName="ui/windows/xiaozhushou/child/xzschildyuelongchi.ab"

xzsChildYueLongChi.assetName="xzsChildYueLongChi"


function xzsChildYueLongChi:bindComponents()
...
function xzsChildYueLongChi:unbindComponents()
...
function xzsChildYueLongChi:onLoaded(...)
self:bindComponents()
end


function xzsChildYueLongChi:__delete()
...
function xzsChildYueLongChi:onShow(argtable,afterOnloaded)
...
function xzsChildYueLongChi:onHide()

end

function xzsChildYueLongChi:refreshRewards()
