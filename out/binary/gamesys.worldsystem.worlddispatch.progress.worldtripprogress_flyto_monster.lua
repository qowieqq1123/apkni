worldTripProgress_FlyTo_Monster=simple_class(worldTripProgress_FlyTo)
worldTripProgress_FlyTo_Monster.name="worldTripProgress_FlyTo_Monster"

function worldTripProgress_FlyTo_Monster:addTrigger()
