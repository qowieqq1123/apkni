...
def_class("UIZongmenLevelInvestorBuyWin",UIWindowBase)
...
function UIZongmenLevelInvestorBuyWin:bindComponents()
...
function UIZongmenLevelInvestorBuyWin:unbindComponents()
...
function UIZongmenLevelInvestorBuyWin:onLoaded(...)
self:bindComponents()
end


function UIZongmenLevelInvestorBuyWin:__delete()
self:clearTimer()
...
function UIZongmenLevelInvestorBuyWin:onShow(argtable,afterOnloaded)
...
function UIZongmenLevelInvestorBuyWin:onHide()
self:clearTimer()
end


function UIZongmenLevelInvestorBuyWin:setSpineCallBackFun()
self:clearTimer()
...
function UIZongmenLevelInvestorBuyWin:refresh()
...
function UIZongmenLevelInvestorBuyWin:refreshShowPanel()
...
function UIZongmenLevelInvestorBuyWin:initRewardsList()
...
function UIZongmenLevelInvestorBuyWin:onBuyBtn()
...
function UIZongmenLevelInvestorBuyWin:onCancelBtn()
self:onClickClose()
end


function UIZongmenLevelInvestorBuyWin:onClickClose()
self:closeSelf()
end


function UIZongmenLevelInvestorBuyWin:onClickRewardItem(itemId,index,guid,attach)
if itemId==-1 then
return
end
...
function UIZongmenLevelInvestorBuyWin:clearTimer()
