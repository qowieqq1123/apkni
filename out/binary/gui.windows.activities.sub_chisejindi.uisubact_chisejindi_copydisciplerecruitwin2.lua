...
def_class("UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:unbindComponents()
...
[1]={{-10,132}},
[2]={{-394,160},{384,160}},
[3]={{-394,160},{-10,132},{384,160}},
}



function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:__delete()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onHide()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onFireBtn()
local args={
actId=self.actId,
...
self:showWindow("UISubAct_ChiSeJinDi_CopyDiscipleSellWin2",args)
end


function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onRefreshBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onGoBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onFazeBtn()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onDiscipleBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onWeaponBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:initView()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:refreshMoneyNum(onlyTab)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:checkCloseWin(warning)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:refreshRound()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:showBackBtn()
self.showBack=true
self.goBtn:setActive(self.showBack)
end

function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:refreshList(onlyAnim)
local roundData=self.copyData.roundData
self.employeeList:setChildLayoutGroupCreateItems(roundData.len)
local items=self.employeeList:getChildLayoutGroupGridList()
local posList=_itemPos[items.Count]
...
local discipleID=data.param_1
local levelUpID=nil
for idx,id in ipairs(self.copyData.discipleList)do
...
item:SetChildAnchoredPos(_itemCmp.widget,pos[1],pos[2])
...
local attrStr=helper.getAttributeStr(i,attrValue,2,"<color=#65615f>{0}</color>          {1}")
...
item:SetChildUIModelShowTarget(_itemCmp.background,5785,1,{},_animationID.enter,false,false,0)
end
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:onClickRecruit(index)
if self.tweener or not self.showList then return end
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:closeList()
local items=self.employeeList:getChildLayoutGroupGridList()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2:setItemRecruit(index)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2.on_249_238(actId,subId,index)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2.on_249_239(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2.on_249_241(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoneyNum()
end
