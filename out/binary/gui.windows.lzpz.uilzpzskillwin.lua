...
def_class("UILZPZSkillWin",UIWindowBase)
...
function UILZPZSkillWin:bindComponents()
...
function UILZPZSkillWin:unbindComponents()
...
function UILZPZSkillWin:onLoaded(...)
self:bindComponents()
end


function UILZPZSkillWin:__delete()
...
function UILZPZSkillWin:onShow(argtable,afterOnloaded)
self.id=argtable.id
...
function UILZPZSkillWin:onHide()
...
function UILZPZSkillWin:onApplyBtn()
...
lingZhenPengZhuangController:reqUseSkill(self.id)
self:closeSelf()
end,WARNING_TYPE.eWarning)
else

UIManager:callWindowFunc('UILingZhenPZGameExWin','handleSkill',self.id)
self:closeSelf()
end
...
function UILZPZSkillWin:onCloseClick()
local id=self.id
if id==4 then
local okCB=function()
UIManager:callWindowFunc('UILingZhenPZGameExWin','showFailureWin')
self:closeSelf()
end
...
function UILZPZSkillWin:onGiveUpBtn()
self:onCloseClick()
end

function UILZPZSkillWin:onMask()
self:onCloseClick()
end