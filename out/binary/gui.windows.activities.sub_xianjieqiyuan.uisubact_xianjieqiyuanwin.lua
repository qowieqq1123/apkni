...
def_class("UISubAct_xianjieqiyuanWin",UIWindowBase)
...
function UISubAct_xianjieqiyuanWin:bindComponents()
...
self.effectBottom_1=UIObject.get(self,4)
self.effectBottom_10=UIObject.get(self,5)
self.effectBottom_2=UIObject.get(self,6)
self.effectBottom_3=UIObject.get(self,7)
self.effectBottom_4=UIObject.get(self,8)
self.effectBottom_5=UIObject.get(self,9)
self.effectBottom_6=UIObject.get(self,10)
self.effectBottom_7=UIObject.get(self,11)
self.effectBottom_8=UIObject.get(self,12)
self.effectBottom_9=UIObject.get(self,13)
self.effectBottomRoot=UIObject.get(self,14)
self.effectCenter=UIObject.get(self,15)
self.effectMid=UIObject.get(self,16)
self.equipBtn=UIButton.get(self,17)
self.equipItem=UIBaseItem.get(self,18)
self.message2Txt=UIText.get(self,19)
self.messageFrame=UIObject.get(self,20)
self.messageMask=UIObject.get(self,21)
self.messageTxt=UIText.get(self,22)
self.money1Root=UIObject.get(self,23)
self.money2Root=UIObject.get(self,24)
self.oneCostDesc=UIText.get(self,25)
self.oneCostIcon=UIImage.get(self,26)
self.oneCostReddot=UIObject.get(self,27)
self.oneFreeDesc=UIText.get(self,28)
self.rewadProgress=UIObject.get(self,29)
self.rewardContent=UIObject.get(self,30)
self.rewardNumTxt=UIText.get(self,31)
self.rewardScrollView=UIObject.get(self,32)
self.rightRoot=UIObject.get(self,33)
self.roleList=UIEnhancedScrollerLua.get(self,34)
self.root=UIObject.get(self,35)
self.singleRoleItem=UIObject.get(self,36)
self.skipBtn=UIButton.get(self,37)
self.skipSelectImg=UIObject.get(self,38)
...
self.topRoot=UIObject.get(self,43)
self.isShowReddotBtn=UIButton.get(self,44)
...
function UISubAct_xianjieqiyuanWin:unbindComponents()
...
function UISubAct_xianjieqiyuanWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_xianjieqiyuanWin:__delete()
...
function UISubAct_xianjieqiyuanWin:onShow(argtable,afterOnloaded)
...
self.bgImg:setChildUIModelEnableInitUISpinePara(false,true)
self.bgImg:setChildUIModelShowTarget(5236,1,{},0,false,false,0,function()
...
function UISubAct_xianjieqiyuanWin:onHide()
self:stopBgAudioSound()
end
...
function UISubAct_xianjieqiyuanWin.onShowPrize(prizeType,temp,effectData)
if _this==nil then return end
...
function UISubAct_xianjieqiyuanWin.on_item_changed(changeType,itemguid,itemid,oldcount,newcount)
if _this==nil then return end
...
function UISubAct_xianjieqiyuanWin.on_money_changed(moneyType,lastVal,val)
if _this==nil then return end
...
function UISubAct_xianjieqiyuanWin:initMoneyData(datas)
local moneyList={}
local moneyLookup={}
for i=1,2 do
local data=datas[i]
...
function UISubAct_xianjieqiyuanWin:initMoneyItem(money)
...
function UISubAct_xianjieqiyuanWin:refreshMoneyItem(money,lastVal)
local moneyType=money[2]
local widget=money[1]
local isshow=moneyType~=nil
widget:SetChildActive(-1,isshow)
...
function UISubAct_xianjieqiyuanWin:onAddClick(moneyType)
gainControl:showCommonGainWin_item(moneyType)
end

function UISubAct_xianjieqiyuanWin:clickMoney(moneyType)
...
function UISubAct_xianjieqiyuanWin:clearFMTweener(mtype)
...
function UISubAct_xianjieqiyuanWin:recordAllNotFullOpenItem(isclear)
...
function UISubAct_xianjieqiyuanWin:refreshDesc()
local icon
...
function UISubAct_xianjieqiyuanWin:refreshActTimer()
...
function UISubAct_xianjieqiyuanWin:initModelView()
...
function UISubAct_xianjieqiyuanWin:refreshModelLove()
...
function UISubAct_xianjieqiyuanWin:setSignleModel(index,color,callback)
...
function UISubAct_xianjieqiyuanWin:onBeginDrag(id,pos)
...
function UISubAct_xianjieqiyuanWin:onEndDrag(id,pos)
...
function UISubAct_xianjieqiyuanWin:onDrag(id,pos,dt)
if self.dragPos==nil or self.dragFlag==nil then return end
...
function UISubAct_xianjieqiyuanWin:startAutoSwitch()
...
function UISubAct_xianjieqiyuanWin:stopAutoSwitch()
...
function UISubAct_xianjieqiyuanWin:doSwitchTo(index)
self:stopAutoSwitch()
...
function UISubAct_xianjieqiyuanWin:startAutoScroll()
...
function UISubAct_xianjieqiyuanWin:stopAutoScroll()
...
function UISubAct_xianjieqiyuanWin:refreshEquipLove()
...
function UISubAct_xianjieqiyuanWin:onEquipBtn()
...
function UISubAct_xianjieqiyuanWin:initRewardPanel(anim,isInit)
...
function UISubAct_xianjieqiyuanWin:onClickItem(index)
local total=self.myData.total
local flag=self.myData.flag
...
function UISubAct_xianjieqiyuanWin:onTipsBtn()
...
function UISubAct_xianjieqiyuanWin:onShopBtn()
...
function UISubAct_xianjieqiyuanWin:onViewBtn(itemid)
if self.playingAnim then return end
UIRecruitControl:showItemDiscipleInfoByItemId2(itemid)
end

function UISubAct_xianjieqiyuanWin:onUpBtn()
local args={
actId=self.actID,
...
self:showWindow('UISubAct_xianjieqiyuan_SelectLoveDialog',args)
end

function UISubAct_xianjieqiyuanWin:refreshSkipBtn()
...
function UISubAct_xianjieqiyuanWin:onSkipBtn()
...
function UISubAct_xianjieqiyuanWin:getFastBuy()
local d=self.fastBuy[1]
return d[1],d[2]
end

function UISubAct_xianjieqiyuanWin:refreshCostBtn()
...
function UISubAct_xianjieqiyuanWin:onOneBtn()
self:check_useItem(1,1,1)
end

function UISubAct_xianjieqiyuanWin:onTenBtn()
self:check_useItem(10,2,1)
end

function UISubAct_xianjieqiyuanWin:check_useItem(usecnt,typo,typo2)
...
function UISubAct_xianjieqiyuanWin:useItem(usecnt,typo,typo2)
local itemid=self.sub_actcfg.itemid
local actID=self.actID
local subType=self.subType
local subid=self.subid
...
activitiesController:sendProtocol(actSendType.eComonReqHandle,actID,subType,subid,json_str)
UIManager:invokeUIMethod('UISubAct_xianjjieqiyuan_rewardWin','clearClickLock')
end
local closeback=function()
if _this==nil then return end
UIManager:invokeUIMethod('UISubAct_xianjjieqiyuan_rewardWin','clearClickLock',true)
end
...
function UISubAct_xianjieqiyuanWin:testAnim(typo,colors)
local func=function()
if _this==nil then return end
...
function UISubAct_xianjieqiyuanWin:playResultAnim(typo,colors,func)
...
self:lotterySizePos(randomCnt,type,sizeList,posList,effectPosList)
else

end
else
self:lotterySizePos(least,type,sizeList,posList,effectPosList)
end
end
...
args[colorKey]=_effectID[effectInfo.size][effectInfo.color]
...
function UISubAct_xianjieqiyuanWin:resetResultAnim()
...
self.bgImg:setChildModelAnimationState(eAnimationID.stand,1)
end

function UISubAct_xianjieqiyuanWin:lotteryPos(posList,sizeType)
...
function UISubAct_xianjieqiyuanWin:lotterySizePos(count,sizeType,oTypeList,oPosList,iPosList)
...
function UISubAct_xianjieqiyuanWin:initMessage()
...
function UISubAct_xianjieqiyuanWin:updateMessage()
...
function UISubAct_xianjieqiyuanWin:addMessage()
local obj_idx=nil
...
function UISubAct_xianjieqiyuanWin:removeMessage(idx)
local f
...
function UISubAct_xianjieqiyuanWin:onBtnClose()
UIManager:invokeUIMethod(self.parentWin,'onBtnClose')
end



function UISubAct_xianjieqiyuanWin:rec_selectUp()
...
function UISubAct_xianjieqiyuanWin:rec_selectEquip()
self:refreshEquipLove()
...
function UISubAct_xianjieqiyuanWin:rec_chouka()
self:initRewardPanel(true)
end

function UISubAct_xianjieqiyuanWin:show_chouka_reward()
if not self.skipFlag then
self:closeWindow('UISubAct_xianjjieqiyuan_rewardWin')
end
...
args.parentWin='UISubAct_xianjieqiyuanWin'
args.openBack=function()
if _this==nil then return end
_this.clickLockTime=nil
end
local func=function()
self:showWindow('UISubAct_xianjjieqiyuan_rewardWin',args)
self:refreshDesc()
end
...
self.root:setChildCanvasGroupRaycast(false)
self.root:setChildCanvasGroupDOFade(0,0.35)
self.winlua:SetChildModelAnimationStop(self.bgImg:getID(),eAnimationID.zhidui_enter,1)
self:showWindow('UISubAct_xianjjieqiyuan_rewardWin',args)
self:refreshDesc()
end
...
function UISubAct_xianjieqiyuanWin:rec_tagReward(actID,subType,subid)
self:initRewardPanel()
end

function UISubAct_xianjieqiyuanWin:stopBgAudioSound()
...
function UISubAct_xianjieqiyuanWin:roleJumpTo(index,tweenTime,callback)
self.scrollscript:jumpToDataIndex(index,0,0,true,tweenTime<=0 and 0 or 4,math.max(tweenTime,0),callback)
end

function UISubAct_xianjieqiyuanWin:printItemIndex()

end

function UISubAct_xianjieqiyuanWin:printScrollRectNormalizedPosition()
local pos=_this.winlua:GetChildScrollRectNormalizedPosition(_this.roleList:getID(),true)

end

function UISubAct_xianjieqiyuanWin:doCheckScrollDone()
...
function UISubAct_xianjieqiyuanWin:cancelCheckScrollDone()
...
function UISubAct_xianjieqiyuanWin:refreshIsShowReddotBtn()
...
function UISubAct_xianjieqiyuanWin:onIsShowReddotBtn()
local actInfo=activitiesModel:getSubActInfo(self.actID,self.subType,self.subid)
local isShowReddot=actInfo:checkIsShowReddot()
...
function UISubAct_xianjieqiyuanWin.onSubActivityOverBeforeEndTime24Hour(actId,subType,subId)
if _this==nil then return end
