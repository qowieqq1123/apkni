...
local xjEntityHud_RPEvent={}


function xjEntityHud_RPEvent:onInit()
...
function xjEntityHud_RPEvent:onCreateWidget(widget)
self.dataGuid=self.data.guid
local data=xianjieModel:getResPointData(self.dataGuid)
local cfg=data:getCfg()
...
function xjEntityHud_RPEvent:onRemoveWidget(widget)

end


function xjEntityHud_RPEvent:onDelete()

end

return xjEntityHud_RPEvent