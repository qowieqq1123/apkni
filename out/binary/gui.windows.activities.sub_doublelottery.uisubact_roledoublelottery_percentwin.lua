...
def_class("UISubAct_roledoubleLottery_PercentWin",UIWindowBase)
...
function UISubAct_roledoubleLottery_PercentWin:bindComponents()
...
function UISubAct_roledoubleLottery_PercentWin:unbindComponents()
...
function UISubAct_roledoubleLottery_PercentWin:onLoaded(...)
self:bindComponents()
end


function UISubAct_roledoubleLottery_PercentWin:__delete()
...
function UISubAct_roledoubleLottery_PercentWin:onShow(argtable,afterOnloaded)
self.percentTypeCfgList=argtable and argtable.percentList or{}
self:refresh()
end


function UISubAct_roledoubleLottery_PercentWin:onHide()

end

function UISubAct_roledoubleLottery_PercentWin:refresh()
...
function UISubAct_roledoubleLottery_PercentWin:onClickMask()
self:onCloseBtn()
end


function UISubAct_roledoubleLottery_PercentWin:onCloseBtn()
self:closeSelf()
end


function UISubAct_roledoubleLottery_PercentWin:onClickRewardItem(itemId,index,guid,attach)
