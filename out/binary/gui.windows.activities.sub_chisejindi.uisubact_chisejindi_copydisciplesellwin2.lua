...
def_class("UISubAct_ChiSeJinDi_CopyDiscipleSellWin2",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:__delete()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onHide()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onCloseBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onSellBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onClickItem(item,id)
self.selectLookup[id]=(not self.selectLookup[id])or nil
item:SetChildActive(_itemCmp.selected,self.selectLookup[id])
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:onLongTouchItem(disciple)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:initView()
self.moneyIcon:setImageIcon(iconHelper.getIconName(self.config.chanceMoney),false)
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:refreshMoney()
local moneyStr=mathHelper.formatNumber(self.copyData.money)
self.moneyNum:setText(moneyStr)
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:updateData()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:refreshView()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2:refreshItem(item,id)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin2.on_249_241(actId,subId,roundtype,len,ids)
