...
def_class("UIXJBuildingPageBgWin",UIWindowBase)
...
function UIXJBuildingPageBgWin:bindComponents()
...
function UIXJBuildingPageBgWin:unbindComponents()
...
function UIXJBuildingPageBgWin:onLoaded(...)
_this=self
self:bindComponents()
end


function UIXJBuildingPageBgWin:__delete()
_this=nil
...
function UIXJBuildingPageBgWin:onShow(argtable,afterOnloaded)
self:setRootLPosX(0)
self:closeExtra()
...
function UIXJBuildingPageBgWin:onHide()

end

function UIXJBuildingPageBgWin.showUI()
if _this==nil then return end
if _this.markDragon==false then return end
_this:showExtra()
end

function UIXJBuildingPageBgWin:doMove(pos)
...
function UIXJBuildingPageBgWin:showCloseBtn(bShow)
self.btnClose:setActive(bShow)
end

function UIXJBuildingPageBgWin:closeExtra()
...
function UIXJBuildingPageBgWin:showExtra()
...
function UIXJBuildingPageBgWin:onLoadFinish()
...
function UIXJBuildingPageBgWin:resetRootCanves(sortLayer,sortOrder)
...
function UIXJBuildingPageBgWin:moveRoot(moveX,duration)
self.root:setChildDOLocalMoveX(moveX,duration)
end

function UIXJBuildingPageBgWin:setRootLPosX(xpos)
local pos=self.root:getChildLocalPosition()
pos.x=xpos
self.root:setChildLocalPosition(pos)
end

function UIXJBuildingPageBgWin:refreshTitle(titleName)
...
function UIXJBuildingPageBgWin:onBtnClose()
self:onCloseClick()
end

function UIXJBuildingPageBgWin:onCloseClick()
self:closeSelf()
end
