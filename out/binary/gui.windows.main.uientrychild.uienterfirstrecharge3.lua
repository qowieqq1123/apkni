...
def_class("UIEnterFirstRecharge3",UICloneObject)





UIEnterFirstRecharge3.abName="ui/windows/main/uientrychild/uienternomalitem.ab"

UIEnterFirstRecharge3.assetName="UIEnterNomalItem"


function UIEnterFirstRecharge3:bindComponents()
...
function UIEnterFirstRecharge3:unbindComponents()
...
function UIEnterFirstRecharge3:onLoaded(...)
self:bindComponents()
end


function UIEnterFirstRecharge3:__delete()
...
function UIEnterFirstRecharge3:onShow(argtable,afterOnloaded)
...
UIManager:showWindow("UIFirstRechargeWin3",{id=self.selectIndex})
end,true)
...
function UIEnterFirstRecharge3:onHide()
...
function UIEnterFirstRecharge3:freshReddot()

UIManager:invokeUIMethod('UIMain','freshSimpleBtnReddot')
local reddot,cfgIndex=firstRecharge3Model:checkMainEnterReddot()
self.widget:SetChildActive(1,reddot)

self.selectIndex=firstRecharge3Model:getTabSelectIndexBySortCfgIndex(cfgIndex)

local nextRefreshTime=firstRecharge3Model:getNextRefreshTime()
...
function UIEnterFirstRecharge3:startTimer(nextRefreshTime)
self:stopSelfTimer()
...
function UIEnterFirstRecharge3:stopSelfTimer()
if self.timer then
...
function UIEnterFirstRecharge3:onIcon()

end

function UIEnterFirstRecharge3:onClickBg()
