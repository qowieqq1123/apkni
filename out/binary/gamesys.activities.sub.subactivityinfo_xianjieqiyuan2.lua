...
local subActivityInfo_xianjieqiyuan2={name='xianjieqiyuan2'}

function subActivityInfo_xianjieqiyuan2:onInit()

end

function subActivityInfo_xianjieqiyuan2:onStart()

end

function subActivityInfo_xianjieqiyuan2:onUpdate()

end

function subActivityInfo_xianjieqiyuan2:onDelete()

end

function subActivityInfo_xianjieqiyuan2:checkReddot()
local data=self.data
if data then
local sub_actcfg=self:getSubActConfig()

if activitiesHandle_xianjieqiyuan2.checkHasFree(self.sub_act_type,self.sub_act_id,data.free)then
return true
end
...
function subActivityInfo_xianjieqiyuan2:handleNote(note)
...
function subActivityInfo_xianjieqiyuan2:initNotes(loglist)
local notesList={}
if loglist then
...
function subActivityInfo_xianjieqiyuan2:setNotesNew(loglist)
...
function subActivityInfo_xianjieqiyuan2:getOneNoteStr()
local data=self.data
...
function subActivityInfo_xianjieqiyuan2:clearNoteSelect()
local data=self.data
if data then
...
return subActivityInfo_xianjieqiyuan2