...
local subActivityInfo_rolelingzhendiaoke={name='rolelingzhendiaoke'}

function subActivityInfo_rolelingzhendiaoke:onInit()

end

function subActivityInfo_rolelingzhendiaoke:onStart()

end

function subActivityInfo_rolelingzhendiaoke:onUpdate()

end

function subActivityInfo_rolelingzhendiaoke:onDelete()

end

function subActivityInfo_rolelingzhendiaoke:checkReddot()
return false

end


function subActivityInfo_rolelingzhendiaoke:checkNewDay()
if self:checkDoing()then
local data=self.data
if data then
local mydata=activitiesModel:getSubActInfoData(self.act_id,SUB_ACTIVITY_TYPE.eLingZhenHuiHua2,self.sub_act_id)
mydata.topScore=0
activitiesModel:setSubActInfoData(self.act_id,SUB_ACTIVITY_TYPE.eLingZhenHuiHua2,self.sub_act_id,mydata)
end
end
end


function subActivityInfo_rolelingzhendiaoke:startActTime()
...
function subActivityInfo_rolelingzhendiaoke:isReceive(id)
return false
end


function subActivityInfo_rolelingzhendiaoke:getTopScore()
...
function subActivityInfo_rolelingzhendiaoke:getLingZhenCamp()
if not self.data then
return
end
local data=activitiesModel:getSubActInfoData(self.act_id,self.sub_act_type,self.sub_act_id)
if data==nil then return end
return data.campId or 1
end


function subActivityInfo_rolelingzhendiaoke:getLingZhenCampScoreDataByCampId(campId)
if not self.data then
return
end
local data=activitiesModel:getSubActInfoData(self.act_id,self.sub_act_type,self.sub_act_id)
...
function subActivityInfo_rolelingzhendiaoke:getNextUpdateDataTime()
if not self.data then
return
end
local data=activitiesModel:getSubActInfoData(self.act_id,self.sub_act_type,self.sub_act_id)
...
function subActivityInfo_rolelingzhendiaoke:getTodayMapData()
if not self.data then
...
function subActivityInfo_rolelingzhendiaoke:getMaxScore()
if not self.data then
...
function subActivityInfo_rolelingzhendiaoke:getQuickFlag()
if not self.data then
logErr("lingzhendiaoke not have data")
return
end
...
function subActivityInfo_rolelingzhendiaoke:setLingZhenPengZhuangGameData(createList,itemList,combineList,selectQueue,recordList,skillCount,score,mapExpireTime,selectMapId)
self.data.gameData={}
...
function subActivityInfo_rolelingzhendiaoke:clearLingZhenPengZhuangGameData()
...
function subActivityInfo_rolelingzhendiaoke:getLingZhenPengZhuangGameData()
if not self.data or not self.data.gameData then
return nil
end
...
function subActivityInfo_rolelingzhendiaoke:saveLingZhenPengZhuangGameData()
if not self.data then
return
end
local data=activitiesModel:getSubActInfoData(self.act_id,self.sub_act_type,self.sub_act_id)
...
function subActivityInfo_rolelingzhendiaoke:loadLingZhenPengZhuangGameData()
if not self.data then
return
end
local data=activitiesModel:getSubActInfoData(self.act_id,self.sub_act_type,self.sub_act_id)
...
function subActivityInfo_rolelingzhendiaoke:test_clearLingZhenPengZhuangGameData()
if not self.data then
return
end
self.data.gameData=nil
...
return subActivityInfo_rolelingzhendiaoke