...
def_class("UIZheXianLingZJDescWin",UIWindowBase)
...
function UIZheXianLingZJDescWin:bindComponents()

self.nameChapter=UIText.get(self,0)
self.name=UIText.get(self,1)
self.itemsRoot=UIObject.get(self,2)
self.wanfaItem1=UIObject.get(self,3)
self.wanfaItem2=UIObject.get(self,4)
...
function UIZheXianLingZJDescWin:unbindComponents()
...
function UIZheXianLingZJDescWin:onLoaded(...)
self:bindComponents()
self.wanfalist={}
...
function UIZheXianLingZJDescWin:__delete()
self:unbindComponents()
end

function UIZheXianLingZJDescWin:onShow(argtable,afterOnloaded)
...
function UIZheXianLingZJDescWin:onHide()
