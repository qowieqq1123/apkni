...
def_class("UICourtroomGameTipsWin",UIWindowBase)
...
function UICourtroomGameTipsWin:bindComponents()
...
function UICourtroomGameTipsWin:unbindComponents()
...
function UICourtroomGameTipsWin:onLoaded(...)
self:bindComponents()
end


function UICourtroomGameTipsWin:__delete()
...
function UICourtroomGameTipsWin:onShow(argtable,afterOnloaded)
...
function UICourtroomGameTipsWin:onHide()
