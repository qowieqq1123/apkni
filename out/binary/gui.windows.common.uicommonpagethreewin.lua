...
def_class("UICommonPageThreeWin",UIWindowBase)
...
function UICommonPageThreeWin:bindComponents()
...
function UICommonPageThreeWin:unbindComponents()
...
function UICommonPageThreeWin:onLoaded(...)
_this=self
self:bindComponents()
end


function UICommonPageThreeWin:__delete()
_this=nil
...
function UICommonPageThreeWin:onHide()
...
function UICommonPageThreeWin:onShow(argtable,afterOnloaded)
self:closeExtra()
...
function UICommonPageThreeWin.showUI()
if _this==nil then return end
if _this.markDragon==false then return end
_this:showExtra()
end

function UICommonPageThreeWin:showCloseBtn(bShow)
self.btnClose:setActive(bShow)
end

function UICommonPageThreeWin:closeExtra()
...
function UICommonPageThreeWin:showExtra()
...
function UICommonPageThreeWin:onLoadFinish()
...
function UICommonPageThreeWin:resetRootCanves(sortLayer,sortOrder)
...
function UICommonPageThreeWin:onClickMask()
self:onCloseClick()
end

function UICommonPageThreeWin:onBtnClose()
self:onCloseClick()
end


function UICommonPageThreeWin:onCloseClick()
self:closeSelf()
end