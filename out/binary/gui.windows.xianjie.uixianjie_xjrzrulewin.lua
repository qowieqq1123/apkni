...
def_class("UIXianJie_XJRZRuleWin",UIWindowBase)
...
function UIXianJie_XJRZRuleWin:bindComponents()
...
function UIXianJie_XJRZRuleWin:unbindComponents()
...
function UIXianJie_XJRZRuleWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UIXianJie_XJRZRuleWin:__delete()
...
function UIXianJie_XJRZRuleWin:onShow(argtable,afterOnloaded)
...
function UIXianJie_XJRZRuleWin:onHide()
...
function UIXianJie_XJRZRuleWin:onBackground()
