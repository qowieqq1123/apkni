...
def_class("UISubAct_fyslZenYiLCWin",UIWindowBase)
...
function UISubAct_fyslZenYiLCWin:bindComponents()
...
function UISubAct_fyslZenYiLCWin:unbindComponents()
...
function UISubAct_fyslZenYiLCWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_fyslZenYiLCWin:__delete()
...
function UISubAct_fyslZenYiLCWin:onShow(argtable,afterOnloaded)
...
function UISubAct_fyslZenYiLCWin:onHide()
...
function UISubAct_fyslZenYiLCWin:onFazebtn()
end

function UISubAct_fyslZenYiLCWin:onDizibtn()
end

function UISubAct_fyslZenYiLCWin:onSkillItem()
end

function UISubAct_fyslZenYiLCWin:onBtnClose()
self:closeSelf()
end
function UISubAct_fyslZenYiLCWin:onBlackBG()
self:closeSelf()
end
function UISubAct_fyslZenYiLCWin:onClickMask()
end


function UISubAct_fyslZenYiLCWin:onCuitibtn()
local d={}
d.title='淬体等级说明'
d.mode=3
