worldDispatchTask_Run_Experience=simple_class(worldDispatchTask)
worldDispatchTask_Run_Experience.name="worldDispatchTask_Run_Experience"

function worldDispatchTask_Run_Experience:express()
...
function worldDispatchTask_Run_Experience:init()
self.progress_state=eWorldTripProgress.Work
self.progress_begin=timeHelper.getServerShortTime()
self.progress_end=0
end

function worldDispatchTask_Run_Experience:back()
...
function worldDispatchTask_Run_Experience:correct()
local fogCfg=cfgHelper.get1(cfg_worldfogconfig_get,self.target_id)
