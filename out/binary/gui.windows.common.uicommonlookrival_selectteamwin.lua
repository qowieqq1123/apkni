...
def_class("UICommonLookRival_selectTeamWin",UIWindowBase)
...
function UICommonLookRival_selectTeamWin:bindComponents()
...
function UICommonLookRival_selectTeamWin:unbindComponents()
...
function UICommonLookRival_selectTeamWin:onLoaded(...)
_this=self
self:bindComponents()
end


function UICommonLookRival_selectTeamWin:__delete()
...
function UICommonLookRival_selectTeamWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UICommonLookRival_selectTeamWin:onHide()

end

function UICommonLookRival_selectTeamWin:refresh()
...
function UICommonLookRival_selectTeamWin:onTeamBtnClick(teamIndex)
