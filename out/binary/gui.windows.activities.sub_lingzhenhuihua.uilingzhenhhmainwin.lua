...
def_class("UILingZhenHHMainWin",UIWindowBase)
...
function UILingZhenHHMainWin:bindComponents()
...
function UILingZhenHHMainWin:unbindComponents()
...
function UILingZhenHHMainWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UILingZhenHHMainWin:__delete()
_this=nil
...
function UILingZhenHHMainWin:onShow(argtable,afterOnloaded)
...
local npcSpeakParam=cfgHelper.get(cfg_lingzhenhuihuaconfig_get,self.subid,"npcSpeakParam")
...
if not timeHelper.isTodayStamp(timeHelper.convertLongStamp(serverStamp))then
...
function UILingZhenHHMainWin:onShowArgRecv(argtable,afterOnloaded)
...
function UILingZhenHHMainWin:onHide()
self:clearTimer()
self:clearSpeakTimer()
self:clearEffect()
end

function UILingZhenHHMainWin:refresh(isInit)
...
function UILingZhenHHMainWin:refreshSelectCampPanel()
...
function UILingZhenHHMainWin:refreshStartGamePanel(isChange)
if isChange then
self.campId=self.info:getLingZhenCamp()
...
function UILingZhenHHMainWin:refreshProgressPanel(isNeedJump)
local allRewardCfg=cfgHelper.get(cfg_lingzhenhuihuaconfig_get,self.subid,"stage")
...
function UILingZhenHHMainWin:refreshCampShowPanel(campId)
...
local allCampNameCfg=cfgHelper.get(cfg_lingzhenhuihuaconfig_get,self.subid,"camp")
...
local allRewardList=cfgHelper.get(cfg_lingzhenhuihuaconfig_get,self.subid,"reward")
...
function UILingZhenHHMainWin:clearEffect()
for i=1,2 do
...
function UILingZhenHHMainWin:setRemainingTimeTimer()
if self.info then
self:clearTimer()
local func=function()
...
function UILingZhenHHMainWin:clearTimer()
if self.timer then
...
function UILingZhenHHMainWin:doSpeaking()
self:clearSpeakTimer()

local speakLib=cfgHelper.get(cfg_lingzhenhuihuaconfig_get,self.subid,"npcSpeakLib")
...
function UILingZhenHHMainWin:doTalkAnim()
...
function UILingZhenHHMainWin:talkEnd()
self:clearSpeakTimer()
...
function UILingZhenHHMainWin:clearSpeakTimer()
...
function UILingZhenHHMainWin:onCloseBtn()
...
function UILingZhenHHMainWin:onHelpBtn()
end



function UILingZhenHHMainWin:onStartBtn()
UIFullLingZhenHuiHuaControl:showGameWin(_this.activityArgs)

end



function UILingZhenHHMainWin:onRuleBtn()
...
function UILingZhenHHMainWin:onShopBtn()
local config=cfgHelper.get1(cfg_lingzhenhuihuaconfig_get,self.subid)
...
function UILingZhenHHMainWin:onLianzhiBtn()
...
function UILingZhenHHMainWin:onSelectCampBtn1()
...
function UILingZhenHHMainWin:onSelectCampBtn2()
...
function UILingZhenHHMainWin:onRandomCampBtn()
if self.campId and self.campId~=0 then

return
end
activitiesHandle_lingzhendiaoke:reqSelectCampById(_this.actid,_this.subType,_this.subid)
end

function UILingZhenHHMainWin:onClickRewardItem(itemId,index,guid,attach)
if itemId==-1 then
return
end
