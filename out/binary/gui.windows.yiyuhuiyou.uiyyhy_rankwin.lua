...
def_class("UIYYHY_RankWin",UIWindowBase)
...
function UIYYHY_RankWin:bindComponents()
...
function UIYYHY_RankWin:unbindComponents()
...
function UIYYHY_RankWin:onLoaded(...)
_this=self
self:bindComponents()
end


function UIYYHY_RankWin:refreshMenuItemSelect(item,idx,flag)
if item==nil then
...
function UIYYHY_RankWin:refreshMenuItemReddot(item,idx)
if item==nil then
item=self.menuGridPanel:getChildLayoutGroupGridItem(idx-1)
end
...
function UIYYHY_RankWin:onMenuItemClick(page)
...
function UIYYHY_RankWin:refreshMenuPage(page,flag)
...
function UIYYHY_RankWin:__delete()
_this=nil
self:unbindComponents()
end


function UIYYHY_RankWin:onHide()
...
function UIYYHY_RankWin:onShow(argtable,afterOnloaded)
local page=argtable and argtable.page or 1
self.refreshMark={}
local level=0
local titleName
if level>0 then
...
function UIYYHY_RankWin:getRankReward(typo,rank,look)
...
function UIYYHY_RankWin:openXianMengPage()
...
function UIYYHY_RankWin:closeXianMengPage()
self.rankScrollView:setActive(false)
self.rankItem:setActive(false)
end


function UIYYHY_RankWin:openMemberPage()
...
function UIYYHY_RankWin:closeMemberPage()
self.rankScrollView:setActive(false)
self.rankItem:setActive(false)
end


function UIYYHY_RankWin:refreshTips()
local tips_str
...
function UIYYHY_RankWin:refreshRankItem()
...
function UIYYHY_RankWin:getRewardPageSortList()
local list={}
...
function UIYYHY_RankWin:openRewardPage()
local rankList,lqmaxid=self:getRewardPageSortList()
local num=#rankList
local isShow=num>0
...
function UIYYHY_RankWin:closeRewardPage()
self.rewardScrollView:setActive(false)
end


function UIYYHY_RankWin:onRewardBtn(lqmaxid)
if lqmaxid and lqmaxid>0 then
YiYuHuiYouController.send_248_61(lqmaxid)
end
end

function UIYYHY_RankWin:onClickItem(itemId,index,guid,attach)
tipsManager.showTips({itemid=itemId,itemguid=nil,move=TIPS_MOVE_POS.eLeft})
end

function UIYYHY_RankWin:onCloseBtn()
self:closeSelf()
end



function UIYYHY_RankWin:recv_reward()
if self.curPage==2 then
self:openRewardPage()
self:refreshTips()
