...
def_class("tipsChildScrollView1",UICloneObject)





tipsChildScrollView1.abName="ui/windows/tips/child/tipschildscrollview1.ab"

tipsChildScrollView1.assetName="tipsChildScrollView1"


function tipsChildScrollView1:bindComponents()
...
function tipsChildScrollView1:unbindComponents()
...
function tipsChildScrollView1:onLoaded()
self:bindComponents()
self.creater:setRefreshAction(function(...)self:onFinishCreate(...)end)
end

function tipsChildScrollView1:__delete()
self:unbindComponents()
end

function tipsChildScrollView1:onShow(args)
...
function tipsChildScrollView1:onFinishCreate()
self.len=self.len+1
