...
def_class("UIVisitorChanllengeFightLoseWin",UIWindowBase)
...
function UIVisitorChanllengeFightLoseWin:bindComponents()

self.root=UIObject.get(self,0)
self.titleTxt=UIText.get(self,1)
self.tgslpanel=UIObject.get(self,2)
self.conditionList=UIObject.get(self,3)
self.strengthenCreator=UIObject.get(self,4)
self.tgsltxt2=UIText.get(self,5)
self.tgsltxt3=UIText.get(self,6)
self.tgsltxtup=UIObject.get(self,7)
self.tgsltxtup2=UIObject.get(self,8)
self.tgsltxtup3=UIObject.get(self,9)
...
function UIVisitorChanllengeFightLoseWin:unbindComponents()
...
function UIVisitorChanllengeFightLoseWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UIVisitorChanllengeFightLoseWin:__delete()
self:unbindComponents()
_this=nil
end


function UIVisitorChanllengeFightLoseWin:onHide()
...
function UIVisitorChanllengeFightLoseWin:onShow(argtable,afterOnloaded)
...
item:SetChildActive(2,result==2)
end)
end

function UIVisitorChanllengeFightLoseWin:refreshStrengthenGrids()
...
item:SetChildNewBieComponentId(2,FMT.fmt('UIVisitorChanllengeFightLoseWin.item_{0}',i))
end
end



function UIVisitorChanllengeFightLoseWin.onClickStrengthenItem(index)
