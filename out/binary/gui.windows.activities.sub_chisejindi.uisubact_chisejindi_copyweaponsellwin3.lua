...
def_class("UISubAct_ChiSeJinDi_CopyWeaponSellWin3",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:__delete()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onHide()
end
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onCloseBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onSellBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onClickItem(item,id)
self.selectLookup[id]=(not self.selectLookup[id])or nil
item:SetChildActive(_itemCmp.selected,self.selectLookup[id])
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onLongTouchItem(weapon)
local args={
itemid=weapon,
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:refreshItem(item,id)
...
item:SetChildLongTouch(_itemCmp.widget,0,1,function(...)
self:onLongTouchItem(id)
end)
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:onClickSell(id)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:initView()
self.moneyIcon:setImageIcon(iconHelper.getIconName(self.config.chanceMoney),false)
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:refreshMoney()
local moneyStr=mathHelper.formatNumber(self.copyData.money)
self.moneyNum:setText(moneyStr)
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:updateData()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3:refreshView()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin3.on_249_241(actId,subId,roundtype,len,ids)
