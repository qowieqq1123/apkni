...
def_class("UIEnterWDCQQuFuAct",UICloneObject)





UIEnterWDCQQuFuAct.abName="ui/windows/main/uientrychild/uienternomalitem.ab"

UIEnterWDCQQuFuAct.assetName="UIEnterNomalItem"


function UIEnterWDCQQuFuAct:bindComponents()
...
function UIEnterWDCQQuFuAct:unbindComponents()
...
local iconname='button_hdrk_0068'



function UIEnterWDCQQuFuAct:onLoaded(...)
self:bindComponents()
end


function UIEnterWDCQQuFuAct:__delete()
...
function UIEnterWDCQQuFuAct:onShow(argtable,afterOnloaded)
...
function UIEnterWDCQQuFuAct:onHide()

end


function UIEnterWDCQQuFuAct:freshReddot()
local reddot=WDCQController.checkQuFuEnterReddot()
self.widget:SetChildActive(1,reddot)
end



function UIEnterWDCQQuFuAct:onClickBg()
WDCQController.clickQuFugEnter()
end

function UIEnterWDCQQuFuAct:onIcon()
WDCQController.clickQuFugEnter()
end


function UIEnterWDCQQuFuAct:stopLeftTimer()
if self.timeId then
...
function UIEnterWDCQQuFuAct:startLeftTimer()
self:stopLeftTimer()



local leftStamp=WDCQController.getQuFugEnterLeftTime()
...
if left<=0 then
WDCQController:removeQuFuActEnter()
end
end
