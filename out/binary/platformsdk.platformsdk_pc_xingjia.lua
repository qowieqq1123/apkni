...
platformSDK_PC_XingJIa=simple_class(platformSDK_None)

local cjson=require'cjson'

local _WindowsHelper=CS.XingJiaPCHelper

function platformSDK_PC_XingJIa:__init(...)
...
function platformSDK_PC_XingJIa:reqLogin()
_WindowsHelper.ExecCmd("reqLogin","")
end


function platformSDK_PC_XingJIa:reqLogout()
_WindowsHelper.ExecCmd("reqLogout","")
end



function platformSDK_PC_XingJIa:reqShowUserCenter()
_WindowsHelper.ExecCmd("onShowUserCenter","")
end


function platformSDK_PC_XingJIa:reqPay(id,count,params,subscribe)
...
function platformSDK_PC_XingJIa:reqReport(typo,info)
...
function platformSDK_PC_XingJIa:reqFangChenMi()

end


function platformSDK_PC_XingJIa:onPay(json,jsonStr)
...
function platformSDK_PC_XingJIa:LoginCallBack(json,jsonStr)
...
function platformSDK_PC_XingJIa:LogoutCallBack(json,jsonStr)
...
function platformSDK_PC_XingJIa:PurchasePaymentResult()

end


function platformSDK_PC_XingJIa:OnApplicationQuit()
local showdata=
{
type='UIDialouge',
title='温馨提示',
...
function platformSDK_PC_XingJIa:reqApplicationQuit_PC()
_WindowsHelper.ExecCmd("setQuitState","quit")
platformHelper:exitGame()
end