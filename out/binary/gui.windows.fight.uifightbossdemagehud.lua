...
def_class("UIFightBossDemageHUD",UIWindowBase)
require("lua.gui.windows.fight.FightBossHUD")
require("lua.gui.windows.fight.FightBossDemageHUD")
...
function UIFightBossDemageHUD:bindComponents()
...
function UIFightBossDemageHUD:unbindComponents()
...
function UIFightBossDemageHUD:onLoaded(...)
self:bindComponents()
self.argsList={}
self.hudList={}
self.bars={
...
function UIFightBossDemageHUD:__delete()
...
function UIFightBossDemageHUD:onShow(argtable,afterOnloaded)
self:freshView()
end


function UIFightBossDemageHUD:onHide()

end


function UIFightBossDemageHUD:freshView()
...
local hud=FightBossDemageHUD(info)
...
function UIFightBossDemageHUD:releaseAllHud()
...
function UIFightBossDemageHUD:hideAllTxPanel()
for k,v in pairs(bars)do
local info=self.argsList[v]
if info then
self.winlua:SetChildActive(v,true)
