...
def_class("xzsChildWuXingTa",UICloneObject)





xzsChildWuXingTa.abName="ui/windows/xiaozhushou/child/xzschildwuxingta.ab"

xzsChildWuXingTa.assetName="xzsChildWuXingTa"


function xzsChildWuXingTa:bindComponents()
...
function xzsChildWuXingTa:unbindComponents()
...
function xzsChildWuXingTa:onLoaded(...)
self:bindComponents()
...
function xzsChildWuXingTa:__delete()
...
function xzsChildWuXingTa:onShow(argtable,afterOnloaded)
...
function xzsChildWuXingTa:onHide()

end



function xzsChildWuXingTa:onShowPrize(prizeType,temp,effectData,temp2)
...
function xzsChildWuXingTa:doNextStep()
self:stopOverTick()
...
function xzsChildWuXingTa:onProgressStepComplete()
self.animComplete=true
...
function xzsChildWuXingTa:startOverTick()
...
function xzsChildWuXingTa:stopOverTick()
