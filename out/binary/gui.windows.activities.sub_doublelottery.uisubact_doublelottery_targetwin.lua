...
def_class("UISubAct_doubleLottery_TargetWin",UIWindowBase)
...
function UISubAct_doubleLottery_TargetWin:bindComponents()
...
function UISubAct_doubleLottery_TargetWin:unbindComponents()
...
function UISubAct_doubleLottery_TargetWin:onLoaded(...)
self:bindComponents()
end


function UISubAct_doubleLottery_TargetWin:__delete()
...
function UISubAct_doubleLottery_TargetWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UISubAct_doubleLottery_TargetWin:onHide()

end

function UISubAct_doubleLottery_TargetWin:refresh(isResetListPos)
...
function UISubAct_doubleLottery_TargetWin:getSortTargetCfgList()
...
function UISubAct_doubleLottery_TargetWin:onClickMask()
self:onCloseBtn()
end



function UISubAct_doubleLottery_TargetWin:onCloseBtn()
self:closeSelf()
end


function UISubAct_doubleLottery_TargetWin:onClickGetRewardBtn(targetCount)
self.activityData:reqDoubleLotteryGetTargetReward()
end


function UISubAct_doubleLottery_TargetWin:onClickRewardItem(itemId,index,guid,attach)
