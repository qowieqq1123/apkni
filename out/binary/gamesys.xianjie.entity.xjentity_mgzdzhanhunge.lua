...
local xjEntity_MGZDZhanHunGe={}


function xjEntity_MGZDZhanHunGe:onInit()
...
self.xjicontype=1502

self.data.buildID=self.buildID
end


function xjEntity_MGZDZhanHunGe:onCreateWidget(widget)
...
function xjEntity_MGZDZhanHunGe:onRemoveWidget(widget)

widget:SetChildSceneEntityRemoveModel(0)
end


function xjEntity_MGZDZhanHunGe:refreshInfo()
...
function xjEntity_MGZDZhanHunGe:onMyClick(boxParams)
xianjieController:openMGZDZhanHunGeInfoWin(self.buildID)
end



return xjEntity_MGZDZhanHunGe