...
def_class("UISubAct_fyslPinJitwoWin",UIWindowBase)
...
function UISubAct_fyslPinJitwoWin:bindComponents()
...
function UISubAct_fyslPinJitwoWin:unbindComponents()
...
function UISubAct_fyslPinJitwoWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UISubAct_fyslPinJitwoWin:__delete()
...
function UISubAct_fyslPinJitwoWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UISubAct_fyslPinJitwoWin:refreshdata()
local cfg=cfg_fuyaoshilianconfig_get(_this.subId).damagelevel

local monlv=activitiesHandle_fuyaoBoss:getMonlv(_this.actId,_this.subType,_this.subId)
local tempArry={}
...
function UISubAct_fyslPinJitwoWin:onHide()
...
function UISubAct_fyslPinJitwoWin:onFazebtn()
end



function UISubAct_fyslPinJitwoWin:onDizibtn()
end


function UISubAct_fyslPinJitwoWin:onClickMask()
end

function UISubAct_fyslPinJitwoWin:onBtnClose()
self:closeSelf()
end

function UISubAct_fyslPinJitwoWin:onBlackBG()
self:closeSelf()
end



function UISubAct_fyslPinJitwoWin:onSkillItem()
end
