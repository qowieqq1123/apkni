...
def_class("UIFabaoRefineMaterialSelectWin",UIWindowBase)
...
function UIFabaoRefineMaterialSelectWin:bindComponents()
...
function UIFabaoRefineMaterialSelectWin:unbindComponents()
...
function UIFabaoRefineMaterialSelectWin:onLoaded(...)
self:bindComponents()
...
function UIFabaoRefineMaterialSelectWin:__delete()
self:unbindComponents()
tipsManager.closeTips()
end

function UIFabaoRefineMaterialSelectWin:onShow(argtable,afterOnloaded)
...
self.selfMaterial=argtable.selfMaterial
...
function UIFabaoRefineMaterialSelectWin:onHide()
...
function UIFabaoRefineMaterialSelectWin:freshInfo()
...
if self.selfMaterial then
local selfMaterialColor=itemsConfig.getItemColor(self.selfMaterial.itemid)
if self.selfMaterial and selfMaterialColor>=self.needcolor then
list[#list+1]=self.selfMaterial
end
end
...
function UIFabaoRefineMaterialSelectWin:onSelect(i,itemguid,itemid,formType)

local isput=self.selectGuids[tostring(itemguid)]==true
local formType=TIPS_FORM_TYPE.eFaBaoRefineMaterialSelect
...
function UIFabaoRefineMaterialSelectWin:initDrop()
...
function UIFabaoRefineMaterialSelectWin:onDropdownChange(dropIdx,index)
