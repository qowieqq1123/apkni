...
def_class("UISubAct_ChiSeJinDi_CopyWeaponBuyWin",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onLoaded(...)
self:bindComponents()
_this=self
self.starTweens={}
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:__delete()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onHide()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onSellBtn()
local args={
actId=self.actId,
...
self:showWindow("UISubAct_ChiSeJinDi_CopyWeaponSellWin",args)
end


function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onRefreshBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onFazeBtn()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onDiscipleBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onWeaponBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onGoBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:initView()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:updateBuyed()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:refreshMoneyNum(onlyTab)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:closeList()
local items=self.goodsList:getChildLayoutGroupGridList()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:refreshList(onlyAnim)
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onClickImage(index)
if self.tweener or not self.showList then return end
local roundData=self.copyData.roundData
local data=roundData.list[index]
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:onClickBuy(index)
if self.tweener or not self.showList then return end
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin:setItemBuyed(index)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin.on_249_238(actId,subId,index)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin.on_249_239(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin.on_249_241(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoneyNum()
end
