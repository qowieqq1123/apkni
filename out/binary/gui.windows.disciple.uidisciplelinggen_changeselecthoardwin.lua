...
def_class("UIDiscipleLinggen_ChangeSelectHoardWin",UIWindowBase)
...
function UIDiscipleLinggen_ChangeSelectHoardWin:bindComponents()

self.root=UIObject.get(self,0)
self.title=UIText.get(self,1)
self.sourceItem=UIBaseItem.get(self,2)
self.destItem=UIBaseItem.get(self,3)
self.tip=UIText.get(self,4)
self.cancelBtn=UIButton.get(self,5)
self.okBtn=UIButton.get(self,6)
...
function UIDiscipleLinggen_ChangeSelectHoardWin:unbindComponents()
...
function UIDiscipleLinggen_ChangeSelectHoardWin:onLoaded(...)
self:bindComponents()
end


function UIDiscipleLinggen_ChangeSelectHoardWin:__delete()
...
function UIDiscipleLinggen_ChangeSelectHoardWin:onShow(argtable,afterOnloaded)
...
function UIDiscipleLinggen_ChangeSelectHoardWin:onHide()

end

function UIDiscipleLinggen_ChangeSelectHoardWin:refresh()
...
local activeData=self.destData.activeList[1]
local destItem=self.destItem:getWidgetBase()
self:refreshHoardItem(activeData,destItem)


local posName=UIDiscipleModel:getPosSlotName_linggen(self.destData.pos)
local tip=FMT.fmt('已装备同类秘藏，是否替换{0}秘藏栏的秘藏？',posName)
self.tip:setText(tip)
end

function UIDiscipleLinggen_ChangeSelectHoardWin:refreshHoardItem(data,item)
...
function UIDiscipleLinggen_ChangeSelectHoardWin:onCancelBtn()
...
function UIDiscipleLinggen_ChangeSelectHoardWin:onOkBtn()
UIDiscipleController:do_send_2_136(self.disciple_guid,self.destData.pos,self.idx)
