...
def_class("UISubAct_YXJMtitleWin",UIWindowBase)
...
function UISubAct_YXJMtitleWin:bindComponents()
...
function UISubAct_YXJMtitleWin:unbindComponents()
...
function UISubAct_YXJMtitleWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_YXJMtitleWin:__delete()
...
function UISubAct_YXJMtitleWin:onShow(argtable,afterOnloaded)
...
self:freshinfo()
self.bgModel:setChildUIModelShowTarget(6095,1,{},eAnimationID.stand,false,false,0)
...
function UISubAct_YXJMtitleWin:onHide()

end

function UISubAct_YXJMtitleWin:onCloseClick()
self:closeSelf()
end
function UISubAct_YXJMtitleWin:onBtnClose()
self:onCloseClick()
end
function UISubAct_YXJMtitleWin:onClickMask()
self:onCloseClick()
end

function UISubAct_YXJMtitleWin:onTjbtn()
...
function UISubAct_YXJMtitleWin:refreshallfinishbtn()
_this.chooseidx=nil
_this.deletlist=nil
...
function UISubAct_YXJMtitleWin:freshallfinishbtn()
...
function UISubAct_YXJMtitleWin:freshfinishbtn()
self.tjdjsbtn:setActive(true)
self.tjbtn:setActive(false)
...
function UISubAct_YXJMtitleWin:onTjdjsbtn()
self.tjdjsbtn:setActive(false)
...
function UISubAct_YXJMtitleWin:getSkillNumbyID(skillid)
local skillnum=self.sub_actInfo:getSkilldata(skillid)
return skillnum
end

function UISubAct_YXJMtitleWin:getNowNum()
local finishIdex=self.sub_actInfo:getAnserdata()
return finishIdex
end

function UISubAct_YXJMtitleWin:getMaxTitledata()
...
function UISubAct_YXJMtitleWin:freshinfo()
self.tjdjsbtn:setActive(false)
self.tjbtn:setActive(true)
local finishIdex=self:getNowNum()
...
function UISubAct_YXJMtitleWin:getChooselen()
local len=0
for k,v in ipairs(self.chooseidx)do
if v~=0 then
len=len+1
...
function UISubAct_YXJMtitleWin:checkChooseidx(idx)
for k,v in ipairs(self.chooseidx)do
if v==idx then
return true
end
...
function UISubAct_YXJMtitleWin:setChooseidx(idx)
for k,v in ipairs(self.chooseidx)do
if v==0 then
...
function UISubAct_YXJMtitleWin:checkChooseRightidx(_rightidx)
...
function UISubAct_YXJMtitleWin:deletChooseidx(_rightidx)
...
function UISubAct_YXJMtitleWin:onLeftClickItem(idx,wenzi)
...
function UISubAct_YXJMtitleWin:onRightClickItem(_rightidx)
if self.isdoanimat==true then
return
end
...
function UISubAct_YXJMtitleWin:onSkillClickItem(i,skillid,maxnum,widget)
if self.isdoanimat==true then
return
end
...
function UISubAct_YXJMtitleWin:handelSkill(i,skillid,widget)
...
function UISubAct_YXJMtitleWin:freshSkillPanel()
local skills=self.subcfg.skills
for k,v in ipairs(self.gnitemalist)do
local widget=v:getChildWidgetBase()
if skills[k]then
...
function UISubAct_YXJMtitleWin:freshallPanel()
self.chooseidx={[1]=0,[2]=0,[3]=0,[4]=0,}
self.deletlist={}
self.islucking=false
self.isgnbtn=false
...
function UISubAct_YXJMtitleWin:closethiswin()
...
_this:showWindow("UISubAct_YXJMrewardWin",temp)
end)
end


function UISubAct_YXJMtitleWin:playskillspeak()
...
function UISubAct_YXJMtitleWin:clearplayskillspeak()
...
function UISubAct_YXJMtitleWin:doSpeaking_playera(widget,type,skillid)
local cfg
if type==1 then
local skillcfg=cfg_lanternriddlesshelfconfig_get(skillid)
...
function UISubAct_YXJMtitleWin:doTalkAnim_playera(widget)
if self.talkTween1~=nil then
self.talkTween1:Kill()
self.talkTween1=nil
end
...
function UISubAct_YXJMtitleWin:talkEnda(widget)
if self.speakShowTimer then
self:stopTimerByID(self.speakShowTimer)
self.speakShowTimer=nil
end
...
function UISubAct_YXJMtitleWin:doSpeaking_playerb(widget,type,skillid)
local cfg
if type==1 then
local skillcfg=cfg_lanternriddlesshelfconfig_get(skillid)
cfg=skillcfg.speakskill
...
function UISubAct_YXJMtitleWin:doTalkAnim_playerb(widget)
if self.talkTween2~=nil then
self.talkTween2:Kill()
self.talkTween2=nil
end
...
function UISubAct_YXJMtitleWin:talkEndb(widget)
if self.speakShowTimer2 then
self:stopTimerByID(self.speakShowTimer2)
self.speakShowTimer2=nil
end
...
function UISubAct_YXJMtitleWin:doSpeaking_playerc(widget,type,skillid)
local cfg
if type==1 then
local skillcfg=cfg_lanternriddlesshelfconfig_get(skillid)
cfg=skillcfg.speakskill
...
function UISubAct_YXJMtitleWin:doTalkAnim_playerc(widget)
if self.talkTween3~=nil then
self.talkTween3:Kill()
self.talkTween3=nil
end
...
function UISubAct_YXJMtitleWin:talkEndc(widget)
if self.speakShowTimer3 then
self:stopTimerByID(self.speakShowTimer3)
self.speakShowTimer3=nil
end
...
function UISubAct_YXJMtitleWin:doSpeaking_playerd(widget,type,skillid)
local cfg
if type==1 then
local skillcfg=cfg_lanternriddlesshelfconfig_get(skillid)
cfg=skillcfg.speakskill
...
function UISubAct_YXJMtitleWin:doTalkAnim_playerd(widget)
if self.talkTween4~=nil then
self.talkTween4:Kill()
self.talkTween4=nil
end
...
function UISubAct_YXJMtitleWin:talkEndd(widget)
if self.speakShowTimer4 then
self:stopTimerByID(self.speakShowTimer4)
self.speakShowTimer4=nil
end
...
function UISubAct_YXJMtitleWin:clearAnserdata(actid,subtype,suid)
...
function UISubAct_YXJMtitleWin:clearSkilldata(actid,subtype,suid)
...
function UISubAct_YXJMtitleWin:printtiltletest()
