...
def_class("UIYYHYThrowOutAndSlideWin",UIWindowBase)
...
function UIYYHYThrowOutAndSlideWin:bindComponents()
...
function UIYYHYThrowOutAndSlideWin:unbindComponents()
...
function UIYYHYThrowOutAndSlideWin:onLoaded(...)
self:bindComponents()

end


function UIYYHYThrowOutAndSlideWin:__delete()
...
function UIYYHYThrowOutAndSlideWin:onHide()

end

function UIYYHYThrowOutAndSlideWin:initView()
...
function UIYYHYThrowOutAndSlideWin:getKeyIdx()
...
function UIYYHYThrowOutAndSlideWin:timeClose()
closeTimeCounter=nil
self:closeSelf()
end
...
function UIYYHYThrowOutAndSlideWin:onShow(argtable,afterOnloaded)
...
function UIYYHYThrowOutAndSlideWin:tickUpdata()
self:addMessageEx()
...
function UIYYHYThrowOutAndSlideWin:throwOut(k_idx,args)
local thType=args[1]
local str=args[2]
...
function UIYYHYThrowOutAndSlideWin:clearTweener(tw)
...
function UIYYHYThrowOutAndSlideWin:addMessage(args)
...
function UIYYHYThrowOutAndSlideWin:addMessageEx()
