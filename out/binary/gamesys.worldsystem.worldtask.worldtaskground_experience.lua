...
worldTaskGround_Experience=simple_class(worldTaskGround)


function worldTaskGround_Experience:__init(data)
...
function worldTaskGround_Experience:start(serverTime)
...
function worldTaskGround_Experience:startWanderMove()
...
function worldTaskGround_Experience:startNormalMove(fast)
...
function worldTaskGround_Experience:createNormalMove(index,forward,fast)
...
function worldTaskGround_Experience:onNormalMoveStep(index,fast)
...
function worldTaskGround_Experience:onWanderMoveStep()
...
function worldTaskGround_Experience:quit()
worldTaskBase.quit(self)
self.inlineMove=nil
self.inlineObject=nil
end

function worldTaskGround_Experience:finish()
worldTaskBase.finish(self)
self:popInlineMove()
self:disposeInlineObject()
end

function worldTaskGround_Experience:isWaitingBack()
return self.endTime<=0 and self.GE_Time(self.fast,self.onceTime)
end

function worldTaskGround_Experience:goBack()
...
worldTaskGround.start(self,timeHelper.getServerShortTime())
...
function worldTaskGround_Experience:createInlineObject()
...
function worldTaskGround_Experience:pushAnimationMove(position,animation,duration,callback)
...
function worldTaskGround_Experience:pushWalkMove(inlinePath,finish,callback)
local moveKey=worldMoveModel:convertMoveKey(self.key,0)
...
function worldTaskGround_Experience:popInlineMove()
...
function worldTaskGround_Experience:disposeInlineObject()
...
function worldTaskGround_Experience:isInlineMoving()
return self.inlineMove and self.inlineMove.Pass<self.inlineMove.Duration or false
end


function worldTaskGround_Experience:createWanderMove()
...
function worldTaskGround_Experience:createWanderWalkMove()
...
function worldTaskGround_Experience:createWanderPointMove()
...
function worldTaskGround_Experience:createWanderAnimationPoint(position,info)
...
function worldTaskGround_Experience:createWanderEffectPoint(position,info)
local effect=info[1]
local timeInfo=info[2]
local duration=#timeInfo==2 and math.random(timeInfo[1],timeInfo[2])or timeInfo[1]
