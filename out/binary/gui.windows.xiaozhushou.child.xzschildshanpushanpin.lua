...
def_class("xzsChildShanPuShanPin",UICloneObject)





xzsChildShanPuShanPin.abName="ui/windows/xiaozhushou/child/xzschildshanpushanpin.ab"

xzsChildShanPuShanPin.assetName="xzsChildShanPuShanPin"


function xzsChildShanPuShanPin:bindComponents()
...
function xzsChildShanPuShanPin:unbindComponents()
...
function xzsChildShanPuShanPin:onLoaded(...)
self:bindComponents()
...
function xzsChildShanPuShanPin:__delete()
...
function xzsChildShanPuShanPin:onShow(argtable,afterOnloaded)
...
function xzsChildShanPuShanPin:onHide()
...
function xzsChildShanPuShanPin:onShowPrize(prizeType,temp,effectData,temp2)
...
function xzsChildShanPuShanPin:doNextStep()
self:stopOverTick()
...
function xzsChildShanPuShanPin:onProgressStepComplete()
self.animComplete=true
...
function xzsChildShanPuShanPin:startOverTick()
...
function xzsChildShanPuShanPin:stopOverTick()
