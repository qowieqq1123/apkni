...
def_class("UILDChatLeftBigEmotItem",UICloneObject)





UILDChatLeftBigEmotItem.abName=""

UILDChatLeftBigEmotItem.assetName="UILDChatLeftBigEmotItem"


function UILDChatLeftBigEmotItem:bindComponents()
...
function UILDChatLeftBigEmotItem:unbindComponents()
...
function UILDChatLeftBigEmotItem:onLoaded(...)
self:bindComponents()
end


function UILDChatLeftBigEmotItem:__delete()
...
function UILDChatLeftBigEmotItem:onShow(argtable,afterOnloaded)
...
function UILDChatLeftBigEmotItem:onHide()
