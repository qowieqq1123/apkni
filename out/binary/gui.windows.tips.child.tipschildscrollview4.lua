...
def_class("tipsChildScrollView4",UICloneObject)





tipsChildScrollView4.abName="ui/windows/tips/child/tipschildscrollview4.ab"

tipsChildScrollView4.assetName="tipsChildScrollView4"


function tipsChildScrollView4:bindComponents()
...
function tipsChildScrollView4:unbindComponents()
...
function tipsChildScrollView4:onLoaded(...)
self:bindComponents()
end


function tipsChildScrollView4:__delete()
...
function tipsChildScrollView4:onShow(args,afterOnloaded)
...
function tipsChildScrollView4:onHide()

end



function tipsChildScrollView4:onFinishCreate()
self.len=self.len+1
