...
def_class("UISubAct_ChiSeJinDi_CopyWeaponSellWin",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:__delete()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onHide()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onCloseBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onSellBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onClickItem(item,id)
self.selectLookup[id]=(not self.selectLookup[id])or nil
item:SetChildActive(_itemCmp.selected,self.selectLookup[id])
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onLongTouchItem(weapon)
local args={
itemid=weapon,
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:refreshItem(item,id)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:onClickSell(id)
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:initView()
self.moneyIcon:setImageIcon(iconHelper.getIconName(self.config.chanceMoney),false)
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin:refreshMoney()
local moneyStr=mathHelper.formatNumber(self.copyData.money)
self.moneyNum:setText(moneyStr)
end

function UISubAct_ChiSeJinDi_CopyWeaponSellWin:updateData()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin:refreshView()
...
function UISubAct_ChiSeJinDi_CopyWeaponSellWin.on_249_241(actId,subId,roundtype,len,ids)
