...
def_class("UIShareDiscipleRoleInfoWin",UIWindowBase)
...
self.privateChannel=UIObject.get(self,11)
self.privateCount=UIText.get(self,12)
...
function UIShareDiscipleRoleInfoWin:unbindComponents()
...
function UIShareDiscipleRoleInfoWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UIShareDiscipleRoleInfoWin:__delete()
...
function UIShareDiscipleRoleInfoWin:onShow(argtable,afterOnloaded)
self.guid=argtable.guid
self.netdata=UIDiscipleModel:getDiscipleDataX(self.guid)
...
self:freshDiscipleRoleInfoCard()

local usedNum=gameUtilityModel:getData_counter(gameCounterType.eShareDiscipleRoleInfoNum)
local limitTotalNum=cfgHelper.get2(cfg_chatstyleconfig_get,3,"daily")
...
function UIShareDiscipleRoleInfoWin:onHide()

end

function UIShareDiscipleRoleInfoWin:freshDiscipleRoleInfoCard()
...
function UIShareDiscipleRoleInfoWin:freshExportRoot()
...
function UIShareDiscipleRoleInfoWin:getFriendListIdx(actorid)
...
function UIShareDiscipleRoleInfoWin:fillRecentData(item)
...
function UIShareDiscipleRoleInfoWin:fillFriendData(item)
...
function UIShareDiscipleRoleInfoWin:mainClickAction(mainItem,isLast)
...
function UIShareDiscipleRoleInfoWin:subClickAction(subItem)
...
function UIShareDiscipleRoleInfoWin:mainCreateAction(mainItem)
local index=mainItem.Index+1
local typo=index
...
function UIShareDiscipleRoleInfoWin:subCreateAction(subItem)
local index=subItem.Index+1
...
function UIShareDiscipleRoleInfoWin:onExpandAction(index)
if index>=0 then
...
function UIShareDiscipleRoleInfoWin:getPrivateList(formType)
...
function UIShareDiscipleRoleInfoWin:getPrivateCountByType(formType)
return#self:getPrivateList(formType)
end

function UIShareDiscipleRoleInfoWin:freshPrivateList(formType)
if self.privateCacheList==nil then self.privateCacheList={}end
...
function UIShareDiscipleRoleInfoWin:freshAllPrivateList()
for i,v in pairs(self.privateConfig)do
self:freshPrivateList(i)
end
end

function UIShareDiscipleRoleInfoWin:freshOtherPrivateList(formType)
for i,v in pairs(self.privateConfig)do
if formType~=i then
self:freshPrivateList(i)
end
...
function UIShareDiscipleRoleInfoWin:freshExpandColumCount(formType)
...
function UIShareDiscipleRoleInfoWin:selectActor(formType,index,actorInfo,subItem)
...
function UIShareDiscipleRoleInfoWin:freshPrivateTitle()
...
function UIShareDiscipleRoleInfoWin:freshScrollViewRect()
...
function UIShareDiscipleRoleInfoWin:onCancelBtn()
self:closeSelf()
end



function UIShareDiscipleRoleInfoWin:onShareBtn()



local channelIds={}
local actorIds={}
local jsonStr=chatEmotHelper.getDiscipleShareChatJson(self.guid)
...
chatControl:reqShare(CHAT_REGEX_TYPE.eSharedz,jsonStr,channelIds,actorIds)
end
...
function UIShareDiscipleRoleInfoWin:onCloseBtn()
...
function UIShareDiscipleRoleInfoWin:onClickPrivateChannel()
...
function UIShareDiscipleRoleInfoWin:freshPrivateChannel()
local isShow=chatCommonHelper.isShowChannel(CHAT_CHANNNEL.ePrivate)
