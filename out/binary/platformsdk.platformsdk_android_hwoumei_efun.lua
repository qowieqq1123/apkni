...
function platformSDK_Android_HWOuMei:setZMLingPaiNotifyTime(updateType,args)
...
function platformSDK_Android_HWOuMei:setChuanSongZhenYouLiNotifyTime(updateType,args)
...
function platformSDK_Android_HWOuMei:setTianYuanShouChaoNotifyTime(updateType,args)
...
function platformSDK_Android_HWOuMei:setGuaJiNotify(taskId,taskType,taskStatus,stampTime,index)
