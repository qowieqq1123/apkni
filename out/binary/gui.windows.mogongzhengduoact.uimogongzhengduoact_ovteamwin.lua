...
def_class("UIMoGongZhengDuoAct_ovTeamWin",UIWindowBase)
...
function UIMoGongZhengDuoAct_ovTeamWin:bindComponents()
...
function UIMoGongZhengDuoAct_ovTeamWin:unbindComponents()
...
function UIMoGongZhengDuoAct_ovTeamWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UIMoGongZhengDuoAct_ovTeamWin:__delete()
...
function UIMoGongZhengDuoAct_ovTeamWin:onShow(argtable,afterOnloaded)
...
function UIMoGongZhengDuoAct_ovTeamWin:onHide()
self:clearUpdateTimer()
end

function UIMoGongZhengDuoAct_ovTeamWin:refresh()
self:clearUpdateTimer()
...
function UIMoGongZhengDuoAct_ovTeamWin:refresh_update()
local girds=self.teamScrollView:getChildScrollViewItemWidgets()
local nowTime=timeHelper.getServerShortTime()
for i=1,girds.Count do
local widget=girds[i-1]
...
function UIMoGongZhengDuoAct_ovTeamWin:getSortTeamList(buildID)
...
function UIMoGongZhengDuoAct_ovTeamWin:getAllSortTeamList()
local sortList={}
...
function UIMoGongZhengDuoAct_ovTeamWin:getSortTeamListEx()
...
function UIMoGongZhengDuoAct_ovTeamWin:getSortFilterTeamList()
...
function UIMoGongZhengDuoAct_ovTeamWin:getZhenYingTypeByActorId(actorId)
local zmData
local isSelf=playerModel:checkActorId(actorId)
if isSelf then
zmData=xianjieModel:getMyZongMenData()
...
function UIMoGongZhengDuoAct_ovTeamWin:setUpdateTimer()
self:clearUpdateTimer()
...
function UIMoGongZhengDuoAct_ovTeamWin:clearUpdateTimer()
...
function UIMoGongZhengDuoAct_ovTeamWin:getFilterData(param)
...
function UIMoGongZhengDuoAct_ovTeamWin.selectConditionBack(data)
if _this==nil then
return
end
...
function UIMoGongZhengDuoAct_ovTeamWin:onRefreshBtn()
local nowTime=timeHelper.getServerShortTime()
...
function UIMoGongZhengDuoAct_ovTeamWin:onInfoBtnClick(index)
...
function UIMoGongZhengDuoAct_ovTeamWin:onGotoBtnClick(index)
...
function UIMoGongZhengDuoAct_ovTeamWin:onFilterButton(index)
local filterName,filterFlag=self:getFilterData()
local args={}
