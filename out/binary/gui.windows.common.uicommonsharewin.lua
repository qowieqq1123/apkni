...
def_class("UICommonShareWin",UIWindowBase)
...
function UICommonShareWin:bindComponents()
...
self.CSGUIScrollView=UIComboScrollView.get(self,11)
...
function UICommonShareWin:unbindComponents()
...
function UICommonShareWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UICommonShareWin:__delete()
_this=nil
self:unbindComponents()
end


function UICommonShareWin:onHide()
...
function UICommonShareWin:onShow(argtable,afterOnloaded)
...
self.frameSp:setChildUIModelShowTarget(4751,1,{},2040,false,false,0,function()
if _this==nil then return end
...
function UICommonShareWin:refreshOptionItem(item,index)
if item==nil then
...
function UICommonShareWin:freshExportRoot()
...
function UICommonShareWin:getFriendListIdx(actorid)
...
function UICommonShareWin:fillRecentData(item)
...
function UICommonShareWin:fillFriendData(item)
...
function UICommonShareWin:mainClickAction(mainItem,isLast)
...
function UICommonShareWin:subClickAction(subItem)
...
function UICommonShareWin:mainCreateAction(mainItem)
local index=mainItem.Index+1
local typo=index
...
function UICommonShareWin:subCreateAction(subItem)
local index=subItem.Index+1
...
function UICommonShareWin:onExpandAction(index)
if index>=0 then
...
function UICommonShareWin:getPrivateList(formType)
...
function UICommonShareWin:getPrivateCountByType(formType)
return#self:getPrivateList(formType)
end

function UICommonShareWin:freshPrivateList(formType)
if self.privateCacheList==nil then self.privateCacheList={}end
...
function UICommonShareWin:freshAllPrivateList()
for i,v in pairs(self.privateConfig)do
self:freshPrivateList(i)
end
end

function UICommonShareWin:freshOtherPrivateList(formType)
for i,v in pairs(self.privateConfig)do
if formType~=i then
self:freshPrivateList(i)
end
...
function UICommonShareWin:freshExpandColumCount(formType)
...
function UICommonShareWin:selectActor(formType,index,actorInfo,subItem)
...
function UICommonShareWin:freshPrivateTitle()
...
function UICommonShareWin:freshScrollViewRect()
...
function UICommonShareWin:onCancelBtn()
self:closeSelf()
end



function UICommonShareWin:onShareBtn()
local channelIds={}
local actorIds={}
...
UIManager:showWindow('UIChatWin',{channelId=cfg.channel,fixedHeight=750,})
end
UIManager.info("分享成功")
...
function UICommonShareWin:onCloseBtn()
...
function UICommonShareWin:onClickPrivateChannel()
...
function UICommonShareWin:freshPrivateChannel()
local isShow=chatCommonHelper.isShowChannel(CHAT_CHANNNEL.ePrivate)
