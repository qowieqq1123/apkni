...
def_class("UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:__delete()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onHide()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onFireBtn()
local args={
actId=self.actId,
...
self:showWindow("UISubAct_ChiSeJinDi_CopyDiscipleSellWin",args)
end


function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onRefreshBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onGoBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onFazeBtn()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onDiscipleBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onWeaponBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:initView()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:refreshMoneyNum(onlyTab)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:checkCloseWin(warning)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:refreshRound()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:showBackBtn()
self.showBack=true
self.goBtn:setActive(self.showBack)
end

function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:refreshList(onlyAnim)
local roundData=self.copyData.roundData
...
item:SetChildUIModelShowTarget(_itemCmp.background,5464,1,{},_animationID.enter,false,false,0)
end
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:onClickRecruit(index)
if self.tweener or not self.showList then return end
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:closeList()
local items=self.employeeList:getChildLayoutGroupGridList()
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin:setItemRecruit(index)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin.on_249_238(actId,subId,index)
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin.on_249_239(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin.on_249_241(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoneyNum()
end
