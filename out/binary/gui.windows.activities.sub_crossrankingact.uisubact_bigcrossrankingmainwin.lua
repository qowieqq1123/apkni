...
def_class("UISubAct_BigCrossRankingMainWin",UIWindowBase)
...
function UISubAct_BigCrossRankingMainWin:bindComponents()
...
function UISubAct_BigCrossRankingMainWin:unbindComponents()
...
function UISubAct_BigCrossRankingMainWin:onLoaded(...)
self:bindComponents()
...
function UISubAct_BigCrossRankingMainWin:__delete()
...
function UISubAct_BigCrossRankingMainWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UISubAct_BigCrossRankingMainWin:onHide()

end


function UISubAct_BigCrossRankingMainWin:onShowArgRecv(args)

self:onShow(args)
end

function UISubAct_BigCrossRankingMainWin:preFresh()
self.canvasGroupLayout:setChildCanvasGroupAlpha(0)
end

function UISubAct_BigCrossRankingMainWin:refresh()
self:showBg()
...
function UISubAct_BigCrossRankingMainWin:showBg()
...
function UISubAct_BigCrossRankingMainWin:refreshTab()
...
function UISubAct_BigCrossRankingMainWin:refreshSelfCommonInfo()
...
function UISubAct_BigCrossRankingMainWin:refreshPlayerRankInfo()
...
if actorInfo.iconInfo and actorInfo.iconInfo.piList then



local playerImage=actorInfo.iconInfo.piList
playerImageController.setPlayerModel(widget,item_index.model,playerImage,0.5,eAnimationID.idle,0,0,playerController:supportDynamic())
else
...
function UISubAct_BigCrossRankingMainWin:refreshPlayerInfo()
...
local scoreInfo=FMT.fmt("{0}{1}",mathHelper.formatNumber9(score,2),val_unit_name)
...
function UISubAct_BigCrossRankingMainWin:refreshXmRankInfo()
...
function UISubAct_BigCrossRankingMainWin:refreshXMInfo()
...
function UISubAct_BigCrossRankingMainWin:onClickPlayer(actorId,serverId)
local attach={
serverid=serverId
}
...
function UISubAct_BigCrossRankingMainWin:onClickXM(guildId)
...
function UISubAct_BigCrossRankingMainWin:setRemainingTimeTimer()
self:clearTimer()
local func
func=function()
...
function UISubAct_BigCrossRankingMainWin:refreshRemainingTimeTimer()
...
function UISubAct_BigCrossRankingMainWin:clearTimer()
if self.timer then
...
function UISubAct_BigCrossRankingMainWin:freshBtns()
...
function UISubAct_BigCrossRankingMainWin:onDailyRewardBtn()
local cb=function()
...
function UISubAct_BigCrossRankingMainWin:onShowRankBtn()
UIManager:showWindow("UISubAct_CrossRankingInfoWin",self.argtable)
end



function UISubAct_BigCrossRankingMainWin:onUpRankingBtn()
local args={
...
function UISubAct_BigCrossRankingMainWin:onInfoBtn()
local d=self.config.infomation_args
UIManager:showWindow('UIRuleWin',d)
end

function UISubAct_BigCrossRankingMainWin:onGoJoinXmBtn()
jumpManager:jump({id=JUMP_TYPE.eXianMengJoin})
end

function UISubAct_BigCrossRankingMainWin:onServerListBtn()
