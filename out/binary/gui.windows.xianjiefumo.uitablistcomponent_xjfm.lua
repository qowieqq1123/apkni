...
def_class("UITabListComponent_XJFM",UIWindowBase)
...
function UITabListComponent_XJFM:bindComponents()
...
function UITabListComponent_XJFM:unbindComponents()
...
function UITabListComponent_XJFM:onLoaded(...)
self:bindComponents()
_this=self
end


function UITabListComponent_XJFM:__delete()
...
function UITabListComponent_XJFM:onShow(argtable,afterOnloaded)
...
item:SetChildNewBieComponentId(0,FMT.fmt('UITabListComponent_XJFM.toggleListItem_{0}',i))
...
function UITabListComponent_XJFM:clearReddotFunction()
...
function UITabListComponent_XJFM:refreshReddot(index,class,sub_typo,last_flag,flag)
local item=self.ToggleGroup:getChildLayoutGroupGridItem(index-1)
item:SetChildActive(3,flag)
end


function UITabListComponent_XJFM:onHide()
self:clearReddotFunction()
end



function UITabListComponent_XJFM:triggerToggle(idx)
self.onToggleChange(idx)
end


function UITabListComponent_XJFM.onToggleChange(idx)
...
function UITabListComponent_XJFM:setToggleOn(index,on)
local item=self.ToggleGroup:getChildLayoutGroupGridItem(index-1)
...
function UITabListComponent_XJFM:refreshItemName(argtable)
local cnt=#argtable
for i=1,cnt do
...
function UITabListComponent_XJFM:onCloseButton()
UIManager:invokeUIMethod("UIBackgroundComponent_XJFM","onCloseButtonEx")
end
