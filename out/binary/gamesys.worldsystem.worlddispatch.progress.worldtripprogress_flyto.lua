worldTripProgress_FlyTo=simple_class(worldTripProgress_Base)
worldTripProgress_FlyTo.name="worldTripProgress_FlyTo"

function worldTripProgress_FlyTo:__init(trip)
worldTripProgress_Base.__init(self,trip)
self.duration=math.ceil(self.trip.trip_duration)
end

function worldTripProgress_FlyTo:start(time)
...
self.hNormal=self.trip.corners[#self.trip.corners]-self.trip.corners[1]
self.hNormal.y=0
...
function worldTripProgress_FlyTo:addStepChange(moveList)

end

function worldTripProgress_FlyTo:addTrigger()
...
function worldTripProgress_FlyTo:addMove(index)
...
function worldTripProgress_FlyTo:onDiscipleChange()
