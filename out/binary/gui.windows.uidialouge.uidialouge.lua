...
def_class("UIDialouge",UIWindowBase)
...
function UIDialouge:bindComponents()
...
function UIDialouge:unbindComponents()
...
function UIDialouge:onShow(showdata)
...
function UIDialouge:setContent(content)
self.dialougeText:setText(content)
end


function UIDialouge:handleTimeCount(time)
if time>0 then
...
function UIDialouge:autoCancelClick(time)
if time>0 then
local function tick(i,t,c)
...
function UIDialouge:autoOkClick(time)
if time>0 then
local function tick(i,t,c)
...
function UIDialouge:onOkButton()
...
function UIDialouge:onCancelButton()
...
function UIDialouge:onBGClick()
if self.showdata.allowclickBG==nil or self.showdata.allowclickBG==true then
self:onCloseBtn()
end
end

function UIDialouge:onCloseBtn()

self:doClose()
end

function UIDialouge:doClose()
...
function UIDialouge:doCancel()
self.showdata:deleteSelf()
self:close()
end

function UIDialouge:onChangeChoose()
