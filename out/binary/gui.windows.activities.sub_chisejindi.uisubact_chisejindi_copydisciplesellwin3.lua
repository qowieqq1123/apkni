...
def_class("UISubAct_ChiSeJinDi_CopyDiscipleSellWin3",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:__delete()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onHide()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onCloseBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onSellBtn()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onClickItem(item,id)
self.selectLookup[id]=(not self.selectLookup[id])or nil
item:SetChildActive(_itemCmp.selected,self.selectLookup[id])
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:onLongTouchItem(disciple)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:initView()
self.moneyIcon:setImageIcon(iconHelper.getIconName(self.config.chanceMoney),false)
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:refreshMoney()
local moneyStr=mathHelper.formatNumber(self.copyData.money)
self.moneyNum:setText(moneyStr)
end

function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:updateData()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:refreshView()
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3:refreshItem(item,id)
...
function UISubAct_ChiSeJinDi_CopyDiscipleSellWin3.on_249_241(actId,subId,roundtype,len,ids)
