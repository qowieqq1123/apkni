...
def_class("UIYYHYJieShuanZhiYinWin",UIWindowBase)
...
function UIYYHYJieShuanZhiYinWin:bindComponents()
...
function UIYYHYJieShuanZhiYinWin:unbindComponents()
...
function UIYYHYJieShuanZhiYinWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UIYYHYJieShuanZhiYinWin:__delete()
_this=nil
...
function UIYYHYJieShuanZhiYinWin:onShow(argtable,afterOnloaded)
...
UIYYHYJieShuanZhiYinWin:updataInfo()
_this:delayDo(0.8,function()
UIYYHYJieShuanZhiYinWin:doSpeaking()
end)
end


function UIYYHYJieShuanZhiYinWin:initSortGroups()
...
function UIYYHYJieShuanZhiYinWin:getStartGroupIndex()
...
function UIYYHYJieShuanZhiYinWin:refresh()
self:showCurrentGroup()
end

function UIYYHYJieShuanZhiYinWin:callActivityFunc(fname,...)
return call_activitiesHandle_func('activitiesHandle_targetActivity',fname,self.actId,self.subId,...)
end

function UIYYHYJieShuanZhiYinWin:callActivityInfoFunc(fname,...)
local info=activitiesModel:getSubActInfo(self.actId,SUB_ACTIVITY_TYPE.eMuBiaoHuoDong,self.subId)
return info[fname](info,...)
end


function UIYYHYJieShuanZhiYinWin:onHide()

end

function UIYYHYJieShuanZhiYinWin:startCountDown()
...
function UIYYHYJieShuanZhiYinWin:clearTimer()
if self.timer then
...
function UIYYHYJieShuanZhiYinWin:showCurrentGroup()
...
function UIYYHYJieShuanZhiYinWin:updataInfo()

UIYYHYJieShuanZhiYinWin:setTargetYuHuo()
UIYYHYJieShuanZhiYinWin:setTargetRewards()
...
local yuhuonum=YiYuHuiYouModel:getWaterObjScore()or 50
...
function UIYYHYJieShuanZhiYinWin:setTargetRewards()

local rewards={}
local rewardlist=YiYuHuiYouModel:getlYYHYDiaoLuo()
...
if v.itemid<60000 or v.itemid>69999 then
rewards[#rewards+1]={v.itemid,v.num}
end
end
end
...
function UIYYHYJieShuanZhiYinWin:setTargetYuHuo()
...
function UIYYHYJieShuanZhiYinWin:onClosebtn1()


YiYuHuiYouModel:ClearYYHYData()
_this:closeSelf()
local win=UIManager:findActiveWindow('UIYYHYWinzhiyin')
if win then
...
function UIYYHYJieShuanZhiYinWin:onChushouBtn()



UIYYHYJieShuanZhiYinWin:onClosebtn1()
end



function UIYYHYJieShuanZhiYinWin:doSpeaking()
local ku_id=1
...
function UIYYHYJieShuanZhiYinWin:doTalkAnim()
...
function UIYYHYJieShuanZhiYinWin:talkEndai()
...
function UIYYHYJieShuanZhiYinWin:setTargetTasks()
...
function UIYYHYJieShuanZhiYinWin:getTargetDatas()
local cfg=cfgHelper.get1(cfg_targetactivity1config_get,self.subId)
local list={}
...
function UIYYHYJieShuanZhiYinWin:showPageBtn()
...
function UIYYHYJieShuanZhiYinWin:onLeftBtn()
...
function UIYYHYJieShuanZhiYinWin:onRightBtn()
...
function UIYYHYJieShuanZhiYinWin:onReceiveBtn()
local isComplete=self:callActivityInfoFunc('isGroupComplete',self.subId,self.groupId)
if isComplete then
...
function UIYYHYJieShuanZhiYinWin:onHelpBtn()
...
function UIYYHYJieShuanZhiYinWin:onClickItemitem(itemId,index,guid,attach)
...
function UIYYHYJieShuanZhiYinWin:onClickItem(itemId,index,guid,attach)
