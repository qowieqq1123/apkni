...
def_class("UI_win_lotteryDetail",UIWindowBase)
...
function UI_win_lotteryDetail:bindComponents()
...
function UI_win_lotteryDetail:unbindComponents()
...
function UI_win_lotteryDetail:onLoaded(...)
self:bindComponents()
_this=self
end


function UI_win_lotteryDetail:__delete()
...
function UI_win_lotteryDetail:onShow(argtable,afterOnloaded)
...
self.config=cfg_devildomshenyuanmizangconfig_get(self.configidx)
if not self.config then
self.config=cfg_devildomshenyuanmizangconfig_get(1)
end
end
...
function UI_win_lotteryDetail:onHide()

end

function UI_win_lotteryDetail:refreshNormalList()
...
function UI_win_lotteryDetail:refreshNormalPrList()
...
function UI_win_lotteryDetail:refreshProList()
...
function UI_win_lotteryDetail:refreshProPrList()
...
function UI_win_lotteryDetail:refreshSpecialList()
