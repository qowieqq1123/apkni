...
def_class("UIRankListTop3Win_1",UIWindowBase)
...
function UIRankListTop3Win_1:bindComponents()
...
function UIRankListTop3Win_1:unbindComponents()
...
function UIRankListTop3Win_1:onLoaded(...)
self:bindComponents()
_this=self
...
function UIRankListTop3Win_1:__delete()
...
function UIRankListTop3Win_1:onShow(argtable,afterOnloaded)
...
function UIRankListTop3Win_1:onHide()

end



function UIRankListTop3Win_1:onClickHelpBtn()
...
function UIRankListTop3Win_1:onClickDetailBtn()
local args={
...
function UIRankListTop3Win_1:onClickTab(index)
...
function UIRankListTop3Win_1:onClickPlayer(index)
...
function UIRankListTop3Win_1:refreshTabList()
...
function UIRankListTop3Win_1:refreshPanel()
...
function UIRankListTop3Win_1:refreshPlayer(index)
...
function UIRankListTop3Win_1:refeshOwner(rankType)
...
local value=self.onwerData.data or 0
...
function UIRankListTop3Win_1.onRankListRefresh(rankType)
