...
def_class("UIFirstRechargeWin2",UIWindowBase)
...
function UIFirstRechargeWin2:bindComponents()

self.bgModel=UIObject.get(self,0)
self.buildingModelRoot=UIObject.get(self,1)
self.clickItemMask=UIButton.get(self,2)
self.closeBtn=UIButton.get(self,3)
self.confirmBtn=UIButton.get(self,4)
self.confirmBtnText=UIText.get(self,5)
self.dayBtn_1=UIButton.get(self,6)
self.dayBtn_2=UIButton.get(self,7)
self.dayBtn_3=UIButton.get(self,8)
self.dayBtnList=UIObject.get(self,9)
self.dayBtnReddot_1=UIObject.get(self,10)
self.dayBtnReddot_2=UIObject.get(self,11)
self.dayBtnReddot_3=UIObject.get(self,12)
self.dayBtnSelect_1=UIObject.get(self,13)
self.dayBtnSelect_2=UIObject.get(self,14)
self.dayBtnSelect_3=UIObject.get(self,15)
self.discipleModelRoot=UIObject.get(self,16)
self.diziPanel=UIObject.get(self,17)
self.dzJJLvBg=UIObject.get(self,18)
self.dzJJLvText=UIText.get(self,19)
self.giftMark_1=UIObject.get(self,20)
self.giftMark_2=UIObject.get(self,21)
self.giftMark_3=UIObject.get(self,22)
self.gotFlag=UIObject.get(self,23)
self.gubaoImage=UIImage.get(self,24)
self.gubaoModelRoot=UIObject.get(self,25)
self.infoBtn=UIButton.get(self,26)
self.item_1=UIObject.get(self,27)
self.item_2=UIObject.get(self,28)
self.item_3=UIObject.get(self,29)
self.item_4=UIObject.get(self,30)
self.item_5=UIObject.get(self,31)
self.leftPanel=UIObject.get(self,32)
self.mask=UIButton.get(self,33)
self.root=UIObject.get(self,34)
self.selectDiziList=UIObject.get(self,35)
self.selectDiziPanel=UIObject.get(self,36)
self.showModelPanel=UIObject.get(self,37)
self.specialImageModelRoot=UIImage.get(self,38)
self.specialSpineModelRoot=UIObject.get(self,39)
self.tabPanel=UIObject.get(self,40)
self.timeText=UIText.get(self,41)
self.titleImage=UIImage.get(self,42)
self.xiaoren=UIObject.get(self,43)
...
function UIFirstRechargeWin2:unbindComponents()
...
function UIFirstRechargeWin2:onLoaded(...)
_this=self
self:bindComponents()
end


function UIFirstRechargeWin2:__delete()
...
function UIFirstRechargeWin2:onShow(argtable,afterOnloaded)
self.allCfg=firstRechargeNewModel:getSortCfgList()
self.selectIndex=1
...
self.tabList=firstRechargeNewModel:getShowTabList()
...
function UIFirstRechargeWin2:onHide()
if self.isImageFloat then
self:doLocalMoveY(false)
end
end
...
function UIFirstRechargeWin2:showBgModel()
...
function UIFirstRechargeWin2:finishLoadBgModel(isFront)
...
function UIFirstRechargeWin2:selectTab(selectIndex,dayIndex)
...
self.frCfg=cfgHelper.get1(cfg_firstcharge2config_get,self.rechargeId)
self.dayCount=self.tabList[selectIndex].dayCount
if not firstRechargeNewModel:getFirstRechargePageOpenFlagByRechargeId(self.rechargeId)then
firstRechargeNewModel:setFirstRechargePageOpenFlagByRechargeId(self.rechargeId)
...
self.firstRechargeData=firstRechargeNewModel:getFirstRechargeDataByRechargeId(self.rechargeId)
if not dayIndex then
local _,canGetDayIndex=firstRechargeNewModel:checkReddotById(self.rechargeId)
...
function UIFirstRechargeWin2:selectDizi(selectIndex)
...
function UIFirstRechargeWin2:refresh(isChangePage)
...
function UIFirstRechargeWin2:refreshTab()
...
function UIFirstRechargeWin2:refreshTabPanel()
...
local reddot=firstRechargeNewModel:checkReddotById(tabData.rechargeId)
...
function UIFirstRechargeWin2:refreshLeftPanel(isChangePage)
...
function UIFirstRechargeWin2:showItemModel(isChangePage)
...
function UIFirstRechargeWin2:showBuildingModel()
...
function UIFirstRechargeWin2:showSpecialImageModel()
...
function UIFirstRechargeWin2:showSpecialSpineModel()
...
function UIFirstRechargeWin2:refreshDiziPanel()
local showModelItemId=self.showModelPram.itemid
...
function UIFirstRechargeWin2:refreshGubaoPanel()
local showModelItemId=self.showModelPram.itemid
...
function UIFirstRechargeWin2:refreshSelectDiziPanel()
...
function UIFirstRechargeWin2:refreshRightPanel()

local widget

local rewardsAllCfg=self.frCfg.rewards
local rewardsCfg=firstRechargeNewModel:getVersionAndPfCfg(rewardsAllCfg)
...
function UIFirstRechargeWin2:refreshBottomPanel()
...
self.nextRefreshTime=firstRechargeNewModel:getNextRefreshTime()
if self.nextRefreshTime then
isNeedTimer=true
end


local isBought=firstRechargeNewModel:checkIsBought(self.rechargeId)
...
local isGot=firstRechargeNewModel:checkIsGotFirstRechargeRewardByIdAndDay(self.rechargeId,self.dayIndex)
...
self.canGetRewardTime=firstRechargeNewModel:getCanGetRewardTimeByIdAndDay(self.rechargeId,self.dayIndex)
...
function UIFirstRechargeWin2:onDayBtnClick(day,isForceRefresh)
...
function UIFirstRechargeWin2:onRewardItemClick(itemId,itemIndex)
if itemId==-1 then
return
end
...
function UIFirstRechargeWin2:onClickTab(index)
...
function UIFirstRechargeWin2:onClickSelectDiziItem(index)
...
function UIFirstRechargeWin2:onClickItemMask()
tipsManager.showTips({itemid=self.clickItemId,move=TIPS_MOVE_POS.eRight})
end


function UIFirstRechargeWin2:doLocalMoveY(isFloat)
if isFloat then
...
function UIFirstRechargeWin2:setRemainingTimeTimer()
self:clearTimer()
...
function UIFirstRechargeWin2:clearTimer()
if self.timer then
...
function UIFirstRechargeWin2:refreshDayBtnReddot()
local nowTime=gameUtilityModel.getServerLongTime()
for i,reddot in ipairs(self.dayBtnReddot)do
local reddotFlag=false
if i<=self.dayCount then

if not firstRechargeNewModel:checkIsGotFirstRechargeRewardByIdAndDay(self.rechargeId,i)then

local targetTime=firstRechargeNewModel:getCanGetRewardTimeByIdAndDay(self.rechargeId,i)
...
function UIFirstRechargeWin2:doModelFadeIn()
self:clearModelTween()
...
function UIFirstRechargeWin2:clearModelTween()
...
function UIFirstRechargeWin2:onCloseBtn()
self:closeSelf()
end


function UIFirstRechargeWin2:onConfirmBtn(isBought)
if isBought then

payControl.reqPay(self.rechargeId)
else

firstRechargeNewController:reqGetFirstRechargeReward(self.rechargeId,self.dayIndex)
...
function UIFirstRechargeWin2:onDayBtn_1()
self:onDayBtnClick(1)
end


function UIFirstRechargeWin2:onDayBtn_2()
self:onDayBtnClick(2)
end


function UIFirstRechargeWin2:onDayBtn_3()
self:onDayBtnClick(3)
end


function UIFirstRechargeWin2:onInfoBtn()
local showModelItemId=self.showModelPram.itemid
UIRecruitControl:showItemDiscipleInfoByItemId2(showModelItemId,self.selectDiziIndex)
end


function UIFirstRechargeWin2:onMask()
end
