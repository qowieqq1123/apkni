...
def_class("UICommonActForeGroundWin",UIWindowBase)
...
function UICommonActForeGroundWin:bindComponents()
...
function UICommonActForeGroundWin:unbindComponents()
...
function UICommonActForeGroundWin:onLoaded(...)
self:bindComponents()
...
function UICommonActForeGroundWin:__delete()
...
function UICommonActForeGroundWin:onShow(argtable,afterOnloaded)
...
function UICommonActForeGroundWin:onHide()
self.isPlay=false
self:clearReddotFunction()
...
function UICommonActForeGroundWin:freshMenuList()
if self.selectMenuIdx then
return
end
...
function UICommonActForeGroundWin:clearReddotFunction()
...
function UICommonActForeGroundWin:fillMenu(index,config)
...
function UICommonActForeGroundWin:refreshReddot(index,class,sub_typo,last_flag,flag)
local item=self.scrollView:getGridObjectByindex(index-1)
item:SetChildActive(_CMP_INDEX.cmpReddot,flag)
end

function UICommonActForeGroundWin:freshMenuSelect(index)
if index==nil then
return
end
...
function UICommonActForeGroundWin:on_click_callback(id,index,guid,attach)
...
function UICommonActForeGroundWin:onBtnClose()
self.selectMenuIdx=nil
self:closeSelf()
end
