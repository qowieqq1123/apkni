...
def_class("tipsChildScrollView2",UICloneObject)





tipsChildScrollView2.abName="ui/windows/tips/child/tipschildscrollview2.ab"

tipsChildScrollView2.assetName="tipsChildScrollView2"


function tipsChildScrollView2:bindComponents()
...
function tipsChildScrollView2:unbindComponents()
...
function tipsChildScrollView2:onLoaded(...)
self:bindComponents()
end

function tipsChildScrollView2:__delete()
self:unbindComponents()
end

function tipsChildScrollView2:onShow(argtable,afterOnloaded)

end

function tipsChildScrollView2:onHide()
...
function tipsChildScrollView2:onShow(args)
...
function tipsChildScrollView2:onFinishCreate()
self.len=self.len+1
