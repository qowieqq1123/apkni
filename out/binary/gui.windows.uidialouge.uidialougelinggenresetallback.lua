...
def_class("UIDialougeLingGenResetAllBack",UIWindowBase)
...
function UIDialougeLingGenResetAllBack:bindComponents()
...
function UIDialougeLingGenResetAllBack:unbindComponents()
...
function UIDialougeLingGenResetAllBack:onLoaded(...)
self:bindComponents()
...
function UIDialougeLingGenResetAllBack:__delete()
...
function UIDialougeLingGenResetAllBack:onShow(showdata)

self.titleText:setText(showdata.title)
self.dialougeText:setText(showdata.content)
self.timeText:setText(showdata.timeStr)
...
function UIDialougeLingGenResetAllBack:setContent(content)
self.dialougeText:setText(content)
end


function UIDialougeLingGenResetAllBack:handleTimeCount(time)
if time>0 then
...
function UIDialougeLingGenResetAllBack:autoCancelClick(time)
if time>0 then
local function tick(i,t,c)
...
function UIDialougeLingGenResetAllBack:autoOkClick(time)
if time>0 then
local function tick(i,t,c)
...
function UIDialougeLingGenResetAllBack:onOkButton()
...
function UIDialougeLingGenResetAllBack:onCancelButton()
...
function UIDialougeLingGenResetAllBack:onBGClick()
if self.showdata.allowclickBG==nil or self.showdata.allowclickBG==true then
self:onCloseBtn()
end
end

function UIDialougeLingGenResetAllBack:onCloseBtn()

self:doClose()
end

function UIDialougeLingGenResetAllBack:doClose()
...
function UIDialougeLingGenResetAllBack:doOk()
local okcallback=self.showdata.okcallback
self.showdata:deleteSelf()
self:close()
if okcallback then
...
function UIDialougeLingGenResetAllBack:doCancel()
self.showdata:deleteSelf()
self:close()
end

function UIDialougeLingGenResetAllBack:onChangeChoose()
