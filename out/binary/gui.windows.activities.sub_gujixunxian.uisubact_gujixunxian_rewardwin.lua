...
def_class("UISubAct_gujixunxian_rewardWin",UIWindowBase)
...
function UISubAct_gujixunxian_rewardWin:bindComponents()
...
function UISubAct_gujixunxian_rewardWin:unbindComponents()
...
function UISubAct_gujixunxian_rewardWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UISubAct_gujixunxian_rewardWin:__delete()
_this=nil
...
function UISubAct_gujixunxian_rewardWin:onHide()

end

function UISubAct_gujixunxian_rewardWin.onDiscipleCreate(dis_guid)
...
function UISubAct_gujixunxian_rewardWin.onItemUse(itemid,num)
if _this==nil then return end
...
function UISubAct_gujixunxian_rewardWin.onCloseUI(name)
if _this==nil then return end
...
function UISubAct_gujixunxian_rewardWin:onShow(argtable,afterOnloaded)
self.curStep=1
...
function UISubAct_gujixunxian_rewardWin:refreshDesc()
...
function UISubAct_gujixunxian_rewardWin:initRewardView()
...
function UISubAct_gujixunxian_rewardWin:refreshItem(item,itemid,itemnum)
local countStr=''
...
function UISubAct_gujixunxian_rewardWin:refreshItemNew(item,idx)
if item==nil then
...
function UISubAct_gujixunxian_rewardWin:playShow()
local delay=0
local d=0.2
local num=self.rewardnum
local grids=self.goodGridPanel:getChildLayoutGroupGridList()
...
function UISubAct_gujixunxian_rewardWin:playEffect()
...
function UISubAct_gujixunxian_rewardWin:playItemEffect(item)
...
function UISubAct_gujixunxian_rewardWin:checkItem()
local index=self.curStep
local reward=self.rewardlist[index]
local itemid=reward.itemid
...
function UISubAct_gujixunxian_rewardWin:replay(itemid_,num,dzid)
local index=self.curStep
...
function UISubAct_gujixunxian_rewardWin:playEffectEnd()
...
function UISubAct_gujixunxian_rewardWin:onFinish()
...
function UISubAct_gujixunxian_rewardWin:addNote(str)
table.insert(self.noteslist,1,str)
self:refreshNotes()
end

function UISubAct_gujixunxian_rewardWin:refreshNotes()
...
function UISubAct_gujixunxian_rewardWin:onClickItem(itemId,index,guid,attach)
...
function UISubAct_gujixunxian_rewardWin:clearClickLock(isclear)
self.clickLock=nil
if not isclear then
...
function UISubAct_gujixunxian_rewardWin:onShareBtn()

end

function UISubAct_gujixunxian_rewardWin:onFrameBG()
self:onClickClose()
end

function UISubAct_gujixunxian_rewardWin:onClickClose()
...
function UISubAct_gujixunxian_rewardWin:onTenBtn()
if self.playingAnim==true then return end
if self.clickLock==true then return end
...
function UISubAct_gujixunxian_rewardWin:onOneBtn()
if self.playingAnim==true then return end
if self.clickLock==true then return end
if self.clickLockTime then
if gameUtilityModel.getServerShortTime()<self.clickLockTime then
