...
def_class("UILDChatRightShareLXWJInfoItem",UICloneObject)





UILDChatRightShareLXWJInfoItem.abName=""

UILDChatRightShareLXWJInfoItem.assetName="UILDChatRightShareLXWJInfoItem"


function UILDChatRightShareLXWJInfoItem:bindComponents()
...
function UILDChatRightShareLXWJInfoItem:unbindComponents()
...
function UILDChatRightShareLXWJInfoItem:onLoaded(...)
self:bindComponents()
end


function UILDChatRightShareLXWJInfoItem:__delete()
self:unbindComponents()
end


function UILDChatRightShareLXWJInfoItem:onHide()
...
function UILDChatRightShareLXWJInfoItem:onShow(argtable,afterOnloaded)
...
function UILDChatRightShareLXWJInfoItem:onBg()

end

function UILDChatRightShareLXWJInfoItem:freshRect()
