...
def_class("UISubAct_ZhenXinHuaQiXiDaTiTipsWin",UIWindowBase)
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:bindComponents()
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:unbindComponents()
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:__delete()
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:onShow(argtable,afterOnloaded)
...
self.mbg:setChildUIModelShowTarget(self.isToday and 6381 or 6382,1,nil,eAnimationID.enter)
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:onHide()

end

function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:refreshAll()
self:refreshTabInfo()
self:refreshPanel()
end

function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:refreshTabInfo()
...
self.tabScrollView:setChildSizeDelta(max>10 and 692 or 630,65)
self.initTab=true
end
end

function UISubAct_ZhenXinHuaQiXiDaTiTipsWin.bindTabWidget(index)
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:refreshTabSelect(widget,isSelect)
widget:SetChildActive(0,isSelect)
end

function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:refreshPanel()
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:refreshPanel1()
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:bindChooseItem(index)
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:refreshPanel2()
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:rectSelectCheckIdx(day,ques_idx,check_idx,old_check_idx)
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:stopCDTimer()
if self.cdTimer then
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:setSelectQuesIdx(idx)
local min=1
...
function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:onLeftBtn()
self:setSelectQuesIdx(self.selectQuesIdx-1)
end



function UISubAct_ZhenXinHuaQiXiDaTiTipsWin:onRightBtn()
self:setSelectQuesIdx(self.selectQuesIdx+1)
end
