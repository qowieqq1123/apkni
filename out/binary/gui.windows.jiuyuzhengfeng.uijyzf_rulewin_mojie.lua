...
def_class("UIJYZF_RuleWin_MoJie",UIWindowBase)
...
function UIJYZF_RuleWin_MoJie:bindComponents()
...
function UIJYZF_RuleWin_MoJie:unbindComponents()
...
function UIJYZF_RuleWin_MoJie:onLoaded(...)
self:bindComponents()
end


function UIJYZF_RuleWin_MoJie:__delete()
...
function UIJYZF_RuleWin_MoJie:onShow(argtable,afterOnloaded)
self.title:setText('规则说明')

local enterData=xianjieModel:getMoJieEnterData()
if enterData==nil then return end

local cfg=cfgHelper.get1(cfg_jiuyuzhengfengmojierulecfg_get,enterData.sId)
if cfg==nil then
logErr("缺少魔界赛季九域争锋规则列表,魔界赛季id：",enterData.sId)
return
end

local list=cfg.jyzfRuleList
...
function UIJYZF_RuleWin_MoJie:onHide()

end

function UIJYZF_RuleWin_MoJie:onFreshAction(index,widget,data)
local item=widget
...
logErr("UIJYZF_RuleWin_MoJie refreshFuncName 没有刷新方法",data.itemType)
end
end


function UIJYZF_RuleWin_MoJie:onStartAction()
end

function UIJYZF_RuleWin_MoJie:refreshFunc_EmptyItem(item,data)
item:SetChildSizeDelta(0,1070,data.hight)
end

function UIJYZF_RuleWin_MoJie:refreshFunc_DescItem(item,data)
...
function UIJYZF_RuleWin_MoJie:refreshFunc_RuleItem_1(item,data)
item:SetChildText(1,data.title)
item:SetChildText(2,data.txt1)
end

function UIJYZF_RuleWin_MoJie:refreshFunc_RuleItem_2(item,data)
item:SetChildText(1,data.title)
item:SetChildText(2,data.txt1)
item:SetChildText(3,data.txt2)
end

function UIJYZF_RuleWin_MoJie:refreshFunc_RuleItem_3(item,data)
item:SetChildText(1,data.title)
item:SetChildText(2,data.txt1)
item:SetChildText(3,data.txt2)
...
function UIJYZF_RuleWin_MoJie:refreshFunc_RuleItem_5(item,data)
item:SetChildText(1,data.title)
item:SetChildText(2,data.txt1)
item:SetChildText(3,data.txt2)
item:SetChildText(4,data.txt3)
...
function UIJYZF_RuleWin_MoJie:refreshFunc_RuleItem_auto(item,data)
item:SetChildText(1,data.title)
