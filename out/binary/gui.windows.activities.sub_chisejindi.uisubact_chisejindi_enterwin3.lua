...
def_class("UISubAct_ChiSeJinDi_EnterWin3",UIWindowBase)
...
function UISubAct_ChiSeJinDi_EnterWin3:bindComponents()
...
function UISubAct_ChiSeJinDi_EnterWin3:unbindComponents()
...
local _enterEffect=20386



function UISubAct_ChiSeJinDi_EnterWin3:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_EnterWin3:__delete()
...
function UISubAct_ChiSeJinDi_EnterWin3:onShow(argtable,afterOnloaded)
if argtable then
...
function UISubAct_ChiSeJinDi_EnterWin3:onHide()
...
function UISubAct_ChiSeJinDi_EnterWin3:onEnterModel()
...
function UISubAct_ChiSeJinDi_EnterWin3:onTargetBtn()
local args={
actId=self.actId,
...
function UISubAct_ChiSeJinDi_EnterWin3:onRankBtn()
if self.info:checkInResultRankTime()then
...
function UISubAct_ChiSeJinDi_EnterWin3:onHelpBtn()
local args={
...
function UISubAct_ChiSeJinDi_EnterWin3:onDailyBtn()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin3:onJumpBtn()
...
function UISubAct_ChiSeJinDi_EnterWin3:isHideJumpBtn()
local passportParam=self.config.passportParam
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshJumpReddot()
local passportParam=self.config.passportParam
local actId=self.actId
local subType=passportParam[1]
local subId=passportParam[2]
...
function UISubAct_ChiSeJinDi_EnterWin3:onLevelHelp()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_EnterWin3:enterCopy()
...
function UISubAct_ChiSeJinDi_EnterWin3:initView()
...
function UISubAct_ChiSeJinDi_EnterWin3:startCDTick()
self:updateCDTick()
...
function UISubAct_ChiSeJinDi_EnterWin3:stopCDTick()
if self.cdTick then
...
function UISubAct_ChiSeJinDi_EnterWin3:updateCDTick()
...
function UISubAct_ChiSeJinDi_EnterWin3:startEnterTick()
...
function UISubAct_ChiSeJinDi_EnterWin3:stopEnterTick()
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshView()
...
function UISubAct_ChiSeJinDi_EnterWin3:showView()
...
function UISubAct_ChiSeJinDi_EnterWin3:openCopy()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
self:showWindow("UISubAct_ChiSeJinDi_CopyMainWin3",args)
self:stopEnterTick()
end


function UISubAct_ChiSeJinDi_EnterWin3:extraParamsHandle(extraParams)
if extraParams then
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshDailyBtn()
local data=self.info:getData()
local getted=data.dailyFlag==1
local pass=data.copyTimes>1 or(data.copyTimes==1 and data.continue==0)
local reddot=pass and not getted


self.dailyImg1:setActive()
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshDailyScore()
local data=self.info:getData()
self.dailyScore:setText(FMT.fmt("{0}/{1}",data.dailyScore,self.config.today))
end


function UISubAct_ChiSeJinDi_EnterWin3:refreshCopyCost()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshRankScore()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshRankReward()
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin3:onClickRewardItem(itemid,index,itemguid,attach)
local data=self.info:getData()
...
function UISubAct_ChiSeJinDi_EnterWin3:startBT()
self:stopBT()
...
function UISubAct_ChiSeJinDi_EnterWin3:randomBTDisciple(bt,index)
...
function UISubAct_ChiSeJinDi_EnterWin3:stopBT()
if self.bt then
...
function UISubAct_ChiSeJinDi_EnterWin3:randamJumpPos(bt,index)
...
function UISubAct_ChiSeJinDi_EnterWin3:refreshTargetReddot()
local reddot=self.info:hasTargetFlag0()
self.targetReddot:setActive(reddot)
end

function UISubAct_ChiSeJinDi_EnterWin3:checkEnterCost(costList,sIndex,callback)
sIndex=sIndex or 1
...
function UISubAct_ChiSeJinDi_EnterWin3.on_249_231(args)
local actId=args[1]
...
function UISubAct_ChiSeJinDi_EnterWin3.on_249_233(actId,subId,stageIdx)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_EnterWin3.on_249_234(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_EnterWin3.on_249_235(actId,subId,targetIdx)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_EnterWin3.on_249_236(args)
local actId=args[1]
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
local subId=args[2]
local round=args[4]
...
function UISubAct_ChiSeJinDi_EnterWin3.on_249_240(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshView()
end
...
function UISubAct_ChiSeJinDi_EnterWin3.onSubActivityDontHandleReddotChange(actId,subType,subId)
