...
local xjEntity_RPMystery={}


function xjEntity_RPMystery:onInit()
...
self.ent_name=mysteryCfg.name
end


function xjEntity_RPMystery:onCreateWidget(widget)
local data=xianjieModel:getResPointData(self.dataGuid)
...
function xjEntity_RPMystery:onRemoveWidget(widget)
widget:SetChildSceneEntityRemoveModel(0)
end

function xjEntity_RPMystery:onMyClick(boxParams)
xianjieController:onClickResPoint(self.dataGuid)
end


function xjEntity_RPMystery:refreshInfo()
...
function xjEntity_RPMystery:checkLogicShow()
local data=xianjieModel:getResPointData(self.dataGuid)
