...
def_class("UITopMoneyWin5",UIWindowBase)
...
function UITopMoneyWin5:bindComponents()
...
function UITopMoneyWin5:unbindComponents()
...
function UITopMoneyWin5:onLoaded(...)
self:bindComponents()
self.money={}
...
function UITopMoneyWin5:__delete()
...
function UITopMoneyWin5:onShow(argtable,afterOnloaded)
if argtable then
self.money=argtable
...
function UITopMoneyWin5:onHide()
self:clearFlyIcon()
end

function UITopMoneyWin5:clearFlyIcon()
...
function UITopMoneyWin5:getMoneyList()
return self.money
end

function UITopMoneyWin5:freshMoneyList()
...
function UITopMoneyWin5:fillData(index,moneyInfo)
...
function UITopMoneyWin5:freshMoneyValue(index,moneyInfo,lastVal)
local rootStr=FMT.fmt('moneyRoot{0}',index)
if moneyInfo==nil then
self[rootStr]:setActive(false)
return
...
function UITopMoneyWin5:clearFMTweener(mtype)
...
function UITopMoneyWin5:onAddClick(moneyType)
...
function UITopMoneyWin5:getMoneyRoot(moneyType)
...
function UITopMoneyWin5:flyMoneyIcon(spos,moneyType)
...
function UITopMoneyWin5:handleFly(moneyType,spos,tpos)
...
function UITopMoneyWin5:onMoneyChange(moneyType,lastVal,val)
local moneyList=self.money
...
function UITopMoneyWin5:clickMoney(idx)
...
function UITopMoneyWin5:onMoney1Btn()
self:clickMoney(1)
end

function UITopMoneyWin5:onMoney2Btn()
self:clickMoney(2)
end

function UITopMoneyWin5:onMoney3Btn()
self:clickMoney(3)
end

function UITopMoneyWin5:onMoney4Btn()
self:clickMoney(4)
end


function UITopMoneyWin5:onItemChange(changeType,itemguid,itemid,lastcount,itemcount)
local moneyList=self.money
for i,v in ipairs(moneyList)do
local moneyInfo=moneyList[i]
