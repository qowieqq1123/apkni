...
def_class("UICommonShowPrizeEightWin",UIWindowBase)
...
function UICommonShowPrizeEightWin:bindComponents()
...
function UICommonShowPrizeEightWin:unbindComponents()
...
function UICommonShowPrizeEightWin:onLoaded(...)
self:bindComponents()
...
function UICommonShowPrizeEightWin:__delete()
...
function UICommonShowPrizeEightWin:onShow(argtable,afterOnloaded)
...
self.tipsText:setActive(argtable.tips==nil)
if argtable.tipsSize then
self.winlua:SetChildTextFontSize(self.tips:getID(),argtable.tipsSize)
end
...
function UICommonShowPrizeEightWin:refreshItem(id,item)
id=id+1
...
local colorEffect=self.argtable.effect and self.argtable.effect[rewardId]
...
function UICommonShowPrizeEightWin:onClickBg()
if self.ListTimer then
self:stopTimerByID(self.ListTimer)
local count=self.grids.Count
