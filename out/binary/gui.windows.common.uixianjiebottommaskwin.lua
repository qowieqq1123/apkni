...
def_class("UIXianJieBottomMaskWin",UIWindowBase)
...
function UIXianJieBottomMaskWin:bindComponents()

self.animFan=UIObject.get(self,0)
self.animFg=UIObject.get(self,1)
self.animMmc=UIObject.get(self,2)
self.bdSkinBtn=UIButton.get(self,3)
self.bdSkinPanel=UIObject.get(self,4)
self.bdSkinReddot=UIObject.get(self,5)
self.dropList_1=UIObject.get(self,6)
self.dropList_2=UIObject.get(self,7)
self.frdroot=UIBaseItem.get(self,8)
self.frdValue=UIText.get(self,9)
self.mbg=UIObject.get(self,10)
self.menu=UIObject.get(self,11)
self.mouse_1=UIObject.get(self,12)
self.mouse_2=UIObject.get(self,13)
self.mouseClick1=UIButton.get(self,14)
self.mouseClick2=UIButton.get(self,15)
self.root=UIObject.get(self,16)
self.scrollView=UIScrollView.get(self,17)
...
function UIXianJieBottomMaskWin:unbindComponents()
...
function UIXianJieBottomMaskWin:onLoaded(...)
self:bindComponents()
...
function UIXianJieBottomMaskWin:__delete()
...
function UIXianJieBottomMaskWin:onShow(argtable,afterOnloaded)
...
function UIXianJieBottomMaskWin:onHide()
self.isPlay=false
...
function UIXianJieBottomMaskWin:rebuildMenu(newSelectIndex)
self:onShow()
end


function UIXianJieBottomMaskWin:reSelectMenu(index)
self:on_click_callbackEx(index)
end

function UIXianJieBottomMaskWin:setTitle(title)
self.title:setText(title)
end


function UIXianJieBottomMaskWin:onClickCloseBtn()

AudioManager.playBtnClick()
self:onClickClose()
end

function UIXianJieBottomMaskWin:onClickClose()
...
function UIXianJieBottomMaskWin:freshMenuList()
...
function UIXianJieBottomMaskWin:clearReddotFunction()
...
function UIXianJieBottomMaskWin:fillMenu(activeUI,index,config)
...
local isUnlock=fullScreenModel.checkTabEnoughCND(tabType)
item:SetChildActive(_CMP_INDEX.cmpLock,not isUnlock)
...
item:SetChildNewBieComponentId(-1,FMT.fmt('UIXianJieBottomMaskWin.btnClick.{0}',index))
end

function UIXianJieBottomMaskWin:refreshReddot(index,class,sub_typo,last_flag,flag)
local item=self.scrollView:getGridObjectByindex(index-1)
item:SetChildActive(_CMP_INDEX.cmpReddot,flag)
end

function UIXianJieBottomMaskWin:freshMenuSelect(activeUI,index)
if index==nil then
return
end
local activeSubMenu=activeUI.activeSubMenu
...
function UIXianJieBottomMaskWin:on_click_callback(id,index,guid,attach)
if fullScreenUI.activeUI==nil then
return
end
local activeUI=fullScreenUI.activeUI
...
function UIXianJieBottomMaskWin:removeAllBehaviorTree()
...
function UIXianJieBottomMaskWin:onMouseClick1()

end

function UIXianJieBottomMaskWin:onMouseClick2()

end

function UIXianJieBottomMaskWin:clearMouseData()
_mouse_catchs={}
_mouse_rewards={}
...
function UIXianJieBottomMaskWin:catchMouse(index)
...
function UIXianJieBottomMaskWin:rewardMouse(rewards)
...
function UIXianJieBottomMaskWin:dropMouse(index)
...
function UIXianJieBottomMaskWin:refreshMouseData()
...
function UIXianJieBottomMaskWin:refreshBdSkinBtn()
local activeUI=fullScreenUI.activeUI
local argstable
...
function UIXianJieBottomMaskWin:onBdSkinBtn()
local activeUI=fullScreenUI.activeUI
...
function UIXianJieBottomMaskWin:refreshFrdRoot()
...
function UIXianJieBottomMaskWin:onProsperityChange()
self:refreshFrdRoot()
end

function UIXianJieBottomMaskWin:on_click_callbackEx(index)
if fullScreenUI.activeUI==nil then
return
end
local activeUI=fullScreenUI.activeUI
...
function UIXianJieBottomMaskWin:showModel(model,offset)
self.mbg:setActive(true)

self.winlua:SetChildUIModelEnableInitUISpineParaEx(self.mbg:getID(),false,true,false)
self.mbg:setChildUIModelShowTarget(model,1,nil,eAnimationID.stand,false,false,0,nil)
self.mbg:setChildUIModelShowTargetOffset(offset and offset[1]or 0,offset and offset[2]or 0)
end
