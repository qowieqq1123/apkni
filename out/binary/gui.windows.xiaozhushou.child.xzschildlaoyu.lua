...
def_class("xzsChildLaoYu",UICloneObject)





xzsChildLaoYu.abName="ui/windows/xiaozhushou/child/xzschildlaoyu.ab"

xzsChildLaoYu.assetName="xzsChildLaoYu"


function xzsChildLaoYu:bindComponents()
...
function xzsChildLaoYu:unbindComponents()
...
function xzsChildLaoYu:onLoaded(...)
self:bindComponents()
...
self:addNotify(notifyConfig.onShenWenPrizeChange,self._onShowPrize)
end


function xzsChildLaoYu:__delete()
...
function xzsChildLaoYu:onShow(argtable,afterOnloaded)
...
function xzsChildLaoYu:onHide()

end

function xzsChildLaoYu:onShowPrize(len,temp)
...
function xzsChildLaoYu:doNextStep()
self:stopOverTick()
...
function xzsChildLaoYu:onProgressStepComplete()
self.animComplete=true
...
function xzsChildLaoYu:startOverTick()
...
function xzsChildLaoYu:stopOverTick()
