...
bwCameraShakePositionNode=simple_class(baseNode)

function bwCameraShakePositionNode:init()
self.isplaying=false
self.bComplete=false
end

function bwCameraShakePositionNode:update(interval)
...
self.isplaying=true
self.bComplete=false
worldController:cameraDOShake(duration,strength,vibrato,function()
self.isplaying=false
self.bComplete=true
self:quicklyTick()
end,ease)
