...
def_class("UITopMoneyWin7",UIWindowBase)
...
function UITopMoneyWin7:bindComponents()
...
self.Bg=UIObject.get(self,16)
self.moneryTypeRoot=UIObject.get(self,17)
self.moneyTypeName=UIText.get(self,18)
...
function UITopMoneyWin7:unbindComponents()
...
_UIObject_release(self.moneryTypeRoot);self.moneryTypeRoot=nil;
_UIObject_release(self.moneyTypeName);self.moneyTypeName=nil;
end
...
function UITopMoneyWin7:onLoaded(...)
self:bindComponents()
self.money={}
...
function UITopMoneyWin7:__delete()
...
function UITopMoneyWin7:onShow(argtable,afterOnloaded)
if argtable then
self.money=argtable[1]
if argtable[2]then
self.Bg:setActive(true)
self.moneryTypeRoot:setActive(true)
self.moneyTypeName:setText(argtable[2])
self.winlua:ForceLayoutHorizontal(self.moneryTypeRoot:getID())
else
self.Bg:setActive(false)
self.moneryTypeRoot:setActive(false)
end
...
function UITopMoneyWin7:onHide()
self:clearFlyIcon()
end

function UITopMoneyWin7:clearFlyIcon()
...
function UITopMoneyWin7:getMoneyList()
return self.money
end

function UITopMoneyWin7:freshMoneyList()
...
function UITopMoneyWin7:fillData(index,moneyInfo)
...
function UITopMoneyWin7:freshMoneyValue(index,moneyInfo,lastVal)
local rootStr=FMT.fmt('moneyRoot{0}',index)
if moneyInfo==nil then
self[rootStr]:setActive(false)
return
...
function UITopMoneyWin7:clearFMTweener(mtype)
...
function UITopMoneyWin7:onAddClick(moneyType)
...
function UITopMoneyWin7:getMoneyRoot(moneyType)
...
function UITopMoneyWin7:flyMoneyIcon(spos,moneyType)
...
function UITopMoneyWin7:handleFly(moneyType,spos,tpos)
...
function UITopMoneyWin7:flyYuBiIcon(spos,moneyType,moneyNum)
local mr=self:getMoneyRoot(moneyType)
...
function UITopMoneyWin7:handleBoomYuBi(spos)
local parent=self.flyIconPanel:getCommonComponent('Transform')
local id=_InstantiateManager.AddInstance(INSTANCE_TYPE.eUIFlyIcon,parent,function(iconId)
local icon=_InstantiateManager.GetComponent(iconId,'CSGUIWidgetBase')
icon:SetChildPosition(0,spos)
...
function UITopMoneyWin7:handleFlyYuBi(moneyType,spos,tpos,moneyNum)
local parent=self.flyIconPanel:getCommonComponent('Transform')
local id=_InstantiateManager.AddInstance(INSTANCE_TYPE.eUIFlyIcon,parent,function(iconId)
...
function UITopMoneyWin7:handleFlyYuBiEnd(tpos)
...
function UITopMoneyWin7:flyMoneyInfoTips(moneyType,index)
local mr=self:getMoneyRoot(moneyType)
...
function UITopMoneyWin7:onMoneyChange(moneyType,lastVal,val)
local moneyList=self.money
...
function UITopMoneyWin7:clickMoney(idx)
...
function UITopMoneyWin7:onMoney1Btn()
self:clickMoney(1)
end

function UITopMoneyWin7:onMoney2Btn()
self:clickMoney(2)
end

function UITopMoneyWin7:onMoney3Btn()
self:clickMoney(3)
end

function UITopMoneyWin7:onMoney4Btn()
self:clickMoney(4)
end

function UITopMoneyWin7:onMoney5Btn()
self:clickMoney(5)
end

function UITopMoneyWin7:onMoney6Btn()
self:clickMoney(6)
end

function UITopMoneyWin7:onMoney7Btn()
self:clickMoney(7)
end


function UITopMoneyWin7:onItemChange(changeType,itemguid,itemid,lastcount,itemcount)
local moneyList=self.money
for i,v in ipairs(moneyList)do
local moneyInfo=moneyList[i]
