...
def_class("UIWuDaoTangSelectWin",UIWindowBase)
...
function UIWuDaoTangSelectWin:bindComponents()
...
function UIWuDaoTangSelectWin:unbindComponents()
...
function UIWuDaoTangSelectWin:onLoaded(...)
self:bindComponents()
...
function UIWuDaoTangSelectWin:__delete()
self:unbindComponents()
end


function UIWuDaoTangSelectWin:onHide()

end

function UIWuDaoTangSelectWin:refreshAfterItemUse(...)
...
function UIWuDaoTangSelectWin:onShow(argtable,afterOnloaded)
...
function UIWuDaoTangSelectWin:getPlanList()
self.planlist={}
...
function UIWuDaoTangSelectWin:refreshSelectPlanGrid()
local buildLv=self.buildLv
...
function UIWuDaoTangSelectWin:onSelectPlan(index)
...
function UIWuDaoTangSelectWin:refreshSelectPlanItem(index,isselect)
local widget=self.selectWidgets[index]
widget:SetChildActive(0,isselect)
end

function UIWuDaoTangSelectWin:getCurPlanID()
...
function UIWuDaoTangSelectWin:getDZFixNum(planid)
...
function UIWuDaoTangSelectWin:getDiscipleList()
...
function UIWuDaoTangSelectWin:refreshDiscipleGrid()
...
function UIWuDaoTangSelectWin:refreshDisclpleSelect(idx,isselect)
local item=self.roleListPanel:getChildScrollViewItemWidget(idx-1)
self:refreshDisclpleSelectEx(item,isselect)
end

function UIWuDaoTangSelectWin:refreshDisclpleSelectEx(item,isselect)
item:SetChildActive(10,isselect)
end

function UIWuDaoTangSelectWin:onDisciplClick(clicknum,index)
index=index+1
if index==0 then
return
end
...
function UIWuDaoTangSelectWin:getSelectDiscipleNum()
local num=0
...
function UIWuDaoTangSelectWin:refreshCostView()
local planid=self:getCurPlanID()
local buildLv=self.buildLv
...
function UIWuDaoTangSelectWin:refreshDiscipleNum()
local planid=self:getCurPlanID()
local buildLv=self.buildLv
...
function UIWuDaoTangSelectWin:onCommitBtn()
local planid=self:getCurPlanID()
local buildLv=self.buildLv
local cost=wudaotangModel:getCost(planid,buildLv)
...
wudaotangController:reqStart(planid,#self.curSelectList,self.curSelectList,0)
...
function UIWuDaoTangSelectWin:onRewardBtn()
