...
def_class("UILZHHroleSkillWin",UIWindowBase)
...
function UILZHHroleSkillWin:bindComponents()
...
function UILZHHroleSkillWin:unbindComponents()
...
function UILZHHroleSkillWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UILZHHroleSkillWin:__delete()
...
function UILZHHroleSkillWin:onShow(argtable,afterOnloaded)
self.id=argtable.id
...
self.count=count
local cfg=cfgHelper.get1(cfg_lzhh2skillinfoconfig_get,self.id)
...
local fdata=cfgHelper.get2(cfg_lingzhenhuihua2config_get,self.subid,'func')
...
function UILZHHroleSkillWin:onHide()
...
function UILZHHroleSkillWin:onApplyBtn()
...
activitiesHandle_rolelingzhendiaoke:reqUseSkill(_this.actid,_this.subType,_this.subid,self.id)
self:closeSelf()
end,WARNING_TYPE.eWarning)
else

UIManager:callWindowFunc('UILingZhenHHroleGameExWin','handleSkill',self.id)
self:closeSelf()
end
...
function UILZHHroleSkillWin:onCloseClick()
local id=self.id
if id==4 then
local okCB=function()
UIManager:callWindowFunc('UILingZhenHHroleGameExWin','showFailureWin')
self:closeSelf()
end
...
function UILZHHroleSkillWin:onGiveUpBtn()
self:onCloseClick()
end

function UILZHHroleSkillWin:onMask()
self:onCloseClick()
end