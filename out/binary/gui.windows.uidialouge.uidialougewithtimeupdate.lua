...
def_class("UIDialougeWithTimeUpdate",UIWindowBase)
...
function UIDialougeWithTimeUpdate:bindComponents()
...
function UIDialougeWithTimeUpdate:unbindComponents()
...
function UIDialougeWithTimeUpdate:onLoaded(...)
self:bindComponents()
end


function UIDialougeWithTimeUpdate:__delete()
self:clearTimer()
...
function UIDialougeWithTimeUpdate:onShow(argtable,afterOnloaded)
...
function UIDialougeWithTimeUpdate:onHide()
self:clearTimer()
end

function UIDialougeWithTimeUpdate:setRefreshTextTimer(timeText,endTime,showTime)
...
local timerStr=FMT.fmt(timeText,timeHelper.format_time_stamp4(lerp))
...
function UIDialougeWithTimeUpdate:clearTimer()
if self.timer then
...
function UIDialougeWithTimeUpdate:onCloseBtn()
self:doClose()
end



function UIDialougeWithTimeUpdate:onCancelButton()
...
function UIDialougeWithTimeUpdate:onOkButton()
...
function UIDialougeWithTimeUpdate:onBGClick()
if self.showdata.allowclickBG==nil or self.showdata.allowclickBG==true then
self:onCloseBtn()
end
end

function UIDialougeWithTimeUpdate:doClose()
...
function UIDialougeWithTimeUpdate:doOk()
local okcallback=self.showdata.okcallback
self.showdata:deleteSelf()
self:close()
if okcallback then
...
function UIDialougeWithTimeUpdate:doCancel()
self.showdata:deleteSelf()
self:close()
end

function UIDialougeWithTimeUpdate:onChangeChoose()
