...
def_class("UISubAct_tgslZenYiWin",UIWindowBase)
...
function UISubAct_tgslZenYiWin:bindComponents()
...
function UISubAct_tgslZenYiWin:unbindComponents()
...
local czabname="ui/windows/activities/sub_taigushilian/taigushilian_atlas_pak.ab"


function UISubAct_tgslZenYiWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UISubAct_tgslZenYiWin:__delete()
...
function UISubAct_tgslZenYiWin:onShow(argtable,afterOnloaded)
if argtable then
...
self.monster=self.bossData[1][1][1][1]
...
local name=desc[1]
if name and name=="出战"then
item:SetChildText(2,"")
item:SetChildText(3,desc[2])
item:SetChildCSImageSprite(4,czabname,desc[3])
else
...
function UISubAct_tgslZenYiWin:onHide()

end

function UISubAct_tgslZenYiWin:onBlackBG()
self:closeSelf()
end

function UISubAct_tgslZenYiWin:onBtnClose()
self:closeSelf()
end

function UISubAct_tgslZenYiWin:onClickMask()
end

function UISubAct_tgslZenYiWin:onFazebtn()
UISubAct_tgslZenYiWin:onClickshowPanel(2)
end
function UISubAct_tgslZenYiWin:onDizibtn()
UISubAct_tgslZenYiWin:onClickshowPanel(1)
end


function UISubAct_tgslZenYiWin:onClickshowPanel(index)
...
function UISubAct_tgslZenYiWin:onClickSkill(fazeData)
local x=-146+78
