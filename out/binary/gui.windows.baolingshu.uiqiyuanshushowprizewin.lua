...
def_class("UIQiYuanShuShowPrizeWin",UIWindowBase)
...
function UIQiYuanShuShowPrizeWin:bindComponents()
...
function UIQiYuanShuShowPrizeWin:unbindComponents()
...
function UIQiYuanShuShowPrizeWin:onLoaded(...)
self:bindComponents()
end


function UIQiYuanShuShowPrizeWin:__delete()
...
function UIQiYuanShuShowPrizeWin:onShow(argtable,afterOnloaded)
...
local addMoneyCfg=cfg.rewards or{}
...
function UIQiYuanShuShowPrizeWin:setContentLayout(len)
...
function UIQiYuanShuShowPrizeWin:onHide()

end

function UIQiYuanShuShowPrizeWin:fillBtns()
local config=cfgHelper.get1(cfg_wishtreeconfig_get,1)
...
if haveItem<itemNum and cost[3]~=nil then
...
if haveItem_ten<itemNum_ten and cost[3]~=nil then
...
function UIQiYuanShuShowPrizeWin:onQifuOneBtn()
UIManager:invokeUIMethod("UIQiYuanShuWin","onQifuBtnOne")
self:closeSelf()
end



function UIQiYuanShuShowPrizeWin:onQifuTenBtn()
UIManager:invokeUIMethod("UIQiYuanShuWin","onQifuBtnTen")
self:closeSelf()
end

function UIQiYuanShuShowPrizeWin:onClickClose()
UIManager:callWindowFunc('UIQiYuanShuWin','fadeShowDZ')
self:closeSelf()
end