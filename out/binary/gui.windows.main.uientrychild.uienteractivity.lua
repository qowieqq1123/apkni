...
def_class("UIEnterActivity",UICloneObject)





UIEnterActivity.abName="ui/windows/main/uientrychild/uienternomalitem.ab"

UIEnterActivity.assetName="UIEnterNomalItem"


function UIEnterActivity:bindComponents()
...
function UIEnterActivity:unbindComponents()
...
function UIEnterActivity:onLoaded(...)
self:bindComponents()
...
function UIEnterActivity:__delete()
self:stopSelfTimer()
...
function UIEnterActivity:onActivityReddotChange(act_id)
if self.act_id~=act_id then return end

self:refreshReddot()
end

function UIEnterActivity:onShow(argtable,afterOnloaded)
...
function UIEnterActivity:refreshReddot()
local flag
...
function UIEnterActivity:startTimer()
...
function UIEnterActivity:stopSelfTimer()
if self.timer then
...
function UIEnterActivity:onHide()

end



function UIEnterActivity:onIcon()

end

function UIEnterActivity:onClickBg()
