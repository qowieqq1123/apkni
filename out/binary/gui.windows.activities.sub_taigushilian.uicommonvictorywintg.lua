...
def_class("UICommonVictoryWinTG",UIWindowBase)
...
function UICommonVictoryWinTG:bindComponents()
...
function UICommonVictoryWinTG:unbindComponents()
...
local btnDefaultLocalPosY=-295


function UICommonVictoryWinTG:onLoaded(...)
self:bindComponents()
end


function UICommonVictoryWinTG:__delete()
...
function UICommonVictoryWinTG:onHide()
...
function UICommonVictoryWinTG:onShow(argtable,afterOnloaded)
self:closeExtra()
self.cd=0
self.extraWin=argtable.extraWin
self.extraParams=argtable.extraParams
self.extraParams.parentWin='UICommonVictoryWinTG'
...
local btnLocalPosY=btnsInfo.btnLocalPosY or btnDefaultLocalPosY
self.btnRoot:setLocalPosY(btnLocalPosY)
end
...
function UICommonVictoryWinTG:closeExtra()
...
function UICommonVictoryWinTG:startContinue(time)
if time then
self.cd=time
end
if self.cd then
...
function UICommonVictoryWinTG:reStartContinue()
if self.continueTimer then
self:startContinue()
end
end

function UICommonVictoryWinTG:onCloseTips()
...
function UICommonVictoryWinTG:onQuitButton()
...
function UICommonVictoryWinTG:onContinueButton(outtime)
...
function UICommonVictoryWinTG:onFightCountBtn()
if self.isWait then
return
end
...
function UICommonVictoryWinTG:onFightRestartBtn()
if self.isWait then
return
end
