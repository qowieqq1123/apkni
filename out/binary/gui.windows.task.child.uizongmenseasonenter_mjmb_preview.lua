...
def_class("UIZongMenSeasonEnter_MJMB_Preview",UICloneObject)





UIZongMenSeasonEnter_MJMB_Preview.abName="ui/windows/task/child/uizongmenseasonenter_mjmb_preview.ab"

UIZongMenSeasonEnter_MJMB_Preview.assetName="UIZongMenSeasonEnter_MJMB_Preview"


function UIZongMenSeasonEnter_MJMB_Preview:bindComponents()
...
function UIZongMenSeasonEnter_MJMB_Preview:unbindComponents()
...
function UIZongMenSeasonEnter_MJMB_Preview:onLoaded(...)
self:bindComponents()
...
function UIZongMenSeasonEnter_MJMB_Preview:__delete()
...
function UIZongMenSeasonEnter_MJMB_Preview:onShow(argtable,afterOnloaded)
...
function UIZongMenSeasonEnter_MJMB_Preview:onHide()

end

function UIZongMenSeasonEnter_MJMB_Preview:refreshCD()
...
function UIZongMenSeasonEnter_MJMB_Preview:startCD()
...
function UIZongMenSeasonEnter_MJMB_Preview:stopCD()
...
function UIZongMenSeasonEnter_MJMB_Preview:onClick()
UIManager:showWindow("UIMoJieCDOpenWin")
end

function UIZongMenSeasonEnter_MJMB_Preview:refreshReddot()
...
function UIZongMenSeasonEnter_MJMB_Preview:onNewDay()
...
function UIZongMenSeasonEnter_MJMB_Preview:startWeakGuideDelayTimer()
self:stopWeakGuideDelayTimer()
...
function UIZongMenSeasonEnter_MJMB_Preview:stopWeakGuideDelayTimer()
