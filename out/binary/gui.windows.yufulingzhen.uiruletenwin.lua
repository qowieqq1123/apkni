...
def_class("UIRuleTenWin",UIWindowBase)
...
function UIRuleTenWin:bindComponents()
...
function UIRuleTenWin:unbindComponents()
...
function UIRuleTenWin:onLoaded(...)
self:bindComponents()
end


function UIRuleTenWin:__delete()
...
function UIRuleTenWin:onShow(argtable,afterOnloaded)
...
function UIRuleTenWin:refreshDesc()
