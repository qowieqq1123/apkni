...
platformSDK_PC_YY=simple_class(platformSDK_None)

local cjson=require'cjson'

local _WindowsHelper=CS.YYPCHelper
...
function platformSDK_PC_YY:__init(...)
...
function platformSDK_PC_YY:reqLogin()
_WindowsHelper.ExecCmd("reqLogin","")
end


function platformSDK_PC_YY:reqLogout()
_WindowsHelper.ExecCmd("reqLogout","")
end



function platformSDK_PC_YY:reqPay(id,count,params,subscribe)
...
function platformSDK_PC_YY:reqReport(typo,info)
...
function platformSDK_PC_YY:reqFangChenMi()

end


function platformSDK_PC_YY:onPay(json,jsonStr)
...
function platformSDK_PC_YY:LoginCallBack(json,jsonStr)
...
function platformSDK_PC_YY:LogoutCallBack(json,jsonStr)
...
function platformSDK_PC_YY:PurchasePaymentResult()

end


function platformSDK_PC_YY:OnApplicationQuit()
local showdata=
{
type='UIDialouge',
title='温馨提示',
...
function platformSDK_PC_YY:reqApplicationQuit_PC()
_WindowsHelper.ExecCmd("setQuitState","quit")
platformHelper:exitGame()
end


function platformSDK_PC_YY:reqMsgSecCheck(scene,content,callback,to_PrivatePlayerData)
...
function platformSDK_PC_YY:onreMsgSecCheck(json,jsonStr)
...
function platformSDK_PC_YY:Chitchat(content)
local playerinfo=platformHelper:getPlayerInfo()
local info
info=platformHelper.concat(info,playerinfo)
...
function platformSDK_PC_YY:gongHuiReport(game_event)
