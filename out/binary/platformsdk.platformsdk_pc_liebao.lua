...
platformSDK_PC_LieBao=simple_class(platformSDK_None)

local cjson=require'cjson'

local _WindowsHelper=CS.LieBaoPCHelper
...
function platformSDK_PC_LieBao:__init(...)
...
function platformSDK_PC_LieBao:reqLogin()
_WindowsHelper.ExecCmd("reqLogin","")
end


function platformSDK_PC_LieBao:reqLogout()
_WindowsHelper.ExecCmd("reqLogout","")
end



function platformSDK_PC_LieBao:reqPay(id,count,params,subscribe)
...
function platformSDK_PC_LieBao:reqReport(typo,info)
...
function platformSDK_PC_LieBao:reqFangChenMi()

end


function platformSDK_PC_LieBao:onPay(json,jsonStr)
...
function platformSDK_PC_LieBao:LoginCallBack(json,jsonStr)
...
function platformSDK_PC_LieBao:LogoutCallBack(json,jsonStr)
...
function platformSDK_PC_LieBao:PurchasePaymentResult()

end


function platformSDK_PC_LieBao:OnApplicationQuit()
local showdata=
{
type='UIDialouge',
title='温馨提示',
...
function platformSDK_PC_LieBao:reqApplicationQuit_PC()
_WindowsHelper.ExecCmd("setQuitState","quit")
platformHelper:exitGame()
end


function platformSDK_PC_LieBao:reqMsgSecCheck(scene,content,callback,to_PrivatePlayerData)
...
function platformSDK_PC_LieBao:onreMsgSecCheck(json,jsonStr)
...
function platformSDK_PC_LieBao:Chitchat(content)
local playerinfo=platformHelper:getPlayerInfo()
local info
info=platformHelper.concat(info,playerinfo)
...
function platformSDK_PC_LieBao:gongHuiReport(game_event)
