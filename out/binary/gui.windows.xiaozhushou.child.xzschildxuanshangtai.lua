...
def_class("xzsChildXuanShangTai",UICloneObject)





xzsChildXuanShangTai.abName="ui/windows/xiaozhushou/child/xzschildxuanshangtai.ab"

xzsChildXuanShangTai.assetName="xzsChildXuanShangTai"


function xzsChildXuanShangTai:bindComponents()
...
function xzsChildXuanShangTai:unbindComponents()
...
function xzsChildXuanShangTai:onLoaded(...)
self:bindComponents()
end


function xzsChildXuanShangTai:__delete()
...
function xzsChildXuanShangTai:onShow(argtable,afterOnloaded)
...
function xzsChildXuanShangTai:onHide()

end

function xzsChildXuanShangTai:refreshRewards()
