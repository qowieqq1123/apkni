...
def_class("UIXianJieSeasonEnter_MJMB",UICloneObject)





UIXianJieSeasonEnter_MJMB.abName="ui/windows/xianjie/child/uixianjieseasonenter_mjmb.ab"

UIXianJieSeasonEnter_MJMB.assetName="UIXianJieSeasonEnter_MJMB"


function UIXianJieSeasonEnter_MJMB:bindComponents()
...
function UIXianJieSeasonEnter_MJMB:unbindComponents()
...
function UIXianJieSeasonEnter_MJMB:onLoaded(...)
self:bindComponents()
_this=self
...
function UIXianJieSeasonEnter_MJMB:__delete()
self:stopSeasonTick()
_this=nil
...
function UIXianJieSeasonEnter_MJMB:onShow(argtable,afterOnloaded)
...
function UIXianJieSeasonEnter_MJMB:onHide()
self:stopSeasonTick()
end

function UIXianJieSeasonEnter_MJMB:refresh()
...
function UIXianJieSeasonEnter_MJMB:refreshSeasonReddot()
local reddot=self.enterHandle:getReddot()
self.reddot:setActive(reddot)
end

function UIXianJieSeasonEnter_MJMB:refreshSeasonStage()
...
function UIXianJieSeasonEnter_MJMB:refreshSeasonTime()
...
function UIXianJieSeasonEnter_MJMB:showStageSpPart()
...
function UIXianJieSeasonEnter_MJMB:showCountDownPart()
self.progressBar:setActive(false)
self.progressInfo:setActive(false)
end

function UIXianJieSeasonEnter_MJMB:startSeasonTick(time)
...
function UIXianJieSeasonEnter_MJMB:stopSeasonTick()
...
function UIXianJieSeasonEnter_MJMB:updateSeasonTick()
