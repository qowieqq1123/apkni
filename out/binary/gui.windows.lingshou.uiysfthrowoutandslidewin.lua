...
def_class("UIYSFThrowOutAndSlideWin",UIWindowBase)
...
function UIYSFThrowOutAndSlideWin:bindComponents()
...
function UIYSFThrowOutAndSlideWin:unbindComponents()
...
[2]={
startPos=Vector3.New(0,-230,0),
entPos=Vector3.New(0,10,0)
},
...
function UIYSFThrowOutAndSlideWin:onLoaded(...)
self:bindComponents()

end


function UIYSFThrowOutAndSlideWin:__delete()
...
function UIYSFThrowOutAndSlideWin:onHide()

end

function UIYSFThrowOutAndSlideWin:initView()
self.defaultFontSize=24
self.defaultFontColor=Color.New(1,1,1,1)
...
function UIYSFThrowOutAndSlideWin:getKeyIdx()
...
function UIYSFThrowOutAndSlideWin:timeClose()
closeTimeCounter=nil
self:closeSelf()
end
...
function UIYSFThrowOutAndSlideWin:onShow(argtable,afterOnloaded)
...
function UIYSFThrowOutAndSlideWin:tickUpdata()
self:addMessageEx()
...
function UIYSFThrowOutAndSlideWin:throwOut(k_idx,args)
local thType=args[1]
local str=args[2]
...
local t1=item:SetChildDOLocalMove(0,entPos,5,func1)
...
local fun3=function()
local t3=item:SetChildDOScale(0,1,1,nil)
table.insert(comdata.tweenlist,t3)
end
local t2=item:SetChildDOScale(0,2,0.5,fun3)
table.insert(comdata.tweenlist,t2)


local func2=function()
comdata.closeTimer=nil
local t4=item:SetChildCanvasGroupDOFade(0,0,2,nil)
table.insert(comdata.tweenlist,t4)
end
comdata.closeTimer=self:delayDo(0.5,func2)
end
function UIYSFThrowOutAndSlideWin:clearTweener(tw)
...
function UIYSFThrowOutAndSlideWin:addMessage(args)
...
function UIYSFThrowOutAndSlideWin:addMessageEx()
