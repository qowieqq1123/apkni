...
def_class("UISubAct_ChiSeJinDi_CopyMainWin3",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:unbindComponents()
...
window.autoRun=true
window:closeWindow("UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin3")
call_activitiesHandle_func("activitiesHandle_chisejindi","reqNextCopyRound",window.actId,window.subId)
end
end,
}
window:showWindow("UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin3",args)
...
local _iconInterval=90
local _iconPadding=30
local _iconSpHeight=11



function UISubAct_ChiSeJinDi_CopyMainWin3:onLoaded()
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyMainWin3:__delete()
self:killAllDoTween()
self:stopUpdateTick()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onHide()
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3.on_249_230(actId,subId)
...
function UISubAct_ChiSeJinDi_CopyMainWin3.on_249_237(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyMainWin3.on_249_238(actId,subId,idx,len,roundList)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoney()
...
function UISubAct_ChiSeJinDi_CopyMainWin3.on_249_239(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoney()
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3.on_249_240(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyMainWin3.on_249_241(actId,subId,roundtype,len,ids)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoney()
...
elseif roundtype==eChiSeJinDiRoundType.Weapon and _this._vState==_eViewState.eWeaponBag then
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onSModel_1()
if self.teamData[1].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onSModel_2()
if self.teamData[2].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onSModel_3()
if self.teamData[3].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onSModel_4()
if self.teamData[4].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onSModel_5()
if self.teamData[5].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onBackground_1()
self:changeViewState(_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onBackButton()
local args={
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onFightBtn()
...
for _,posData in ipairs(self.teamData)do
local disciple=posData.disciple
local weapon=posData.weapon
local discipleColor=disciple>0 and discipleServer[disciple][5]or 0
local weaponColor=weapon>0 and weaponServer[weapon][6]or 0
...
for _,discipleId in ipairs(self.discipleBagDatas)do
...
for _,weaponId in ipairs(self.weaponBagDatas)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onGoBtn()
if self.animation then
return false
end
if self._rChanging then
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onFightFaZe()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onDiscipleBtn()
self:changeViewState(_eViewState.eDiscipleBag)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onWeaponBtn()
self:changeViewState(_eViewState.eWeaponBag)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onFazeBtn()
self:changeViewState(_eViewState.eFaZeBag)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onDiscipleBack()
self:changeViewState(_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onWeaponBack()
self:changeViewState(_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onClickBottomTipsBtn()
self.showTips=not self.showTips
self:showBottomTips()
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onTipsPanel()
self.showTips=false
self:showBottomTips()
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onClickSModel()
local roleList={}
for _,v in ipairs(self.teamData)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:initCopyTips()
local str=self.config.copyTips
self.tipsContent:setText(str)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:showRoundMoneyAdd()
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDragDisciple(discipleId)
local discipleServer=self.config.disciple
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDragWeapon(weaponID)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:cancelDragDisciple()
self.dragDiscipleId=nil
self.dragDisciple:setChildUIModelRemoveTarget()
self.dragDisciple:setActive(false)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:cancelDragWeapon()
self.dragWeaponId=nil
self.dragWeapon:setActive(false)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onTeamModelBeginDrag(index,targetPos)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onTeamModelEndDrag(index,targetPos)
if self._vState~=_eViewState.eDiscipleBag then return end
if self.dragDiscipleId==nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onTeamModelDrag(index,targetPos,deltaTime)
if self._vState~=_eViewState.eDiscipleBag then return end
if self.dragDiscipleId==nil then return end
self.dragDisciple:setChildUIScreenPos(targetPos)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onTeamWeaponBeginDrag(index,position)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onTeamWeaponEndDrag(index,targetPos)
if self._vState~=_eViewState.eWeaponBag then return end
...
if check then
if i==index then
local w=self.sWeaponWidget[index]
w:SetChildActive(_weaponSlotCmp.qualityIcon,true)
return
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onTeamWeaponDrag(index,targetPos,deltaTime)
if self._vState~=_eViewState.eWeaponBag then return end
if not self.dragWeaponId then return end
self.dragWeapon:setChildUIScreenPos(targetPos)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onBagDiscipleBeginDrag(index,position)
if self._vState~=_eViewState.eDiscipleBag then return end
if self.dragDiscipleId~=nil then return end
self.dragDisciple:setActive(true)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onBagDiscipleEndDrag(index,targetPos)
if self._vState~=_eViewState.eDiscipleBag then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onBagDiscipleDrag(index,targetPos,deltaTime)
if self._vState~=_eViewState.eDiscipleBag then return end
if not self.dragDiscipleId then return end
self.dragDisciple:setChildUIScreenPos(targetPos)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:onBagWeaponBeginDrag(index,position)
if self._vState~=_eViewState.eWeaponBag then return end
if self.dragWeaponId~=nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onBagWeaponEndDrag(index,targetPos)
if self._vState~=_eViewState.eWeaponBag then return end
if not self.dragWeaponId then return end
self:cancelDragWeapon()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onBagWeaponDrag(index,targetPos)
if self._vState~=_eViewState.eWeaponBag then return end
if not self.dragWeaponId then return end
self.dragWeapon:setChildUIScreenPos(targetPos)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:changeViewState(state)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:changeRoundState(state,param,callback)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:quitCopy()
self.info:setCopy()
self.info:clearStarUp()
self:doCloseWin()
end

function UISubAct_ChiSeJinDi_CopyMainWin3:doCloseWin()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:initView()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshBackground()
self.bgUse=0
local template=self.copyData.template
local round=self.copyData.round
...
function UISubAct_ChiSeJinDi_CopyMainWin3:animationBackground(pos,duration,callback)
local template=self.copyData.template
local round=self.copyData.round
local templateCfg=cfgHelper.get2(cfg_chisejindiroundconfig_get,template,round)
...
self:doTeamDiscipleAnimation(eAnimationID.stand)
end)

local width=self.previewWidget:GetChildSizeDeltaX(_previewCmp.progressSp)
local tween1=self.previewWidget:SetChildDOSizeDelta(_previewCmp.progressSp,Vector2.New(width+_iconInterval,_iconSpHeight),0.2)
tween1:SetEase(DG.Tweening.Ease.Linear)
sequence:Append(tween1)

sequence:AppendCallback(function()
local iconItem=self.previewWidget:GetChildLayoutGroupGridItem(_previewCmp.iconList,round-1)
iconItem:SetChildActive(1,true)
end)

local iconPos=self.previewWidget:GetChildAnchoredPosition(_previewCmp.iconList)
local tween2=self.previewWidget:SetChildDOAnchorPosX(_previewCmp.iconList,iconPos.x-_iconInterval,0.2)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:freezeBackground()
for i,v in pairs(self.background)do
self.winlua:SetChildUIModelAnimationSpeed(v:getID(),0)
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:refreshMoney()
local moneyStr=mathHelper.formatNumber(self.copyData.money)
self.moneyNum:setText(moneyStr)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:refreshRound()
local template=self.copyData.template
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshLevel()
self.levelBg:setChildLayoutGroupCreateItems(self.copyData.level)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:refreshHP()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshTeamDisciple()
for i,_ in ipairs(self.sModelWidget)do
self:refreshTeamDiscipleItem(i)
end
end

function UISubAct_ChiSeJinDi_CopyMainWin3:refreshTeamDiscipleItem(index)
local posData=self.teamData[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:doTeamDiscipleAnimation(anim)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshEventModel()
local roundData=self.copyData.roundData
...
for i,_ in ipairs(_eventTeamCmp.item)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:setEnemyFlagUnknown()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:setEnemyFlagKnown(randomName)
local roundData=self.copyData.roundData
local widget=self.enemyFlag:getChildWidgetBase()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:showTeamSlot(show)
for i,v in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDiscipleBag(assign)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDisciplePageList()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDisciplePageItemTick(indexList)
local onLookup=self.info:getTeamLookup_Disciple()
for _,itemIdx in ipairs(indexList)do
local index=(self.discipleBagPage-1)*self.discipleViewPageItemCnt+itemIdx
local discipleID=self.discipleBagDatas[index]
local item=self.discipleViewPageItems[itemIdx-1]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDisciplePageItemTickEx(disciples)
local onLookup=self.info:getTeamLookup_Disciple()
for itemIdx=1,self.discipleViewPageItemCnt do
local index=(self.discipleBagPage-1)*self.discipleViewPageItemCnt+itemIdx
local discipleID=self.discipleBagDatas[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onLongTouchDiscipleBagItem(index)
if self.dragDiscipleId~=nil then return end
local discipleId=self.discipleBagDatas[index]
local lookup=self.info:getTeamLookup_Disciple()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onClickDiscipleBagItem(index)
local discipleId=self.discipleBagDatas[index]
local lookup=self.info:getTeamLookup_Disciple()
local pos=lookup[discipleId]
if pos then
...
for _,v in ipairs(jobCfg.pospriorty)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:showTeamWeapon(show)
for i,v in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
if posData.disciple>0 then
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshAllTeamWeapon()
for i,_ in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
if posData.disciple>0 then
self:refreshTeamPosWeapon(i)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshTeamPosWeapon(index)
local widget=self.sWeaponWidget[index]
local posData=self.teamData[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshWeaponBag()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshWeaponPageList()
...
for _,vStr in ipairs(descEx)do
local str=FMT.fmt('<color=#ffff99>{0}</color>',vStr)
desc=FMT.fmt('{0}\n{1}',desc,str)
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onLongTouchWeaponBagItem(index)
if self.dragWeaponId~=nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshWeaponBagItemOwner(indexList)
local lookup=self.info:getTeamLookup_Weapon()
for _,itemIdx in ipairs(indexList)do
local index=(self.weaponBagPage-1)*self.weaponViewPageItemCnt+itemIdx
local weaponId=self.weaponBagDatas[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshWeaponBagItemOwnerEx(weapons)
local lookup=self.info:getTeamLookup_Weapon()
for itemIdx=1,self.weaponViewPageItemCnt do
local index=(self.weaponBagPage-1)*self.weaponViewPageItemCnt+itemIdx
local weaponId=self.weaponBagDatas[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onClickWeaponBagItem(index)
local weaponId=self.weaponBagDatas[index]
local lookup=self.info:getTeamLookup_Weapon()
local pos=lookup[weaponId]
if pos then
...
function UISubAct_ChiSeJinDi_CopyMainWin3:animationRandomView(callback)
self.animation=true
local roundData=self.copyData.roundData
...
for _,tween in pairs(modelTweens)do
sequence:Join(tween)
end
for _,tween in pairs(shadowTweens)do
sequence:Join(tween)
end
sequence:AppendCallback(function()
local widget=self.fightRoot:getChildWidgetBase()
for pos,_ in pairs(modelTweens)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshFightRoot()
local widget=self.fightRoot:getChildWidgetBase()
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onClickFightModel(index)
local roundData=self.copyData.roundData
local fightList=roundData.fightList
...
function UISubAct_ChiSeJinDi_CopyMainWin3:onClickTeamWeapon(index)
local posData=self.teamData[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin3:checkAutoTeamOnRefresh(index)
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin3:checkStarUpRefresh()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:nextStarUp()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:discipleViewEnter()
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
for _,v in ipairs(self.sModelWidget)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:discipleViewExit(callback)
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:weaponViewEnter()
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:weaponViewExit(callback)
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshDiscipleBtnReddot()
local lookup=self.info:getTeamLookup_Disciple()
local onCnt=0
local offCnt=0
for _,v in ipairs(self.discipleBagDatas)do
if lookup[v]then
onCnt=onCnt+1
else
offCnt=offCnt+1
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshWeaponBtnReddot()
local discipleLookup=self.info:getTeamLookup_Disciple()
local empty=false
for _,pos in pairs(discipleLookup)do
...
local weaponLookup=self.info:getTeamLookup_Weapon()
for _,v in ipairs(self.weaponBagDatas)do
...
function UISubAct_ChiSeJinDi_CopyMainWin3:flowMoney(num)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:checkAutoRun()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:weaponRoundEnter(param,callback)
...
self.autoRun=true
self:closeWindow("UISubAct_ChiSeJinDi_CopyWeaponBuyWin3")
...
self:showWindow("UISubAct_ChiSeJinDi_CopyWeaponBuyWin3",args)
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:weaponRoundExit(param,callback)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:rewardRoundAnimation(param,callback)
AudioManager.playAudio(662)
self.animation=true
local num=self.copyData.roundData.chance
local word=FMT.fmt("+{0}",num)
local pic={iconName=iconHelper.getIconName(self.config.chanceMoney)}
local effectCfg=cfgHelper.get1(cfg_effectconfig_get,3)
local effectDuration=effectCfg.lifetime/1000
local sequence=Lua.SequenceProxy.New()
if pic then
...
function UISubAct_ChiSeJinDi_CopyMainWin3:setDoTween(index,tweener)
self:cleanDoTween(index,true)
self.tweeners[index]=tweener
end

function UISubAct_ChiSeJinDi_CopyMainWin3:cleanDoTween(index,complete)
...
function UISubAct_ChiSeJinDi_CopyMainWin3:killAllDoTween()
for _,v in pairs(self.tweeners)do
if v:IsActive()then
v:Kill()
end
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:refreshBackBtn()
self.backButton:setActive(self._vState==_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:startUpdateTick()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:checkUpdateTick()
if self.info:checkInResultRankTime()then
self:quitCopy()
UIManager.info("结算开始，0点后可再进入")
end
...
function UISubAct_ChiSeJinDi_CopyMainWin3:stopUpdateTick()
...
function UISubAct_ChiSeJinDi_CopyMainWin3:showBottomTips()
self.tipsPanel:setScale(self.showTips and Vector3.one or Vector3.zero)
end

function UISubAct_ChiSeJinDi_CopyMainWin3:refreshPreview()
...
local type=index<iconCnt and cfg.params[1]or self.copyData.roundData.roundtype
item:SetChildCSImageSprite(0,_abName,"icon_chiseshilian_xiyou_"..type)
item:SetChildActive(1,self.copyData.round>index or(self.copyData.round==index and self._rState==_eRoundState.eEvent))
...
local temp=self._rState==_eRoundState.eIdle and 1 or 0
local posX=((round-temp)*_iconInterval-(_iconInterval-_iconPadding))*-1
self.previewWidget:SetChildSizeDelta(_previewCmp.progressSp,(round-temp)*_iconInterval,_iconSpHeight)
