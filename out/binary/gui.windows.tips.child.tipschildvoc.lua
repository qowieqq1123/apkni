...
def_class("tipsChildVoc",UICloneObject)





tipsChildVoc.abName="ui/windows/tips/child/tipschildvoc.ab"

tipsChildVoc.assetName="tipsChildVoc"


function tipsChildVoc:bindComponents()
...
function tipsChildVoc:unbindComponents()
...
function tipsChildVoc:onLoaded(...)
self:bindComponents()
end

function tipsChildVoc:__delete()
self:unbindComponents()
end

function tipsChildVoc:onShow(args,afterOnloaded)
