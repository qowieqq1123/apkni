...
local xjEntity_RPEvent={}


function xjEntity_RPEvent:onInit()
...
function xjEntity_RPEvent:onCreateWidget(widget)
local data=xianjieModel:getResPointData(self.dataGuid)
...
function xjEntity_RPEvent:onRemoveWidget(widget)
widget:SetChildSceneEntityRemoveModel(0)
end

function xjEntity_RPEvent:onMyClick(boxParams)
xianjieController:onClickResPoint(self.dataGuid)
end


function xjEntity_RPEvent:refreshInfo()
...
function xjEntity_RPEvent:checkLogicShow()
local data=xianjieModel:getResPointData(self.dataGuid)
