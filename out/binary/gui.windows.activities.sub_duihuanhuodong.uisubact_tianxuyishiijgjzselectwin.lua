...
def_class("UISubAct_tianxuyishiiJGJZSelectWin",UIWindowBase)
...
function UISubAct_tianxuyishiiJGJZSelectWin:bindComponents()
...
function UISubAct_tianxuyishiiJGJZSelectWin:unbindComponents()
...
function UISubAct_tianxuyishiiJGJZSelectWin:onLoaded(...)
self:bindComponents()
_this=self
...
function UISubAct_tianxuyishiiJGJZSelectWin:__delete()
...
function UISubAct_tianxuyishiiJGJZSelectWin:onShow(argtable,afterOnloaded)
...
self.needItemIdList=argtable.needItemIdList
...
function UISubAct_tianxuyishiiJGJZSelectWin:on_item_list_changed(argstable)
...
function UISubAct_tianxuyishiiJGJZSelectWin:refreshTargetCostItem()
...
function UISubAct_tianxuyishiiJGJZSelectWin:onSliderChange(newSelectCnt)
...
function UISubAct_tianxuyishiiJGJZSelectWin:refreshSelectBagList(diffNum)
...
function UISubAct_tianxuyishiiJGJZSelectWin:refreshBagList()

local filter={}
filter[ITEM_FILTER_TYPE.eItemid]={ITEM_FILTER_COMPARE.eEquals,self.needItemIdList}
self.bagList=bagControl.getBagItemsByFilter(BAG_TYPE.eItemBag,filter,nil,false)
...
function UISubAct_tianxuyishiiJGJZSelectWin:getBagItemIdx(bagListIdx)
local idx=bagListIdx%_colomn
return math.ceil(bagListIdx/_colomn),idx==0 and _colomn-1 or idx-1
end

function UISubAct_tianxuyishiiJGJZSelectWin:refreshBagListItem(bagListIdx)
...
function UISubAct_tianxuyishiiJGJZSelectWin:onStartAction()
end

function UISubAct_tianxuyishiiJGJZSelectWin:onFreshAction(index,itemWidget)
...
function UISubAct_tianxuyishiiJGJZSelectWin:onItemClick(itemid,index,itemguid,attach)
...
local argstable={
formType=TIPS_FORM_TYPE.eJGJZMaterial,
itemid=itemid,
itemguid=itemguid,
attach={formType=TIPS_FORM_TYPE.eJGJZMaterial,index=index,selectNumCmpArgs=selectNumCmpArgs,},
}
...
function UISubAct_tianxuyishiiJGJZSelectWin:setSelectNum(itemguid,selectedNum,index,itemid)
...
function UISubAct_tianxuyishiiJGJZSelectWin:getSelectNum(itemguid)
if self.selectList==nil then self.selectList={}end
if self.selectList[tostring(itemguid)]then
...
function UISubAct_tianxuyishiiJGJZSelectWin:onCloseBtn()
self:closeSelf()
end

function UISubAct_tianxuyishiiJGJZSelectWin:onExchangeBtn()
...
function UISubAct_tianxuyishiiJGJZSelectWin:onSubBtn()
...
function UISubAct_tianxuyishiiJGJZSelectWin:onAddBtn()
if self.max<=1 then
return
end
...
function UISubAct_tianxuyishiiJGJZSelectWin:onHelpBtn()
local d={}
d.mode=3
d.title="规则介绍"
