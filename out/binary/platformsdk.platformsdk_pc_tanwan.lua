...
platformSDK_PC_TanWan=simple_class(platformSDK_None)

local cjson=require'cjson'

local _WindowsHelper=CS.TanWanPCHelper
...
function platformSDK_PC_TanWan:__init(...)
...
function platformSDK_PC_TanWan:reqLogin()
_WindowsHelper.ExecCmd("reqLogin","")
end


function platformSDK_PC_TanWan:reqLogout()
_WindowsHelper.ExecCmd("reqLogout","")
end



function platformSDK_PC_TanWan:reqShowUserCenter()
_WindowsHelper.ExecCmd("onShowUserCenter","")
end


function platformSDK_PC_TanWan:reqPay(id,count,params,subscribe)
...
function platformSDK_PC_TanWan:reqReport(typo,info)
...
function platformSDK_PC_TanWan:reqFangChenMi()

end


function platformSDK_PC_TanWan:onPay(json,jsonStr)
...
function platformSDK_PC_TanWan:LoginCallBack(json,jsonStr)
...
function platformSDK_PC_TanWan:LogoutCallBack(json,jsonStr)
...
function platformSDK_PC_TanWan:PurchasePaymentResult()

end


function platformSDK_PC_TanWan:OnApplicationQuit()
local showdata=
{
type='UIDialouge',
title='温馨提示',
...
function platformSDK_PC_TanWan:checkChat()
...
function platformSDK_PC_TanWan:reqMsgSecCheck(scene,content,callback,to_PrivatePlayerData)
...
function platformSDK_PC_TanWan:onreMsgSecCheck(json,jsonStr)
...
function platformSDK_PC_TanWan:reqApplicationQuit_PC()
_WindowsHelper.ExecCmd("setQuitState","quit")
platformHelper:exitGame()
end