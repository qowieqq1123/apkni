...
def_class("UIExchangeShopWin",UIWindowBase)
...
function UIExchangeShopWin:bindComponents()

self.creater=UIObject.get(self,0)
self.model=UIObject.get(self,1)
self.modelbefore=UIObject.get(self,2)
self.modelPeople=UIObject.get(self,3)
self.modelPeopleBtn=UIButton.get(self,4)
self.money=UIText.get(self,5)
self.moneyBtn=UIButton.get(self,6)
self.moneyIcon2=UIImage.get(self,7)
self.moneyRoot=UIObject.get(self,8)
...
function UIExchangeShopWin:unbindComponents()
...
function UIExchangeShopWin:onLoaded(...)
self:bindComponents()
...
function UIExchangeShopWin:__delete()
...
function UIExchangeShopWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UIExchangeShopWin:onHide()
self:clearTimer()
self:reductionSpkObj()
end


function UIExchangeShopWin:refreshBgModel()
...
function UIExchangeShopWin:setRemainingTimeTimer()
self:clearTimer()
local func=function()
...
self.time:setText(FMT.fmt("活动时间：{0}",timeHelper.format_time_stamp12(lerp)))
else
...
function UIExchangeShopWin:clearTimer()
if self.timer then
...
function UIExchangeShopWin:initMoney()
...
function UIExchangeShopWin:freshMoney()
...
function UIExchangeShopWin:getGoodData(idx)
...
function UIExchangeShopWin:freshGirds()
...
function UIExchangeShopWin:freshPageItem(pageidx)
...
function UIExchangeShopWin:freshChildItem(pageidx,index)
local pageWidget=self.creater:getChildLayoutGroupGridItem(pageidx-1)
local item=pageWidget:GetChildLayoutGroupGridItem(3,index-1)
local pageCfg=self.goodlist[pageidx]
local qlTag=pageCfg.qlTag==true
...
function UIExchangeShopWin:onItemClick(id,index,guid,attach)
if id==-1 then return end
tipsManager.showTips({itemid=id,showModel=true,})
end

function UIExchangeShopWin:onScrollItemClick(id,index,guid,attach)
...
function UIExchangeShopWin:onBuyGood(idx,freshAll)
if idx<=0 then return end
self:freshGirds()
end

function UIExchangeShopWin:onBuildingEvent(typo,level)
...
function UIExchangeShopWin:onMoneyChanged(moneyType)
...
function UIExchangeShopWin:initRandom()
this.talkList=this.config.auto_talklist
end

function UIExchangeShopWin:removeRandom(idx)
local list={}
...
function UIExchangeShopWin:getRandom()
...
function UIExchangeShopWin:doSpeaking_player()
local speed=30
...
function UIExchangeShopWin:doTalkAnim_player()
...
function UIExchangeShopWin:talkEnd()
...
function UIExchangeShopWin:clearSpkTimer()
if this.talkTween~=nil then
this.talkTween:Kill()
this.talkTween=nil
end
...
function UIExchangeShopWin:reductionSpkObj()
this:clearSpkTimer()
this.winlua:SetChildScale(this.speakObj:getID(),Vector3.zero)
this.winlua:SetChildCanvasGroupAlpha(this.speakObj:getID(),0)
end

function UIExchangeShopWin:getIsShowNewIcon(itemId)
...
function UIExchangeShopWin:getShowNewIconData()
local data=userActorArraySetting.getBase(ACTOR_SETTING_TYPE.eExChangeShop2,{})
return data
end

function UIExchangeShopWin:setShowNewIconData(list)
...
function UIExchangeShopWin:getNeedTimeUnlock(waitdays)
...
function UIExchangeShopWin:format_time_stamp122(time)
local day=86400
local hour=3600
local min=60
local str=nil
...
function UIExchangeShopWin:onMoneyBtn()
gainControl:showGainWin(self.moneyType)
end


function UIExchangeShopWin:onModelPeopleBtn()
local flag=false
local nowTime=gameUtilityModel.getServerShortTime()
