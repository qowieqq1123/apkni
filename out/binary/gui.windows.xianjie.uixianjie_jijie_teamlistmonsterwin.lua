...
def_class("UIXianJie_JiJie_teamListMonsterWin",UIWindowBase)
...
function UIXianJie_JiJie_teamListMonsterWin:bindComponents()
...
self.getRewardNumText=UIText.get(self,9)
...
function UIXianJie_JiJie_teamListMonsterWin:unbindComponents()
...
function UIXianJie_JiJie_teamListMonsterWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UIXianJie_JiJie_teamListMonsterWin:__delete()
_this=nil
...
function UIXianJie_JiJie_teamListMonsterWin:onShow(argtable,afterOnloaded)
...
function UIXianJie_JiJie_teamListMonsterWin:onShowArgRecv(argtable,afterOnloaded)
self:refresh()
end


function UIXianJie_JiJie_teamListMonsterWin:onHide()
self:clearUpdateTimer()
end

function UIXianJie_JiJie_teamListMonsterWin:refresh(isInit)
self:clearUpdateTimer()
if isInit then
self.teamsList=xianjieModel:getJiJieSimpleDataListByJJType(xjJjJieBaseType.eMonster)or{}
end
...
self:refreshGetRewardNumText()
end


function UIXianJie_JiJie_teamListMonsterWin:refreshTeamList()
local num=#self.teamsList
...
item:SetChildActive(_teamItemCmpIndex.notXm,false)
item:SetChildActive(_teamItemCmpIndex.hasXm,false)
...
function UIXianJie_JiJie_teamListMonsterWin:refreshTeamList_update()
...
function UIXianJie_JiJie_teamListMonsterWin:setUpdateTimer()
self:clearUpdateTimer()
...
function UIXianJie_JiJie_teamListMonsterWin:clearUpdateTimer()
...
function UIXianJie_JiJie_teamListMonsterWin:refreshGetRewardNumText()
...
local jieYouFlag=2
local entityType_jieyou=bit.lshift(jieYouFlag,8)+entityType
local rewardTimeConf_jieyou=xianjieModel:getMonsterInfoCfg(entityType_jieyou)
local allNum_jieyou=0
local remainingNum_jieyou=0
if rewardTimeConf_jieyou then
local maxTimes=rewardTimeConf_jieyou[1]
local curTimes=xianjieModel:getMonsterRewardTimes(entityType,jieYouFlag)
allNum_jieyou=maxTimes
remainingNum_jieyou=maxTimes-curTimes
end
local numStr_jieYou=tostring(remainingNum_jieyou)
if remainingNum_jieyou<=0 then
numStr_jieYou=FMT.cfmt(FONT_COLOR.eRedColor,numStr_jieYou)
end

self.getRewardNumText:setText(FMT.fmt("剩余征讨奖励次数：{0}/{1} 剩余界游仙墟次数：{2}/{3}",numStr,allNum,numStr_jieYou,allNum_jieyou))
end

function UIXianJie_JiJie_teamListMonsterWin.on_35_10()
if not _this then return end

_this:refreshGetRewardNumText()
end

function UIXianJie_JiJie_teamListMonsterWin.onNewDay5am()
if not _this then return end
...
function UIXianJie_JiJie_teamListMonsterWin:onClickMask()
self:onCloseBtn()
end



function UIXianJie_JiJie_teamListMonsterWin:onCloseBtn()
...
function UIXianJie_JiJie_teamListMonsterWin:onGotoBtn()


xianjieController:openWin('UIXianJieExplorationWin',{page=1,extra={selectid=4,selectCnt=1}})
...
function UIXianJie_JiJie_teamListMonsterWin:onInfoPaixu()
end



function UIXianJie_JiJie_teamListMonsterWin:onFightPaixu()
end



function UIXianJie_JiJie_teamListMonsterWin:onYbdsetBtn(page)
...
function UIXianJie_JiJie_teamListMonsterWin:onItemJoinClick(idx)
local teamData=self.teamsList[idx]
...
function UIXianJie_JiJie_teamListMonsterWin:onInfoBtnClick(idx)
local teamData=self.teamsList[idx]
local massguid=teamData.massguid
local actorId=teamData.actorid
local sceneidx=teamData.sceneidx
...
function UIXianJie_JiJie_teamListMonsterWin:onItemBoxClick(idx)
local teamData=self.teamsList[idx]
local infoguid=teamData.guid
local monsterData=xianjieModel:getMonsterData(infoguid)
local cfg=monsterData:getCfg()
...
function UIXianJie_JiJie_teamListMonsterWin:onRuleBtn()
local flag=0
local entityType=xjServerEnityType.eMonsterHouse
local rules=cfgHelper.get4(cfg_fairylandbaseconfig_get,1,'monsterRule',entityType,flag)
local d={}
d.mode=3
d.title="规则"
d.name=rules[1]
