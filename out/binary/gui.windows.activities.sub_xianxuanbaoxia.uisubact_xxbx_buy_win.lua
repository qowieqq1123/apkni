...
def_class("UISubAct_XXBX_Buy_Win",UIWindowBase)
...
function UISubAct_XXBX_Buy_Win:bindComponents()
...
function UISubAct_XXBX_Buy_Win:unbindComponents()
...
function UISubAct_XXBX_Buy_Win:onLoaded(...)
self:bindComponents()
end


function UISubAct_XXBX_Buy_Win:__delete()
self:clearTimer()
...
function UISubAct_XXBX_Buy_Win:onShow(argtable,afterOnloaded)
...
local tipsStr=""
if curDay-1>0 then
tipsStr=FMT.fmt("现在购买可立刻领取前{0}天的奖励",curDay-1)
else
tipsStr="现在购买可立刻领取今天的奖励"
end
...
function UISubAct_XXBX_Buy_Win:onHide()
self:clearTimer()
end


function UISubAct_XXBX_Buy_Win:setSpineCallBackFun()
self:clearTimer()
...
function UISubAct_XXBX_Buy_Win:refresh()

self:refreshShowPanel()


local rechargeId=self.recharge_id
...
function UISubAct_XXBX_Buy_Win:refreshShowPanel()
...
function UISubAct_XXBX_Buy_Win:initRewardsList()
...
for i=1,#rewards do
local touziRewards=rewards[i][2]

for ii,vv in ipairs(touziRewards)do
local itemId=vv[1]
...
function UISubAct_XXBX_Buy_Win:onBuyBtn()
...
function UISubAct_XXBX_Buy_Win:onCancelBtn()
self:onClickClose()
end


function UISubAct_XXBX_Buy_Win:onClickClose()
self:closeSelf()
end


function UISubAct_XXBX_Buy_Win:onClickRewardItem(itemId,index,guid,attach)
if itemId==-1 then
return
end
...
function UISubAct_XXBX_Buy_Win:clearTimer()
