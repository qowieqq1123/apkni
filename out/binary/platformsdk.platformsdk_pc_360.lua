...
platformSDK_PC_360=simple_class(platformSDK_None)

local cjson=require'cjson'

local _WindowsHelper=CS.PC360Helper

function platformSDK_PC_360:__init(...)
...
function platformSDK_PC_360:reqLogin()
_WindowsHelper.ExecCmd("reqLogin","")
end


function platformSDK_PC_360:reqLogout()
_WindowsHelper.ExecCmd("reqLogout","")
end



function platformSDK_PC_360:reqPay(id,count,params,subscribe)
...
function platformSDK_PC_360:reqReport(typo,info)
...
function platformSDK_PC_360:reqFangChenMi()

end


function platformSDK_PC_360:onPay(json,jsonStr)
...
function platformSDK_PC_360:LoginCallBack(json,jsonStr)
...
function platformSDK_PC_360:LogoutCallBack(json,jsonStr)
...
function platformSDK_PC_360:PurchasePaymentResult()

end


function platformSDK_PC_360:OnApplicationQuit()
local showdata=
{
type='UIDialouge',
title='温馨提示',
...
function platformSDK_PC_360:reqApplicationQuit_PC()
_WindowsHelper.ExecCmd("setQuitState","quit")
platformHelper:exitGame()
end