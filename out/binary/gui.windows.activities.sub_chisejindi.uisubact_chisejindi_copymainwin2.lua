...
def_class("UISubAct_ChiSeJinDi_CopyMainWin2",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:unbindComponents()
...
window.autoRun=true
window:closeWindow("UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2")
call_activitiesHandle_func("activitiesHandle_chisejindi","reqNextCopyRound",window.actId,window.subId)
end
end,
}
window:showWindow("UISubAct_ChiSeJinDi_CopyDiscipleRecruitWin2",args)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onLoaded()
self:bindComponents()
_this=self
...
function UISubAct_ChiSeJinDi_CopyMainWin2:__delete()
self:killAllDoTween()
self:stopUpdateTick()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onHide()
...
function UISubAct_ChiSeJinDi_CopyMainWin2.on_249_230(actId,subId)
...
function UISubAct_ChiSeJinDi_CopyMainWin2.on_249_237(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyMainWin2.on_249_238(actId,subId,idx,len,roundList)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoney()
...
function UISubAct_ChiSeJinDi_CopyMainWin2.on_249_239(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoney()
end
...
function UISubAct_ChiSeJinDi_CopyMainWin2.on_249_240(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyMainWin2.on_249_241(actId,subId,roundtype,len,ids)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoney()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onSModel_1()
if self.teamData[1].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onSModel_2()
if self.teamData[2].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onSModel_3()
if self.teamData[3].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onSModel_4()
if self.teamData[4].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onSModel_5()
if self.teamData[5].disciple>0 then
self:onClickSModel()
end
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onBackground_1()
self:changeViewState(_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onBackButton()

local args={
content="是要进行结算还是暂时离开？\n（中途离开后会保存进度）",
oktext="结 算",
canceltext="暂 离",
showCloseBtn=true,
okcb=function()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onFightBtn()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onGoBtn()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onFightFaZe()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onDiscipleBtn()
self:changeViewState(_eViewState.eDiscipleBag)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onWeaponBtn()
self:changeViewState(_eViewState.eWeaponBag)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onFazeBtn()
self:changeViewState(_eViewState.eFaZeBag)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onDiscipleBack()
self:changeViewState(_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onWeaponBack()
self:changeViewState(_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onClickBottomTipsBtn()
self.showTips=not self.showTips
self:showBottomTips()
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onTipsPanel()
self.showTips=false
self:showBottomTips()
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onClickSModel()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:initCopyTips()
local str=self.config.copyTips
self.tipsContent:setText(str)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:showRoundMoneyAdd()
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDragDisciple(discipleId)
local discipleServer=self.config.disciple
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDragWeapon(weaponID)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:cancelDragDisciple()
self.dragDiscipleId=nil
self.dragDisciple:setChildUIModelRemoveTarget()
self.dragDisciple:setActive(false)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:cancelDragWeapon()
self.dragWeaponId=nil
self.dragWeapon:setActive(false)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:onTeamModelBeginDrag(index,targetPos)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onTeamModelEndDrag(index,targetPos)
if self._vState~=_eViewState.eDiscipleBag then return end
if self.dragDiscipleId==nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onTeamModelDrag(index,targetPos,deltaTime)
if self._vState~=_eViewState.eDiscipleBag then return end
if self.dragDiscipleId==nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onTeamWeaponBeginDrag(index,position)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onTeamWeaponEndDrag(index,targetPos)
if self._vState~=_eViewState.eWeaponBag then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onTeamWeaponDrag(index,targetPos,deltaTime)
if self._vState~=_eViewState.eWeaponBag then return end
if not self.dragWeaponId then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onBagDiscipleBeginDrag(index,position)
if self._vState~=_eViewState.eDiscipleBag then return end
if self.dragDiscipleId~=nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onBagDiscipleEndDrag(index,targetPos)
if self._vState~=_eViewState.eDiscipleBag then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onBagDiscipleDrag(index,targetPos,deltaTime)
if self._vState~=_eViewState.eDiscipleBag then return end
if not self.dragDiscipleId then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onBagWeaponBeginDrag(index,position)
if self._vState~=_eViewState.eWeaponBag then return end
if self.dragWeaponId~=nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onBagWeaponEndDrag(index,targetPos)
if self._vState~=_eViewState.eWeaponBag then return end
if not self.dragWeaponId then return end
self:cancelDragWeapon()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onBagWeaponDrag(index,targetPos)
if self._vState~=_eViewState.eWeaponBag then return end
if not self.dragWeaponId then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:changeViewState(state)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:changeRoundState(state,param,callback)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:quitCopy()
self.info:setCopy()
self.info:clearStarUp()
self:doCloseWin()
end

function UISubAct_ChiSeJinDi_CopyMainWin2:doCloseWin()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:initView()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshBackground()
self.bgUse=0
local template=self.copyData.template
local round=self.copyData.round
...
function UISubAct_ChiSeJinDi_CopyMainWin2:animationBackground(pos,duration,callback)
local template=self.copyData.template
local round=self.copyData.round
local templateCfg=cfgHelper.get2(cfg_chisejindiroundconfig_get,template,round)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:freezeBackground()
for i,v in pairs(self.background)do
self.winlua:SetChildUIModelAnimationSpeed(v:getID(),0)
end
end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshMoney()
local moneyStr=mathHelper.formatNumber(self.copyData.money)
self.moneyNum:setText(moneyStr)
end


function UISubAct_ChiSeJinDi_CopyMainWin2:refreshRound()
local template=self.copyData.template
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshLevel()
self.levelBg:setChildLayoutGroupCreateItems(self.copyData.level)
end


function UISubAct_ChiSeJinDi_CopyMainWin2:refreshHP()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshTeamDisciple()
for i,v in ipairs(self.sModelWidget)do
self:refreshTeamDiscipleItem(i)
end
end

function UISubAct_ChiSeJinDi_CopyMainWin2:refreshTeamDiscipleItem(index)
local posData=self.teamData[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:doTeamDiscipleAnimation(anim)
for i,v in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
if posData.disciple>0 then
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshEventModel()
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin2:setEnemyFlagUnknown()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:setEnemyFlagKnown(randomName)
local roundData=self.copyData.roundData
local widget=self.enemyFlag:getChildWidgetBase()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:showTeamSlot(show)
for i,v in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDiscipleBag(assign)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDisciplePageList()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDisciplePageItemTick(indexList)
local onLookup=self.info:getTeamLookup_Disciple()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDisciplePageItemTickEx(disciples)
local onLookup=self.info:getTeamLookup_Disciple()
for itemIdx=1,self.discipleViewPageItemCnt do
local index=(self.discipleBagPage-1)*self.discipleViewPageItemCnt+itemIdx
local discipleID=self.discipleBagDatas[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onLongTouchDiscipleBagItem(index)
if self.dragDiscipleId~=nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onClickDiscipleBagItem(index)
local discipleId=self.discipleBagDatas[index]
local lookup=self.info:getTeamLookup_Disciple()
local pos=lookup[discipleId]
if pos then
...
function UISubAct_ChiSeJinDi_CopyMainWin2:showTeamWeapon(show)
for i,v in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
if posData.disciple>0 then
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshAllTeamWeapon()
for i,v in ipairs(self.sModelWidget)do
local posData=self.teamData[i]
if posData.disciple>0 then
self:refreshTeamPosWeapon(i)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshTeamPosWeapon(index)
local widget=self.sWeaponWidget[index]
local posData=self.teamData[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshWeaponBag()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshWeaponPageList()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onLongTouchWeaponBagItem(index)
if self.dragWeaponId~=nil then return end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshWeaponBagItemOwner(indexList)
local lookup=self.info:getTeamLookup_Weapon()
for idx,itemIdx in ipairs(indexList)do
local index=(self.weaponBagPage-1)*self.weaponViewPageItemCnt+itemIdx
local weaponId=self.weaponBagDatas[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshWeaponBagItemOwnerEx(weapons)
local lookup=self.info:getTeamLookup_Weapon()
for itemIdx=1,self.weaponViewPageItemCnt do
local index=(self.weaponBagPage-1)*self.weaponViewPageItemCnt+itemIdx
local weaponId=self.weaponBagDatas[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onClickWeaponBagItem(index)
local weaponId=self.weaponBagDatas[index]
local lookup=self.info:getTeamLookup_Weapon()
local pos=lookup[weaponId]
if pos then
...
function UISubAct_ChiSeJinDi_CopyMainWin2:animationRandomView(callback)
self.animation=true
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshFightRoot()
local widget=self.fightRoot:getChildWidgetBase()
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onClickFightModel(index)
local roundData=self.copyData.roundData
local fightList=roundData.fightList
...
function UISubAct_ChiSeJinDi_CopyMainWin2:onClickTeamWeapon(index)
local posData=self.teamData[index]
...
function UISubAct_ChiSeJinDi_CopyMainWin2:checkAutoTeamOnRefresh(index)
local roundData=self.copyData.roundData
...
function UISubAct_ChiSeJinDi_CopyMainWin2:checkStarUpRefresh()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:nextStarUp()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:discipleViewEnter()
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:discipleViewExit(callback)
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:weaponViewEnter()
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:weaponViewExit(callback)
self.animation=true
local sequence=Lua.SequenceProxy.New()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshDiscipleBtnReddot()
local lookup=self.info:getTeamLookup_Disciple()
local onCnt=0
local offCnt=0
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshWeaponBtnReddot()
local discipleLookup=self.info:getTeamLookup_Disciple()
local empty=false
...
function UISubAct_ChiSeJinDi_CopyMainWin2:flowMoney(num)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:checkAutoRun()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:weaponRoundEnter(param,callback)
...
self.autoRun=true
self:closeWindow("UISubAct_ChiSeJinDi_CopyWeaponBuyWin2")
...
self:showWindow("UISubAct_ChiSeJinDi_CopyWeaponBuyWin2",args)
end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:weaponRoundExit(param,callback)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:rewardRoundAnimation(param,callback)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:setDoTween(index,tweener)
self:cleanDoTween(true)
self.tweeners[index]=tweener
end

function UISubAct_ChiSeJinDi_CopyMainWin2:cleanDoTween(index,complete)
...
function UISubAct_ChiSeJinDi_CopyMainWin2:killAllDoTween()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:refreshBackBtn()
self.backButton:setActive(self._vState==_eViewState.eNone)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:startUpdateTick()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:checkUpdateTick()
if self.info:checkInResultRankTime()then
self:quitCopy()
UIManager.info("结算开始，0点后可再进入")
end
...
function UISubAct_ChiSeJinDi_CopyMainWin2:stopUpdateTick()
...
function UISubAct_ChiSeJinDi_CopyMainWin2:showBottomTips()
self.tipsPanel:setScale(self.showTips and Vector3.one or Vector3.zero)
end

function UISubAct_ChiSeJinDi_CopyMainWin2:refreshPreview()
