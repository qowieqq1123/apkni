...
def_class("UIZongMenSeasonEnter_CJXY",UICloneObject)





UIZongMenSeasonEnter_CJXY.abName=""

UIZongMenSeasonEnter_CJXY.assetName="UIZongMenSeasonEnter_CJXY"


function UIZongMenSeasonEnter_CJXY:bindComponents()
...
function UIZongMenSeasonEnter_CJXY:unbindComponents()
...
function UIZongMenSeasonEnter_CJXY:onLoaded(...)
self:bindComponents()
...
function UIZongMenSeasonEnter_CJXY:__delete()
...
function UIZongMenSeasonEnter_CJXY:onShow(argtable,afterOnloaded)
...
function UIZongMenSeasonEnter_CJXY:onHide()
...
function UIZongMenSeasonEnter_CJXY:refreshSeasonReddot()
local reddot=self.enterHandle:getReddot()
self.reddot:setActive(reddot)
end

function UIZongMenSeasonEnter_CJXY:refreshSeasonStage()
...
function UIZongMenSeasonEnter_CJXY:refreshSeasonTime(stage)
if stage==nil then
local stages=self.enterHandle:getStages()
stage=stages[#stages]
for i,v in ipairs(stages)do
...
function UIZongMenSeasonEnter_CJXY:startSeasonTick(time)
...
function UIZongMenSeasonEnter_CJXY:stopSeasonTick()
self.seasonTime=nil
...
function UIZongMenSeasonEnter_CJXY:updateSeasonTick()
local nowTime=timeHelper.getServerShortTime()
local deltaTime=self.seasonTime-nowTime
if deltaTime>0 then
self.cdTx:setText(FMT.fmt("{0}后开启",timeHelper.format_time_stamp3(deltaTime)))
