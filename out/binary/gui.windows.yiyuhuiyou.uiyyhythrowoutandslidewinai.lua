...
def_class("UIYYHYThrowOutAndSlideWinAI",UIWindowBase)
...
function UIYYHYThrowOutAndSlideWinAI:bindComponents()
...
function UIYYHYThrowOutAndSlideWinAI:unbindComponents()
...
[1]={
startPos=Vector3.New(-260,-60,0),
entPos=Vector3.New(-260,255,0)
},
...
[4]={
startPos=Vector3.New(425,-60,0),
entPos=Vector3.New(425,255,0)
},
}
...
function UIYYHYThrowOutAndSlideWinAI:onLoaded(...)
self:bindComponents()

end


function UIYYHYThrowOutAndSlideWinAI:__delete()
...
function UIYYHYThrowOutAndSlideWinAI:onHide()

end

function UIYYHYThrowOutAndSlideWinAI:initView()
...
function UIYYHYThrowOutAndSlideWinAI:getKeyIdx()
...
function UIYYHYThrowOutAndSlideWinAI:timeClose()
closeTimeCounter=nil
self:closeSelf()
end
...
function UIYYHYThrowOutAndSlideWinAI:onShow(argtable,afterOnloaded)
...
function UIYYHYThrowOutAndSlideWinAI:tickUpdata()
self:addMessageEx()
...
function UIYYHYThrowOutAndSlideWinAI:throwOut(k_idx,args)
local thType=args[1]
local str=args[2]
...
function UIYYHYThrowOutAndSlideWinAI:clearTweener(tw)
...
function UIYYHYThrowOutAndSlideWinAI:addMessage(args)
...
function UIYYHYThrowOutAndSlideWinAI:addMessageEx()
