...
def_class("UIXianZhanKsPrizeWin",UIWindowBase)
...
function UIXianZhanKsPrizeWin:bindComponents()
...
function UIXianZhanKsPrizeWin:unbindComponents()
...
function UIXianZhanKsPrizeWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UIXianZhanKsPrizeWin:__delete()
_this=nil
...
function UIXianZhanKsPrizeWin:onHide()

end

function UIXianZhanKsPrizeWin.onItemUse(itemid,num)
...
function UIXianZhanKsPrizeWin:onShow(argtable,afterOnloaded)
self.curStep=1
self:stopAllTimer()
...
logErr('没有奖励却打开了UIXianZhanKsPrizeWin?')
end
end

function UIXianZhanKsPrizeWin:setAttachCB(callback)
self.attachCallback=callback
end

function UIXianZhanKsPrizeWin:initRewardView()
...
function UIXianZhanKsPrizeWin:refreshAllPos()
...
function UIXianZhanKsPrizeWin:refreswhScrollView()
...
function UIXianZhanKsPrizeWin:refreshItemPos(item,idx)
...
function UIXianZhanKsPrizeWin:refreshItem(item,widget)
...
function UIXianZhanKsPrizeWin:playShow()
local delay=0
local d=0.1
local num=self.rewardnum
local grids=self.goodGridPanel:getChildLayoutGroupGridList()
...
function UIXianZhanKsPrizeWin:playEffect()
...
function UIXianZhanKsPrizeWin:replay(itemid_,num)
local index=self.curStep
...
function UIXianZhanKsPrizeWin:playEffectEnd()
...
function UIXianZhanKsPrizeWin:onFinish()
...
function UIXianZhanKsPrizeWin:addNote(str)
table.insert(self.noteslist,1,str)
self:refreshNotes()
end

function UIXianZhanKsPrizeWin:refreshNotes()
...
function UIXianZhanKsPrizeWin:onClickItem(itemId,index,itemguid,attach)
itemsComponentHelper.onItemClick(itemId,index,itemguid,attach)
end

function UIXianZhanKsPrizeWin:onClickClose()
