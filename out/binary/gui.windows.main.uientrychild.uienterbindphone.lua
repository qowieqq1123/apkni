...
def_class("UIEnterBindPhone",UICloneObject)





UIEnterBindPhone.abName="ui/windows/main/uientrychild/uienternomalitem.ab"

UIEnterBindPhone.assetName="UIEnterNomalItem"


function UIEnterBindPhone:bindComponents()
...
function UIEnterBindPhone:unbindComponents()
...
function UIEnterBindPhone:onLoaded(...)
self:bindComponents()
end


function UIEnterBindPhone:__delete()
...
function UIEnterBindPhone:onShow(argtable,afterOnloaded)
...
pfwindowslController:reqPhoneBind_OuMei()
return
end
UIManager:showWindow("UIBindPhoneWin")
end,true)
...
function UIEnterBindPhone:onHide()
end

function UIEnterBindPhone:freshReddot()

UIManager:invokeUIMethod('UIMain','freshSimpleBtnReddot')
local reddot=pfwindowslController:checkBindPhoneReddot()
self.widget:SetChildActive(1,reddot)
end

function UIEnterBindPhone:onIcon()

end

function UIEnterBindPhone:onClickBg()
