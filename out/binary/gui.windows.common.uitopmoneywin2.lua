...
def_class("UITopMoneyWin2",UIWindowBase)
...
function UITopMoneyWin2:bindComponents()
...
function UITopMoneyWin2:unbindComponents()
...
function UITopMoneyWin2:onLoaded(...)
self:bindComponents()
self.money={}
...
function UITopMoneyWin2:__delete()
...
function UITopMoneyWin2:onShow(argtable,afterOnloaded)
if argtable then
...
function UITopMoneyWin2:onHide()
self:clearFlyIcon()
end

function UITopMoneyWin2:clearFlyIcon()
...
function UITopMoneyWin2:getMoneyList()
return self.money
end

function UITopMoneyWin2:freshMoneyList()
...
function UITopMoneyWin2:fillData(index,moneyInfo)
...
function UITopMoneyWin2:freshMoneyValue(index,moneyInfo,lastVal)
local rootStr=FMT.fmt('moneyRoot{0}',index)
if moneyInfo==nil then
self[rootStr]:setActive(false)
return
...
function UITopMoneyWin2:clearFMTweener(mtype)
...
function UITopMoneyWin2:onAddClick(moneyType)
...
function UITopMoneyWin2:getMoneyRoot(moneyType)
...
function UITopMoneyWin2:flyMoneyIcon(spos,moneyType)
...
function UITopMoneyWin2:handleFly(moneyType,spos,tpos)
...
function UITopMoneyWin2:onMoneyChange(moneyType,lastVal,val)
local moneyList=self.money
...
function UITopMoneyWin2:clickMoney(idx)
...
function UITopMoneyWin2:onMoney1Btn()
self:clickMoney(1)
end

function UITopMoneyWin2:onMoney2Btn()
self:clickMoney(2)
end

function UITopMoneyWin2:onMoney3Btn()
self:clickMoney(3)
end

function UITopMoneyWin2:onMoney4Btn()
self:clickMoney(4)
end


function UITopMoneyWin2:onItemChange(changeType,itemguid,itemid,lastcount,itemcount)
local moneyList=self.money
for i,v in ipairs(moneyList)do
local moneyInfo=moneyList[i]
