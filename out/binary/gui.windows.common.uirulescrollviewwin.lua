...
def_class("UIRuleScrollViewWin",UIWindowBase)
...
function UIRuleScrollViewWin:bindComponents()
...
function UIRuleScrollViewWin:unbindComponents()
...
function UIRuleScrollViewWin:onLoaded(...)
self:bindComponents()
end


function UIRuleScrollViewWin:__delete()
...
function UIRuleScrollViewWin:onShow(argtable,afterOnloaded)
...
function UIRuleScrollViewWin:onHide()

end

function UIRuleScrollViewWin:refreshDesc()
