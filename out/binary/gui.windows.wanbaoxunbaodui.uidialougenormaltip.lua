...
def_class("UIDialougeNormalTip",UIWindowBase)
...
function UIDialougeNormalTip:bindComponents()
...
function UIDialougeNormalTip:unbindComponents()
...
function UIDialougeNormalTip:onLoaded(...)
self:bindComponents()
_this=self
end


function UIDialougeNormalTip:__delete()
...
function UIDialougeNormalTip:onShow(argtable,afterOnloaded)
...
function UIDialougeNormalTip:onHide()
...
function UIDialougeNormalTip:onCloseBtn()
...
function UIDialougeNormalTip:onMaxCnt()
end



function UIDialougeNormalTip:onSubBtn()
end



function UIDialougeNormalTip:onAddBtn()
end



function UIDialougeNormalTip:onCancelButton()
local cb=self.cellcallback2
self:closeSelf()
if cb then
cb()
...
function UIDialougeNormalTip:onOkButton()
...
function UIDialougeNormalTip:onTipsRoot()
end



function UIDialougeNormalTip:onTipsBtn()
end
