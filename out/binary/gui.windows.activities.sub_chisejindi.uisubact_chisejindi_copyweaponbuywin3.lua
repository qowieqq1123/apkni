...
def_class("UISubAct_ChiSeJinDi_CopyWeaponBuyWin3",UIWindowBase)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:bindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:unbindComponents()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onLoaded(...)
self:bindComponents()
_this=self
self.starTweens={}
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:__delete()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onShow(argtable,afterOnloaded)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onHide()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onSellBtn()
local args={
actId=self.actId,
...
self:showWindow("UISubAct_ChiSeJinDi_CopyWeaponSellWin3",args)
end


function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onRefreshBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onMoneyBg()
tipsManager.showTips({itemid=self.config.chanceMoney})
end

function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onFazeBtn()
local args={
actId=self.actId,
subType=self.subType,
subId=self.subId,
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onDiscipleBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onWeaponBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onGoBtn()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:initView()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:updateBuyed()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:refreshMoneyNum(onlyTab)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:closeList()
local items=self.goodsList:getChildLayoutGroupGridList()
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:refreshList(onlyAnim)
local roundData=self.copyData.roundData
...
item:SetChildText(_itemCmp.costNum,priceStr)
item:SetChildActive(_itemCmp.costIcon,true)
item:SetChildActive(_itemCmp.costNum,true)
...
item:SetChildUIModelShowTarget(_itemCmp.background,5465,1,{},_animationID.enter,false,false,0)
end
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onClickImage(index)
if self.tweener or not self.showList then return end
local roundData=self.copyData.roundData
local data=roundData.list[index]
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:onClickBuy(index)
if self.tweener or not self.showList then return end
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3:setItemBuyed(index)
...
item:SetChildActive(_itemCmp.costIcon,false)
item:SetChildActive(_itemCmp.costNum,false)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3.on_249_238(actId,subId,index)
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3.on_249_239(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
...
function UISubAct_ChiSeJinDi_CopyWeaponBuyWin3.on_249_241(actId,subId)
local subType=SUB_ACTIVITY_TYPE.eChiSeJinDi
if _this.info:compare(actId,subType,subId)then
_this:refreshMoneyNum()
end
