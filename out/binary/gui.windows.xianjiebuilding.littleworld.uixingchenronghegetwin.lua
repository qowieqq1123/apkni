...
def_class("UIXingChenRongHeGetWin",UIWindowBase)
...
function UIXingChenRongHeGetWin:bindComponents()
...
self.starAttrPanel=UIObject.get(self,8)
self.starPanel=UIObject.get(self,9)
self.starText=UIText.get(self,10)
self.zhenxiPanel=UIObject.get(self,11)
...
function UIXingChenRongHeGetWin:unbindComponents()
...
function UIXingChenRongHeGetWin:onLoaded(...)
self:bindComponents()
end


function UIXingChenRongHeGetWin:__delete()
...
function UIXingChenRongHeGetWin:onShow(argtable,afterOnloaded)
local equip=argtable
self.equip=equip
...
function UIXingChenRongHeGetWin:onHide()

end

function UIXingChenRongHeGetWin:setShowItems()
...
function UIXingChenRongHeGetWin:refreshStarPanel()
...
function UIXingChenRongHeGetWin:onCloseBg()
self:closeSelf()
end
