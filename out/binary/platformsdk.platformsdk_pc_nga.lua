...
platformSDK_PC_NGA=simple_class(platformSDK_None)

local cjson=require'cjson'

local _WindowsHelper=CS.NGAPCHelper

function platformSDK_PC_NGA:__init(...)
...
function platformSDK_PC_NGA:reqLogin()
_WindowsHelper.ExecCmd("reqLogin","")
end


function platformSDK_PC_NGA:reqLogout()
_WindowsHelper.ExecCmd("reqLogout","")
end



function platformSDK_PC_NGA:reqPay(id,count,params,subscribe)
...
function platformSDK_PC_NGA:reqReport(typo,info)
...
function platformSDK_PC_NGA:reqFangChenMi()

end


function platformSDK_PC_NGA:onPay(json,jsonStr)
...
function platformSDK_PC_NGA:LoginCallBack(json,jsonStr)
...
function platformSDK_PC_NGA:LogoutCallBack(json,jsonStr)
...
function platformSDK_PC_NGA:PurchasePaymentResult()

end


function platformSDK_PC_NGA:OnApplicationQuit()
local showdata=
{
type='UIDialouge',
title='温馨提示',
...
function platformSDK_PC_NGA:reqApplicationQuit_PC()
_WindowsHelper.ExecCmd("setQuitState","quit")
platformHelper:exitGame()
end