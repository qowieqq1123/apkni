...
def_class("UIXM_ZZSH_PvPTeamWin",UIWindowBase)
...
function UIXM_ZZSH_PvPTeamWin:bindComponents()
...
function UIXM_ZZSH_PvPTeamWin:unbindComponents()
...
function UIXM_ZZSH_PvPTeamWin:onLoaded(...)
_this=self
self:bindComponents()
self.winList={}
self.pageLookup={}
...
function UIXM_ZZSH_PvPTeamWin:__delete()
_this=nil
...
function UIXM_ZZSH_PvPTeamWin:onHide()
...
function UIXM_ZZSH_PvPTeamWin:onShow(argtable,afterOnloaded)
local page=3
if argtable then
...
function UIXM_ZZSH_PvPTeamWin:refreshMenuItemSelect(item,idx,flag)
if item==nil then
...
function UIXM_ZZSH_PvPTeamWin:onMenuItemClick(idx)
...
function UIXM_ZZSH_PvPTeamWin:refreshMenuPage()
...
self.pagewin=win
local args={}
args.parentWin='UIXM_ZZSH_PvPTeamWin'
args.page=self.curPage
self:showWindow(win,args)
end
end

function UIXM_ZZSH_PvPTeamWin:onClickClose()
self:closeSelf()
end