...
def_class("UIEnterPushGiftThree",UICloneObject)





UIEnterPushGiftThree.abName="ui/windows/main/uientrychild/uienternomalitem.ab"

UIEnterPushGiftThree.assetName="UIEnterNomalItem"


function UIEnterPushGiftThree:bindComponents()
...
function UIEnterPushGiftThree:unbindComponents()
...
function UIEnterPushGiftThree:onLoaded(...)
self:bindComponents()

self.widget:SetChildButtonClick(0,function()
UIFullRechargeController:showPushGiftThreeWin({giftId={self.leftId}})
end,true)
...
function UIEnterPushGiftThree:__delete()
self.showLeft=nil
self:stopLeftTimer()
...
function UIEnterPushGiftThree:onShow(argtable,afterOnloaded)
...
function UIEnterPushGiftThree:onHide()

end



function UIEnterPushGiftThree:onfreshGifts()
local giftIds=pushGiftThreeModel:getLimitGiftIds()
...
function UIEnterPushGiftThree:initCountID()
local giftIds=pushGiftThreeModel:getLimitGiftIds()
self.leftId=nil
self.giftIds={}
if#giftIds==0 then
pushGiftThreeManager:removeEnter()
return
end
...
function UIEnterPushGiftThree:startLeftTimer()
self:stopLeftTimer()
local func=function()
if self==nil or self.widget==nil then return end
local leftTime=pushGiftThreeModel:getLeftBuyTime(self.leftId)
if leftTime==nil or leftTime<0 then
self:initCountID()
if self.leftId==nil then return end
leftTime=pushGiftThreeModel:getLeftBuyTime(self.leftId)
end
...
function UIEnterPushGiftThree:stopLeftTimer()
...
function UIEnterPushGiftThree:onIcon()

end

function UIEnterPushGiftThree:onClickBg()
