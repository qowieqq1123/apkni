...
def_class("UISubAct_ZQDMrewardWin",UIWindowBase)
...
function UISubAct_ZQDMrewardWin:bindComponents()
...
function UISubAct_ZQDMrewardWin:unbindComponents()
...
function UISubAct_ZQDMrewardWin:onLoaded(...)
self:bindComponents()
_this=self
end


function UISubAct_ZQDMrewardWin:__delete()
...
function UISubAct_ZQDMrewardWin:onShow(argtable,afterOnloaded)
...
self.bgModel:setChildUIModelShowTarget(5584,1,{},eAnimationID.enter,false,false,0,function()
...
function UISubAct_ZQDMrewardWin:onHide()

end

function UISubAct_ZQDMrewardWin:onBlack()
self:closeSelf()
end


function UISubAct_ZQDMrewardWin:onClickItem(itemId,index,guid,attach)
