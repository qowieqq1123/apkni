...
def_class("UISubAct_roledoubleLottery_PrizeWin",UIWindowBase)
...
function UISubAct_roledoubleLottery_PrizeWin:bindComponents()
...
function UISubAct_roledoubleLottery_PrizeWin:unbindComponents()
...
function UISubAct_roledoubleLottery_PrizeWin:onLoaded(...)
_this=self
self:bindComponents()
...
function UISubAct_roledoubleLottery_PrizeWin:__delete()
self:clearTimer()
...
function UISubAct_roledoubleLottery_PrizeWin:onShow(argtable,afterOnloaded)
if argtable then
...
function UISubAct_roledoubleLottery_PrizeWin:onHide()
self:clearTimer()
end

function UISubAct_roledoubleLottery_PrizeWin:refreshBtn()
...
function UISubAct_roledoubleLottery_PrizeWin:showSpecialEffect()
...
function UISubAct_roledoubleLottery_PrizeWin:onDrawBtnOne()
_this:clearTimer()
self.btnClickMask:setActive(true)
UIManager:invokeUIMethod("UISubAct_roledoubleLotteryWin","onDrawBtnOne",self.selectBoxIndex)
self:onClickBg()
end



function UISubAct_roledoubleLottery_PrizeWin:onDrawBtnMany()
_this:clearTimer()
self.btnClickMask:setActive(true)
UIManager:invokeUIMethod("UISubAct_roledoubleLotteryWin","onDrawBtnMany",self.selectBoxIndex)
self:onClickBg()
end

function UISubAct_roledoubleLottery_PrizeWin:onClickBg()
_this:clearTimer()
self.btnClickMask:setActive(true)
...
function UISubAct_roledoubleLottery_PrizeWin:clearTimer()
