...
def_class("UISettingZongMenSelectWin",UIWindowBase)
...
function UISettingZongMenSelectWin:bindComponents()
...
function UISettingZongMenSelectWin:unbindComponents()
...
local abname="ui/windows/setting/newsetting_altas_pak.ab"


function UISettingZongMenSelectWin:onLoaded(...)
self:bindComponents()
...
self.gainTable={}
self.defaultId=1
self.settingType=KUANGE_TYPE.zongmen
...
function UISettingZongMenSelectWin:__delete()
...
function UISettingZongMenSelectWin:onShow(argtable,afterOnloaded)
local itemid
local settingId
if argtable then
...
function UISettingZongMenSelectWin:onHide()
self.rightScrollerView:setActive(false)
end

function UISettingZongMenSelectWin:freshView(isInit)
...
function UISettingZongMenSelectWin:freshSelectInfo()
...
local modelId=settingcfg.winModelId
...
function UISettingZongMenSelectWin:stopExpireTimer()
if self.timer then
...
function UISettingZongMenSelectWin:freshExpireTimer()
self:stopExpireTimer()
...
function UISettingZongMenSelectWin:initSortCfgList()
self.configList={}
local settingType=self.settingType
...
function UISettingZongMenSelectWin:freshAllGrids(isInit,afterOnloaded)
local col=3
...
if cfg.rightwinIcon then
item:SetChildUIModelRemoveTarget(5)
item:SetChildCSImage(0,abname,cfg.rightwinIcon.iconName,true)

if unlock then
item:SetChildImageExGray(0,false)
else
if cfg.rightwinIcon.grayImage then
item:SetChildCSImage(0,abname,cfg.rightwinIcon.grayImage,true)
item:SetChildImageExGray(0,false)
else
item:SetChildImageExGray(0,true)
end
end
local scale=cfg.rightwinIcon.scale
local offset=cfg.rightwinIcon.offset
item:SetChildScale(0,Vector3.New(scale,scale,scale))
item:SetChildAnchoredPos(0,offset[1],offset[2])
else
local modelId=cfg.winModelId
if afterOnloaded and api_Available_SetChildUIModelEnableInitUISpineParaEx()then
...
item:SetChildUIModelGray(5,not unlock)
...
function UISettingZongMenSelectWin:freshGridsUse()
local len=#self.configList
local useId=UISettingModel:getCurSettingId_Type(self.settingType)
for i=1,len do
local item=self.rightScrollerView:getGridObjectByindex(i-1)
...
function UISettingZongMenSelectWin:freshGridsExperience()
...
function UISettingZongMenSelectWin:onSettingUseChanged(settingId)
self:freshGridsUse()
...
function UISettingZongMenSelectWin:onSettingUnlock(settingId)
self:freshAllGrids()
if settingId==self.selectId then
self:freshSelectInfo()
end
...
function UISettingZongMenSelectWin:onSettingTypeExperience(settingType,experienceList)
...
function UISettingZongMenSelectWin:OnClickItemCallback(id,index,guid,attach)
...
function UISettingZongMenSelectWin:onClickCostItem(itemid,index,guid,attach)
...
function UISettingZongMenSelectWin:onUnLockBtn()
local settingId=self.selectId
...
function UISettingZongMenSelectWin:onRenewalBtn()

end



function UISettingZongMenSelectWin:onUseBtn()
local useid=UISettingModel:getCurSettingId_Type(self.settingType)
local settingId=self.selectId
...
function UISettingZongMenSelectWin:onDetailBtn()
UIManager:showWindow("UISettingAttrAddWin",{settingType=self.settingType})
end

function UISettingZongMenSelectWin:onTipsBtn()
end

function UISettingZongMenSelectWin:onUpStarBtn()
