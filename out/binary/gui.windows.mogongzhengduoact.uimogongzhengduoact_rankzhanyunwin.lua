...
def_class("UIMoGongZhengDuoAct_rankZhanYunWin",UIWindowBase)
...
function UIMoGongZhengDuoAct_rankZhanYunWin:bindComponents()
...
function UIMoGongZhengDuoAct_rankZhanYunWin:unbindComponents()
...
function UIMoGongZhengDuoAct_rankZhanYunWin:onLoaded(...)
self:bindComponents()
end


function UIMoGongZhengDuoAct_rankZhanYunWin:__delete()
...
function UIMoGongZhengDuoAct_rankZhanYunWin:onShow(argtable,afterOnloaded)
self.level=argtable.level
self.selectLevel=self.level

self.rankType=MGZD_RANK_TYPE.eZhanYunRank
...
function UIMoGongZhengDuoAct_rankZhanYunWin:onHide()
self:clearTimer()
end

function UIMoGongZhengDuoAct_rankZhanYunWin:refresh(isReset)
...
function UIMoGongZhengDuoAct_rankZhanYunWin:getSortRankList(isReset)
...
function UIMoGongZhengDuoAct_rankZhanYunWin:onFreshAction(i,widget)
self:fillItem(widget,i)
end

function UIMoGongZhengDuoAct_rankZhanYunWin:onStartAction()

end

function UIMoGongZhengDuoAct_rankZhanYunWin:fillItem(widget,index)
...
function UIMoGongZhengDuoAct_rankZhanYunWin:refreshSelfRankItem()
...
local zhansun=moGongZhengDuoActModel:getArenaSelfRankValue(self.rankType)or Int64_0
...
function UIMoGongZhengDuoAct_rankZhanYunWin:setRemainingTimeTimer()
self:clearTimer()
local func=function()
...
function UIMoGongZhengDuoAct_rankZhanYunWin:clearTimer()
if self.timer then
...
function UIMoGongZhengDuoAct_rankZhanYunWin:onHelpBtn()
...
function UIMoGongZhengDuoAct_rankZhanYunWin:onChangeLevel(level)
