...
def_class("YYHYShopWin",UIWindowBase)
...
function YYHYShopWin:bindComponents()
...
function YYHYShopWin:unbindComponents()
...
function YYHYShopWin:onShow(argtable,afterOnloaded)
...
function YYHYShopWin:doOpenAnim()
...
function YYHYShopWin:onOpenAnimFinish()
...
function YYHYShopWin:onHide()

end

function YYHYShopWin:refreshTime()
...
function YYHYShopWin.clickMenu(index)
...
YYHYShopWin:refreshYuJuShengji()
end
end


function YYHYShopWin:onYujugan()
if _this.selectyuju==1 then
return
end
_this.selectyuju=1
YYHYShopWin:refreshYuJuShengjiPanel(1)
end
function YYHYShopWin:onYujuxian()
if _this.selectyuju==3 then
return
end
_this.selectyuju=3
YYHYShopWin:refreshYuJuShengjiPanel(3)
end
function YYHYShopWin:onYujugou()
if _this.selectyuju==2 then
return
end
_this.selectyuju=2
YYHYShopWin:refreshYuJuShengjiPanel(2)
end


function YYHYShopWin:refreshYuJuShengji()
...
YYHYShopWin:refreshYuJuShengjiPanel(_this.selectyuju)
end


function YYHYShopWin:refreshYuJuSJPanel(index,level)
...
function YYHYShopWin:refreshYuJuManJiPanel(index,level)
local cfg=cfg_yiyuhuiyouyujuconfig_get(index)[level]
...
function YYHYShopWin:refreshYuJuShengjiPanel(index)
...
YYHYShopWin:refreshYuJuSJPanel(index,level)
else
_this.weimanji:setActive(false)
_this.manji:setActive(true)
YYHYShopWin:refreshYuJuManJiPanel(index,level)
end
elseif index==2 then
...
function YYHYShopWin:refreshGoods()
...
function YYHYShopWin:getLimitStr(data,itemid)
...
function YYHYShopWin:refreshGoodItemByItemid(itemid)
local index
local data
...
function YYHYShopWin.clickGood(clickCount,index)
...
function YYHYShopWin:onClickBaseItem(itemid,index,itemguid,attach)
itemsComponentHelper.onItemClickEx(itemid,index,itemguid,attach)
end


function YYHYShopWin:refreshMoneyRoot()
...
function YYHYShopWin:doSpeaking(speakType)
...
function YYHYShopWin:doTalkAnim()
...
function YYHYShopWin:onCloseBtn()
self:closeSelf()
end

function YYHYShopWin:onMoneyRoot()
local moneyType=eMoneyType.mtYuBi
gainControl:showGainWin(moneyType)
end

function YYHYShopWin:onNPCClick()
self:doSpeaking(1)
end


function YYHYShopWin.on_money_changed(moneyType,lastVal,val)
...
function YYHYShopWin:onBtnshengji()
