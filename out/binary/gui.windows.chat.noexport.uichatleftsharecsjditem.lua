...
def_class("UIChatLeftShareCSJDItem",UICloneObject)





UIChatLeftShareCSJDItem.abName=""

UIChatLeftShareCSJDItem.assetName="UIChatLeftShareCSJDItem"


function UIChatLeftShareCSJDItem:bindComponents()
...
function UIChatLeftShareCSJDItem:unbindComponents()
...
function UIChatLeftShareCSJDItem:onLoaded(...)
self:bindComponents()
...
function UIChatLeftShareCSJDItem:__delete()
...
function UIChatLeftShareCSJDItem:onShow(argtable,afterOnloaded)
...
function UIChatLeftShareCSJDItem:onHide()
...
function UIChatLeftShareCSJDItem:onHeadBg()
end

function UIChatLeftShareCSJDItem:onBg()
...
function UIChatLeftShareCSJDItem:refreshStatus()
local info=activitiesModel:getSubActInfo(self.data.actId,self.data.subType,self.data.subId)
if info==nil or not info:checkDoing()or self.timeStamp<info.start_time_l then
...
function UIChatLeftShareCSJDItem:setOverTimeState()
...
function UIChatLeftShareCSJDItem:onCSJDGuildDataChange(actId,subType,subId,guid,reSort)
...
function UIChatLeftShareCSJDItem:onSubActivityStateChange(actId,subType,subId)
if self.data.actId==actId and self.data.subType==subType and self.data.subId==subId then
self:refreshStatus()
end
end

function UIChatLeftShareCSJDItem:freshRect()
