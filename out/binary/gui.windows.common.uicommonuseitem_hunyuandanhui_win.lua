...
def_class("UICommonUseItem_hunyuandanhui_Win",UIWindowBase)
...
function UICommonUseItem_hunyuandanhui_Win:bindComponents()
...
self.costGrid=UIObject.get(self,4)
...
function UICommonUseItem_hunyuandanhui_Win:unbindComponents()
...
function UICommonUseItem_hunyuandanhui_Win:onLoaded(...)
self:bindComponents()
_this=self
end


function UICommonUseItem_hunyuandanhui_Win:__delete()
...
function UICommonUseItem_hunyuandanhui_Win:onShow(argtable,afterOnloaded)
...
function UICommonUseItem_hunyuandanhui_Win:onHide()
...
function UICommonUseItem_hunyuandanhui_Win:initGoods()
self.dialougeText:setText(FMT.fmt("消耗以下道具兑换<color=#549327>{0}</color>体力",self.showdata.goodCount*self.selectCnt))

local costs={{self.showdata.itemid,1}}
local c=#costs
...
function UICommonUseItem_hunyuandanhui_Win:refreshGoods()
self.dialougeText:setText(FMT.fmt("消耗以下道具兑换<color=#549327>{0}</color>体力",self.showdata.goodCount*self.selectCnt))
...
function UICommonUseItem_hunyuandanhui_Win:onClickItem(itemId,index,guid,attach)
tipsManager.showTips({itemid=itemId,itemguid=nil,move=TIPS_MOVE_POS.eRight})
end

function UICommonUseItem_hunyuandanhui_Win:onSliderChange(value)
...
function UICommonUseItem_hunyuandanhui_Win:onCloseBtn()
self:doClose()
end

function UICommonUseItem_hunyuandanhui_Win:onBGClick()
self:doClose()
end

function UICommonUseItem_hunyuandanhui_Win:doClose()
...
function UICommonUseItem_hunyuandanhui_Win:onCancelButton()
self:closeSelf()
end

function UICommonUseItem_hunyuandanhui_Win:onOkButton()
...
function UICommonUseItem_hunyuandanhui_Win:onSubBtn()
...
function UICommonUseItem_hunyuandanhui_Win:onAddBtn()
if self.max<=1 then
return
end
